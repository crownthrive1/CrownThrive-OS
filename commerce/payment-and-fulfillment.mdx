...
<Note>
  ...
  **This page:** Payment and Fulfillment — The standard CrownThrive payment, webhook, entitlement, delivery, refund, dispute, and reconciliation model for first-party digital commerce.
...
CrownThrive first-party digital commerce follows a verified-entitlement model.
