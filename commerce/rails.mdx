...
<Info>
  The current machine-read production architecture for Virality Music, Crown Credits, Stripe/Connect, stablecoins, CHLOM Wallet, Trust Wallet Agent Kit, the managed Base/USDC Agent Wallet, Changelly, and ThriveEvergreen is documented in [Production Hybrid Commerce Convergence — 2026-08-23](/commerce/production-hybrid-commerce-convergence-2026-08-23). The current multichain intelligence and managed-wallet custody/signing boundary is documented in [Trust Wallet Agent Kit & CHLOM Managed Agent Wallet](/commerce/trustwallet-agent-kit-production-runner), with the dedicated wallet identity also summarized in [Managed Agent Wallet](/commerce/chlom-managed-agent-wallet-base-usdc). The embedded-wallet, funding and WalletConnect contract is documented in [MetaMask Embedded Wallets Funding & Dual Wallet Execution](/commerce/metamask-embedded-wallets-funding-and-dual-wallet).
</Info>
