...
-- The test is intentionally bounded to four newly classified public-schema writes.
-- It does not assert closure of the broader PentaCertifier 182-function role-EXECUTE
