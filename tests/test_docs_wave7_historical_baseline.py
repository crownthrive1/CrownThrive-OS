...
class Wave7HistoricalBaselineTests(unittest.TestCase):
    ...
    def test_workflows_pin_historical_digests_and_enable_pipefail(self) -> None:
        for workflow_path, receipt_path, digest_key, expected_digest in (
            WORKFLOW_RECEIPT_DIGESTS
        ):
