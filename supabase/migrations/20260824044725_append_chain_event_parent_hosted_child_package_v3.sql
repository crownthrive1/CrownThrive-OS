-- Live migration: 20260824044725 / append_chain_event_parent_hosted_child_package_v3
-- Final v3 chain-event contract: a child implementation repository may invoke an algorithm whose
-- Framework Factory package is canonically hosted by its registered parent only when the latest
-- exact parent/child technical-link receipt matches both heads and has Guardian/family/interoperability proof.
