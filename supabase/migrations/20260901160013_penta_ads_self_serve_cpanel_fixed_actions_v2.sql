...
begin
  if p_action not in ('publish_console','publish_zone_lab','publish_bootstrap','publish_runtime','status','install_demo','rollback_demo','inventory') then raise exception 'penta_ads_self_serve_cpanel_action_invalid'; end if;
