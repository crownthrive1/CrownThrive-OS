...
- **PentaFactory** — software production continuity, subject to its independent runtime certification;
- **PentaFramework Factory** — framework/version inheritance, subject to independent runtime certification;
