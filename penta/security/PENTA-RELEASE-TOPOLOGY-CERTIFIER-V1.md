...
Rollback boundary: exact pre-change/current-main commit `64af09c3775ad1f4304da0cb29d1134b13155195`. This current-main restack preserves the original source semantics from PR #1751 while dropping repository-generated originator evidence blobs from the bounded implementation diff. No production database migration, provider-rules mutation, credential change, or release mutation is included in this source candidate.
