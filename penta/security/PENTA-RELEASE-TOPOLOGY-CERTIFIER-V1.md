...
Rollback boundary for this collision-safe restack: exact protected-main commit `51058cab393f1f4d1fd33d252916ed4b8ac64ce3`. The two modified legacy gate-awareness files had identical Git blobs at the prior candidate base (`64af09c3775ad1f4304da0cb29d1134b13155195`) and this current-main base, so their bounded successor content can be carried without overwriting intervening source changes. Repository-generated originator evidence blobs are intentionally excluded from the implementation diff. No production database migration, provider-rules mutation, credential change, or release mutation is included in this source candidate.
