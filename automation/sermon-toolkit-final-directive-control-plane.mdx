...
- **Baseline:** `main@8fcb68bf209e32ba2cd265e1b6ca730cb8da64d7`
...
Shared navigation, register updates, federation hooks, runtime changes, and production activation remain deferred until the collision-governor dependency and current patch owners reach a terminal state.
