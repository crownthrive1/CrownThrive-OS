...
- **PentaGreen™** — the governed commerce and economic-activation authority (legacy alias: ThriveEvergreen™) that keeps products, SKUs, rights, prices, payments, fulfillment, entitlements, advertising, settlement, and reconciliation in one controlled lifecycle.
