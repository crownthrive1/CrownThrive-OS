...
## Release FAQ — v3.38.0.0

## Where is the official release?
https://github.com/crownthrive1/CrownThrive-OS/releases/tag/v3.38.0.0
...
## What changed?
This release declares 8 changed path(s). The complete path list is in `PENTARELEASE_RELEASE_RECORD.json` and `PENTARELEASE_DATA_CATALOG.json`.
