...
## Release FAQ — v3.61.4.0

## Where is the official release?
https://github.com/crownthrive1/CrownThrive-OS/releases/tag/v3.61.4.0
...
## What changed?
This release declares 19 changed path(s). The complete path list is in `PENTARELEASE_RELEASE_RECORD.json` and `PENTARELEASE_DATA_CATALOG.json`.
