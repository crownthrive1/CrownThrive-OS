...
https://github.com/crownthrive1/CrownThrive-OS/releases/tag/v3.61.3.0
...
## What changed?
This release declares 24 changed path(s). The complete path list is in `PENTARELEASE_RELEASE_RECORD.json` and `PENTARELEASE_DATA_CATALOG.json`.
