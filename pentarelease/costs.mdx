...
```json
{
  ...
  "direct_usage_calculation": {
    ...
    "payload_bytes": 971328,
    "direct_usd_cost": null,
    "release_version": "3.61.3.0"
  },
  "methodology": {
    ...
    "sunk_costs": "fixed subscription/compute sunk costs are excluded unless explicitly release-bound"
  },
  "sources": [
