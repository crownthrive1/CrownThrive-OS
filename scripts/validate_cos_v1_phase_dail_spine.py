...
FORWARD = ROOT / "supabase/migrations/20260830230400_cos_v1_phase_dail_spine_v1.sql"
ROLLBACK = ROOT / "supabase/rollbacks/20260830230400_cos_v1_phase_dail_spine_v1.rollback.sql"
...
def main() -> None:
    ...
    checks = {
        ...
        "gate_receipt_stable_entity": "'cos_phase_gate_receipt',new.receipt_id::text" in forward,
        "gate_receipt_id_in_payload": "'receipt_id',new.receipt_id" in forward,
        "gate_name_as_entity_version": "new.verifier_actor,null,'ct.cos.phase-control',new.gate_name" in forward,
