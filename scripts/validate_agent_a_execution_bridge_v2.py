...
def main() -> None:
    ...
    require(m["stale_maintenance_function"] == "chlom_runtime.gen7_stale_portfolio_maintenance_v2", "maintenance function drift")
    require(m["heartbeat_freshness_function"] == "chlom_runtime.reconcile_gen6_agent_health_freshness", "heartbeat freshness function drift")
    ...
    require(m["heartbeat_truthfulness"]["live_heartbeat_observed_on_non_canary"] is True, "live heartbeat evidence required")
    require(m["heartbeat_truthfulness"]["heartbeat_ttl_from_agent_template"] is True, "agent TTL must be authoritative")
    require(m["heartbeat_truthfulness"]["stale_health_becomes_degraded"] is True, "stale health cannot remain silently healthy")
    ...
    require(m["l_p_telemetry"]["final_force_test_live_heartbeats"] is True, "L-P fresh heartbeat force-test evidence required")
    ...
    require(m["force_test_2026_08_23"]["agent_a_heartbeat_fresh"] is True, "Agent A heartbeat must be fresh")
    require(m["force_test_2026_08_23"]["l_p_heartbeats_fresh"] is True, "L-P heartbeats must be fresh")
    ...
    require(m["force_test_2026_08_23"]["packet_metrics"]["stability_new_blocker_burndown"] == 0, "force test must not claim old burn-down as new")
