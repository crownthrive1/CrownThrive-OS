...
SCOPE = ROOT / "data/documentation/sprint-2-scope.v1.json"
...
print(f"total_distinct_route_references={sum(count for _, count in results)}")
for rel, count in results:
    print(f"{count:02d} {rel}")

if errors:
    print("FAIL_SPRINT_2_DOCUMENTATION_CONTINUITY")
    for error in errors:
        print(error)
    raise SystemExit(1)

print("PASS_SPRINT_2_DOCUMENTATION_CONTINUITY")
