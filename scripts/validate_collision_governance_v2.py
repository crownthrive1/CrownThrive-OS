...
def main() -> int:
    ...
    require("schedule:" not in trusted_workflow, "second_scheduler_slot_forbidden", failures)
    require("workflow_dispatch:" in trusted_workflow, "trusted_manual_recovery_trigger_missing", failures)
