...
LINEAGE=ROOT/'supabase/migration_lineage/legacy_local_timestamp_drift/local_only_versions'
pre=(LINEAGE/'20260823202950_execution_builder_capability_contract_identity_v1.sql').read_text().lower()
...
sql=(LINEAGE/'20260823203100_execution_builder_agent_v1_0_1.sql').read_text()
low=sql.lower()
