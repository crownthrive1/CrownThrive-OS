...
expected_agents=['ct.gen7.agent-q','ct.gen7.agent-r','ct.gen7.agent-t','ct.gen7.agent-u','ct.gen7.agent-v','ct.gen7.agent-red','ct.gen7.agent-blue','ct.gen7.agent-purple']
...
assert m['mailgun']['sending_key_state']=='internal_canary_passed'
