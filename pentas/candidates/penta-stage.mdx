---
title: "PentaStage"
sidebarTitle: "PentaStage"
description: "Penta namespace reference and canonicalization guide for PentaStage."
...
<Info>
  ...
  **This page:** PentaStage — Penta namespace reference and canonicalization guide for PentaStage.
...
Route work to PentaStage when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaStage` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `dbb54477877d2d5a913e75f5ec421a51734396eb3c49450a1dad94251fbbca17`
