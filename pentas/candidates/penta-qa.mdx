---
title: "PentaQA"
sidebarTitle: "PentaQA"
description: "Penta namespace reference and canonicalization guide for PentaQA."
...
<Info>
  ...
  **This page:** PentaQA — Penta namespace reference and canonicalization guide for PentaQA.
...
Route work to PentaQA when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, build, test-certify, publish.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaQA` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `7e48fb32e33b571cfac42e88120822b02dbb85f4c3dbe1369a4db7eba1c68fcd`
