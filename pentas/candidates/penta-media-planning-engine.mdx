---
title: "Penta Media Planning Engine"
sidebarTitle: "Penta Media Planning Engine"
description: "Penta namespace reference and canonicalization guide for Penta Media Planning Engine."
...
<Info>
  ...
  **This page:** Penta Media Planning Engine — Penta namespace reference and canonicalization guide for Penta Media Planning Engine.
...
Route work to Penta Media Planning Engine when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, publish, build.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Media Planning Engine` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `07a9e8994b58060b3d776ac36cd0388664df8be076f2816b5c7c1ffc20aa84d4`
