...
| --- | --- |
| Architectural layers | [Experience & Interface](/pentas/layers/experience-interface) |
| Jobs / functions | [Support & Operate](/pentas/jobs/support-operate) |
...
Route work to PentaJourney when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: support-operate.
...
2. Match the request to the documented jobs: `support-operate`.
...
- This record hash: `81d820fae88f1b5fa0483526e553f7af43cd860b463f764c6080119343fd0eb9`
