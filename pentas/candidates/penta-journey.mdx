---
title: "PentaJourney"
sidebarTitle: "PentaJourney"
description: "Penta namespace reference and canonicalization guide for PentaJourney."
...
<Info>
  ...
  **This page:** PentaJourney — Penta namespace reference and canonicalization guide for PentaJourney.
...
Route work to PentaJourney when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, support-operate.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaJourney` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `4b8f0a9879b5dae2a748f259e4f6d9a9feb4b88ac7eb2f404b5fb0d2c2c2b9fd`
