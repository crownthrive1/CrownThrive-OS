---
title: "PentaEconomicKernel"
sidebarTitle: "PentaEconomicKernel"
description: "Penta namespace reference and canonicalization guide for PentaEconomicKernel."
...
<Info>
  ...
  **This page:** PentaEconomicKernel — Penta namespace reference and canonicalization guide for PentaEconomicKernel.
...
| Source state | `prior_artifact_reference` |
...
Route work to PentaEconomicKernel when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, transact-economic.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaEconomicKernel` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `d1328030ea8e35a4a2f204c3004d05f028811f343f44508683ae358bd65d5bd0`
