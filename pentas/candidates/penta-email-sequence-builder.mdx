---
title: "Penta Email Sequence Builder"
sidebarTitle: "Penta Email Sequence Builder"
description: "Penta namespace reference and canonicalization guide for Penta Email Sequence Builder."
...
<Info>
  ...
  **This page:** Penta Email Sequence Builder — Penta namespace reference and canonicalization guide for Penta Email Sequence Builder.
...
| Provisional family | [Build Release](/pentas/families/build-release) |
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Build, Test & Release](/pentas/layers/build-release), [Communications, Growth & Service](/pentas/layers/communications-growth) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Build](/pentas/jobs/build), [Test & Certify](/pentas/jobs/test-certify), [Publish](/pentas/jobs/publish), [Communicate & Grow](/pentas/jobs/communicate-grow) |
...
Route work to Penta Email Sequence Builder when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, build, test-certify, publish, communicate-grow.
...
2. Match the request to the documented jobs: `govern`, `document`, `build`, `test-certify`, `publish`, `communicate-grow`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Email Sequence Builder` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `1fea841bd8427b0fc0d0e31ddc1f195c1ed831d937d13a42799d851ed4b736ec`
