...
Route work to Penta Email Sequence Builder when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: build, test-certify, publish, communicate-grow.
...
- This record hash: `ecb547af9ad13503976117ed1f6106a4bf42df2cb7cfdfc4c917c842e27ed9fc`
