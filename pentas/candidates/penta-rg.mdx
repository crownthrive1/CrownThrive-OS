---
title: "PentaRG"
sidebarTitle: "PentaRG"
description: "Penta namespace reference and canonicalization guide for PentaRG."
...
<Info>
  ...
  **This page:** PentaRG — Penta namespace reference and canonicalization guide for PentaRG.
...
Route work to PentaRG when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaRG` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `8a3ddb6a291e12946c8fc111525e14a61adf16b1da20ce597e78be98857cd1ec`
