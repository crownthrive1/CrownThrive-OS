---
title: "PentaPublish"
sidebarTitle: "PentaPublish"
description: "Penta namespace reference and canonicalization guide for PentaPublish."
...
<Info>
  ...
  **This page:** PentaPublish — Penta namespace reference and canonicalization guide for PentaPublish.
...
Route work to PentaPublish when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, publish, build.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaPublish` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `b455d6b8094889433ca6f2a257d539dac5c58d2d81ca0f640f6e50279ffc57d7`
