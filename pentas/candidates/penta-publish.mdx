...
| --- | --- |
| Architectural layers | [Media, Creative & Publishing](/pentas/layers/media-creative) |
| Jobs / functions | [Publish](/pentas/jobs/publish), [Build](/pentas/jobs/build) |
...
Route work to PentaPublish when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: publish, build.
...
2. Match the request to the documented jobs: `publish`, `build`.
...
- This record hash: `94f839e271a5c7590b11c18e4f0e29df2b068526cef30a228685ce036f4f9dad`
