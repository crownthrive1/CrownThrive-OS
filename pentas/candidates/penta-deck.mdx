---
title: "PentaDeck"
sidebarTitle: "PentaDeck"
description: "Penta namespace reference and canonicalization guide for PentaDeck."
...
<Info>
  ...
  **This page:** PentaDeck — Penta namespace reference and canonicalization guide for PentaDeck.
...
Route work to PentaDeck when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaDeck` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `ad11fc297a7a1daafdbf00c4d49199a9931553595675746e683e0a9708379cc6`
