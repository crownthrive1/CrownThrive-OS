...
| --- | --- |
| Architectural layers | [Communications, Growth & Service](/pentas/layers/communications-growth), [Experience & Interface](/pentas/layers/experience-interface), [Commerce & Economic](/pentas/layers/commerce-economic) |
| Jobs / functions | [Communicate & Grow](/pentas/jobs/communicate-grow), [Support & Operate](/pentas/jobs/support-operate), [Analyze & Research](/pentas/jobs/analyze-research), [Transact & Economic](/pentas/jobs/transact-economic) |
...
Route work to Penta Marketing Finance Analyst when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: communicate-grow, support-operate, analyze-research, transact-economic.
...
2. Match the request to the documented jobs: `communicate-grow`, `support-operate`, `analyze-research`, `transact-economic`.
...
- This record hash: `1b5e03d0e8e2c2ddf1847875b71d089507086d855242491d0ceaa223b3f9d209`
