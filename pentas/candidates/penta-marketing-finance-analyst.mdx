---
title: "Penta Marketing Finance Analyst"
sidebarTitle: "Penta Marketing Finance Analyst"
description: "Penta namespace reference and canonicalization guide for Penta Marketing Finance Analyst."
...
<Info>
  ...
  **This page:** Penta Marketing Finance Analyst — Penta namespace reference and canonicalization guide for Penta Marketing Finance Analyst.
...
## Penta Marketing Finance Analyst
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Communications, Growth & Service](/pentas/layers/communications-growth), [Commerce & Economic](/pentas/layers/commerce-economic) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Communicate & Grow](/pentas/jobs/communicate-grow), [Transact & Economic](/pentas/jobs/transact-economic) |
...
Route work to Penta Marketing Finance Analyst when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, communicate-grow, transact-economic.
...
2. Match the request to the documented jobs: `govern`, `document`, `communicate-grow`, `transact-economic`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Marketing Finance Analyst` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `604b35bcdb7795dcab5edd8e113cc408beef2e222b5030a095a4d5f3f79859ed`
