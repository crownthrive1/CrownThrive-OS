...
Route work to Penta Marketer Intelligence Evaluator when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: analyze-research, retrieve, observe, communicate-grow.
...
- This record hash: `32c62bb112c430c099b7e0e2007a20ccadcdcdc704849e308161ab0dd0c603bf`
