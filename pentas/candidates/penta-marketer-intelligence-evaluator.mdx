---
title: "Penta Marketer Intelligence Evaluator"
sidebarTitle: "Penta Marketer Intelligence Evaluator"
description: "Penta namespace reference and canonicalization guide for Penta Marketer Intelligence Evaluator."
...
<Info>
  ...
  **This page:** Penta Marketer Intelligence Evaluator — Penta namespace reference and canonicalization guide for Penta Marketer Intelligence Evaluator.
...
## Penta Marketer Intelligence Evaluator
...
| Provisional family | [Intelligence Research](/pentas/families/intelligence-research) |
...
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Communicate & Grow](/pentas/jobs/communicate-grow), [Analyze & Research](/pentas/jobs/analyze-research) |
...
Route work to Penta Marketer Intelligence Evaluator when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, communicate-grow, analyze-research.
...
2. Match the request to the documented jobs: `govern`, `document`, `communicate-grow`, `analyze-research`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Marketer Intelligence Evaluator` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `feb25e44c6fa7a6a8f576845d91fbafd02426c5f4da633a466e351be6fa26e8b`
