...
Route work to Penta SEO Cluster Builder when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: build, test-certify, publish, communicate-grow.
...
- This record hash: `c3a51552d8a9b286c23c88db4d29fbd4ae65a81fe5ddb32d715a61bf5541a9f7`
