---
title: "Penta SEO Cluster Builder"
sidebarTitle: "Penta SEO Cluster Builder"
description: "Penta namespace reference and canonicalization guide for Penta SEO Cluster Builder."
...
<Info>
  ...
  **This page:** Penta SEO Cluster Builder — Penta namespace reference and canonicalization guide for Penta SEO Cluster Builder.
...
Route work to Penta SEO Cluster Builder when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, build, test-certify, publish, communicate-grow.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta SEO Cluster Builder` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `04b3ae4e3e5193828d67a43b196bff0561a6160fbe7ddec35474e12f5dc66a29`
