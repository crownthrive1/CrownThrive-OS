---
title: "PentaSOP"
sidebarTitle: "PentaSOP"
description: "Penta namespace reference and canonicalization guide for PentaSOP."
...
<Info>
  ...
  **This page:** PentaSOP — Penta namespace reference and canonicalization guide for PentaSOP.
...
Route work to PentaSOP when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: recover, observe, support-operate.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaSOP` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `17e9bfbd227112d71f96106b948856859a81059223614399982ece7abeda7a31`
