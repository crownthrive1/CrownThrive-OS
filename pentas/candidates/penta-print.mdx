...
Route work to PentaPrint when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: publish, build, communicate-grow.
...
- This record hash: `67cd6179cfa90017cf5ae7467677869b4e4e81fecfb0deeabe3d5181c62799b2`
