---
title: "PentaPrint"
sidebarTitle: "PentaPrint"
description: "Penta namespace reference and canonicalization guide for PentaPrint."
...
<Info>
  ...
  **This page:** PentaPrint — Penta namespace reference and canonicalization guide for PentaPrint.
...
Route work to PentaPrint when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, publish, build.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaPrint` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `6c4ca31a5d4e796df8f29528aed48c1d3b109d800101f05472cea9f2a2f7dd8c`
