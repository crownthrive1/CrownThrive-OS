...
Route work to PentaLint when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: build, test-certify, publish.
...
- This record hash: `b646b3fe590305744d6b7860784e1848129faf5527c2447a25546f78a253dbef`
