---
title: "PentaLint"
sidebarTitle: "PentaLint"
description: "Penta namespace reference and canonicalization guide for PentaLint."
...
<Info>
  ...
  **This page:** PentaLint — Penta namespace reference and canonicalization guide for PentaLint.
...
Route work to PentaLint when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaLint` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `44e374d2119a07b8888885e04e5547d6b3cb25a9b1f3f59d936d9fd07ed6b39a`
