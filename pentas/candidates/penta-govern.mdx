...
Route work to PentaGovern when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, secure, document.
...
- This record hash: `a203de6a7ece57d003222669d2d133b921d87413f54223b1b4db202bd6f21d66`
