---
title: "PentaGovern"
sidebarTitle: "PentaGovern"
description: "Penta namespace reference and canonicalization guide for PentaGovern."
...
<Info>
  ...
  **This page:** PentaGovern — Penta namespace reference and canonicalization guide for PentaGovern.
...
Route work to PentaGovern when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaGovern` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `349cf9acbe006274acf089f8be793bae2735798fe9cd03a81371f85f41d67336`
