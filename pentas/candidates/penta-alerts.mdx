...
Route work to PentaAlerts when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: observe, recover, support-operate.
...
- This record hash: `f76a5b0bbe2c99158297265640089e45ae1be26bd386329b0e43a6f1c25f9de8`
