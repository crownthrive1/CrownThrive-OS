---
title: "PentaAlerts"
sidebarTitle: "PentaAlerts"
description: "Penta namespace reference and canonicalization guide for PentaAlerts."
...
<Info>
  ...
  **This page:** PentaAlerts — Penta namespace reference and canonicalization guide for PentaAlerts.
...
Route work to PentaAlerts when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaAlerts` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `c49468f77e6384ba592fc23c5ed6067cbd5f48b67ef58dddfd51de07b6dd68f3`
