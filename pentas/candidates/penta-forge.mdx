---
title: "PentaForge"
sidebarTitle: "PentaForge"
description: "Penta namespace reference and canonicalization guide for PentaForge."
...
<Info>
  ...
  **This page:** PentaForge — Penta namespace reference and canonicalization guide for PentaForge.
...
Route work to PentaForge when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaForge` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `bab77622dfda65609111fa917ed8fcba4326e6e2c571fd80c41ab474afcbb972`
