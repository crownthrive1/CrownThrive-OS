---
title: "PentaPeople"
sidebarTitle: "PentaPeople"
description: "Penta namespace reference and canonicalization guide for PentaPeople."
...
<Info>
  ...
  **This page:** PentaPeople — Penta namespace reference and canonicalization guide for PentaPeople.
...
Route work to PentaPeople when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, manage-people-community.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaPeople` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `b24f01d52b79ec4dcc1fd2ddb67d9726eca95f34d12e30d58998d1a085e89d2c`
