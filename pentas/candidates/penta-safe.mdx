...
Route work to PentaSafe when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: secure, govern, observe.
...
- This record hash: `1ef2ace51244b983a1750f09b1417dab53ed9871edb46b88f5849750fafad955`
