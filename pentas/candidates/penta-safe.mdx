---
title: "PentaSafe"
sidebarTitle: "PentaSafe"
description: "Penta namespace reference and canonicalization guide for PentaSafe."
...
<Info>
  ...
  **This page:** PentaSafe — Penta namespace reference and canonicalization guide for PentaSafe.
...
Route work to PentaSafe when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaSafe` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `1481665c55d29b0545dd9b52f73225e0355506f0dbd3821b4adedc96172353c5`
