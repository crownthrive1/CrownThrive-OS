...
Route work to Penta Media Buyer Assistant when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: publish, build, communicate-grow.
...
- This record hash: `554890e95fc614929f1dfb3d583ee59f4a8d01ef9afdf17961dcad3c7d5f2de9`
