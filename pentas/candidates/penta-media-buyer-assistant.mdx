---
title: "Penta Media Buyer Assistant"
sidebarTitle: "Penta Media Buyer Assistant"
description: "Penta namespace reference and canonicalization guide for Penta Media Buyer Assistant."
...
<Info>
  ...
  **This page:** Penta Media Buyer Assistant — Penta namespace reference and canonicalization guide for Penta Media Buyer Assistant.
...
Route work to Penta Media Buyer Assistant when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, publish, build.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Media Buyer Assistant` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `5646bc6ed8c200f1b1fdd0c817aaba0854a3ab3a6ad0ac04b6eacad11a1df6af`
