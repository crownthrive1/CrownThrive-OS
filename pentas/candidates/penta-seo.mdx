---
title: "PentaSEO"
sidebarTitle: "PentaSEO"
description: "Penta namespace reference and canonicalization guide for PentaSEO."
...
<Info>
  ...
  **This page:** PentaSEO — Penta namespace reference and canonicalization guide for PentaSEO.
...
Route work to PentaSEO when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, communicate-grow.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaSEO` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `f2770a2f2f4c81c93a5ae6635ee6d23325c0091b945db3aeea6b1a00553f1a24`
