...
Route work to PentaSEO when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: communicate-grow, support-operate, analyze-research.
...
- This record hash: `4421fea2e2fccaa33210567838f2f1ebb776c1038d24c38193784bbca8edd7ca`
