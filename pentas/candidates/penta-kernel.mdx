---
title: "PentaKernel"
sidebarTitle: "PentaKernel"
description: "Penta namespace reference and canonicalization guide for PentaKernel."
...
<Info>
  ...
  **This page:** PentaKernel — Penta namespace reference and canonicalization guide for PentaKernel.
...
Route work to PentaKernel when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: architect, govern, support-operate.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaKernel` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `c4d9d89a5a363d3ff043851f21d02ebca99e139fede9537542647b0d40057b7b`
