---
title: "Penta Social Post Factory"
sidebarTitle: "Penta Social Post Factory"
description: "Penta namespace reference and canonicalization guide for Penta Social Post Factory."
...
<Info>
  ...
  **This page:** Penta Social Post Factory — Penta namespace reference and canonicalization guide for Penta Social Post Factory.
...
Route work to Penta Social Post Factory when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, build, test-certify, publish, communicate-grow.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Social Post Factory` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `69fd509991c1db32ce4e8566eab64f7f1cf218d2131363e2b4b6a566633d3e02`
