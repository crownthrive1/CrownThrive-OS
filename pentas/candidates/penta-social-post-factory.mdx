...
Route work to Penta Social Post Factory when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: build, test-certify, publish, communicate-grow.
...
- This record hash: `a932b9b94328822d940a7d2a2f3df72f25a5f0e9642f2288c9569fb1453b4d68`
