---
title: "PentaExperiments"
sidebarTitle: "PentaExperiments"
description: "Penta namespace reference and canonicalization guide for PentaExperiments."
...
<Info>
  ...
  **This page:** PentaExperiments — Penta namespace reference and canonicalization guide for PentaExperiments.
...
Route work to PentaExperiments when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaExperiments` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `6a3e5069dd2968b2be1ebfd695a45ed769dad90a67f08f7b43cbcb290c77d1e9`
