---
title: "PentaROI"
sidebarTitle: "PentaROI"
description: "Penta namespace reference and canonicalization guide for PentaROI."
...
<Info>
  ...
  **This page:** PentaROI — Penta namespace reference and canonicalization guide for PentaROI.
...
Route work to PentaROI when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaROI` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `ee64745d12acc7ecf3df4e3e218329d85435b702dffadc74871ccc1fbd1c211d`
