...
Route work to PentaROI when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: analyze-research, retrieve, observe.
...
- This record hash: `9d32a1a57dad8ead8c40d645148751d298e977588925009a1c9fcbe00b6ab97d`
