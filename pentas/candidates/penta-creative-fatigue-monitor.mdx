---
title: "Penta Creative Fatigue Monitor"
sidebarTitle: "Penta Creative Fatigue Monitor"
description: "Penta namespace reference and canonicalization guide for Penta Creative Fatigue Monitor."
...
<Info>
  ...
  **This page:** Penta Creative Fatigue Monitor — Penta namespace reference and canonicalization guide for Penta Creative Fatigue Monitor.
...
## Penta Creative Fatigue Monitor
...
Route work to Penta Creative Fatigue Monitor when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Creative Fatigue Monitor` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `43dbf2ad01db23888a82ac48522f4c509179f42cdf840de080365d57d3385f51`
