...
Route work to PentaLogs when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: observe, recover, support-operate.
...
- This record hash: `ed8a82c6d59452bfc248605612e0a05599f11f3687708153171b6161a9f019c6`
