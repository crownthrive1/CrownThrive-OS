---
title: "PentaLogs"
sidebarTitle: "PentaLogs"
description: "Penta namespace reference and canonicalization guide for PentaLogs."
...
<Info>
  ...
  **This page:** PentaLogs — Penta namespace reference and canonicalization guide for PentaLogs.
...
Route work to PentaLogs when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, observe, recover.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaLogs` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `50e8812c17641711ffa21ac4335fa94d0857f5d21fe333e13e8087f537fcc7ee`
