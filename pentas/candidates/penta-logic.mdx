---
title: "PentaLogic"
sidebarTitle: "PentaLogic"
description: "Penta namespace reference and canonicalization guide for PentaLogic."
...
<Info>
  ...
  **This page:** PentaLogic — Penta namespace reference and canonicalization guide for PentaLogic.
...
Route work to PentaLogic when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaLogic` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `2618c17ef4493e3f97502154113c473ef586a150c5c3fd7157535dc10714022e`
