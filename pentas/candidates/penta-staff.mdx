---
title: "PentaStaff"
sidebarTitle: "PentaStaff"
description: "Penta namespace reference and canonicalization guide for PentaStaff."
...
<Info>
  ...
  **This page:** PentaStaff — Penta namespace reference and canonicalization guide for PentaStaff.
...
Route work to PentaStaff when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, manage-people-community.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaStaff` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `44270a5a2df586b6b66a0bb6b1e6eb12cc794452e88ddebb255b3df9c2e427dc`
