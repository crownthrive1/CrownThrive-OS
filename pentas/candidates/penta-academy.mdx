---
title: "PentaAcademy"
sidebarTitle: "PentaAcademy"
description: "Penta namespace reference and canonicalization guide for PentaAcademy."
...
<Info>
  ...
  **This page:** PentaAcademy — Penta namespace reference and canonicalization guide for PentaAcademy.
...
Route work to PentaAcademy when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, manage-people-community.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaAcademy` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `809d2e430a68fb4ce272f647f30809e157d551929d1c3a8099e555d900576965`
