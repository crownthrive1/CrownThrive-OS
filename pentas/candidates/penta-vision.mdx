---
title: "PentaVision"
sidebarTitle: "PentaVision"
description: "Penta namespace reference and canonicalization guide for PentaVision."
...
<Info>
  ...
  **This page:** PentaVision — Penta namespace reference and canonicalization guide for PentaVision.
...
Route work to PentaVision when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaVision` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `a40c030365856d6fe444643c97f32e60b601f29fb5ea06e3d2770ee8d323e882`
