---
title: "PentaWorkforce"
sidebarTitle: "PentaWorkforce"
description: "Penta namespace reference and canonicalization guide for PentaWorkforce."
...
<Info>
  ...
  **This page:** PentaWorkforce — Penta namespace reference and canonicalization guide for PentaWorkforce.
...
Route work to PentaWorkforce when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, manage-people-community.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaWorkforce` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `05b8feb77c67b6cd7079ad2a4c06e0e705fbc9041d4de7133d59c8a43dbffdad`
