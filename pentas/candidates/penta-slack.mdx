---
title: "PentaSlack"
sidebarTitle: "PentaSlack"
description: "Penta namespace reference and canonicalization guide for PentaSlack."
...
<Info>
  ...
  **This page:** PentaSlack — Penta namespace reference and canonicalization guide for PentaSlack.
...
Route work to PentaSlack when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: recover, observe, support-operate.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaSlack` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `9de119e965cfe022d4e4c2abd400cdf970ae0cfb97fb2a7dc218f20ae75e8c69`
