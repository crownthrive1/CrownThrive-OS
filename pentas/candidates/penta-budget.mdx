---
title: "PentaBudget"
sidebarTitle: "PentaBudget"
description: "Penta namespace reference and canonicalization guide for PentaBudget."
...
<Info>
  ...
  **This page:** PentaBudget — Penta namespace reference and canonicalization guide for PentaBudget.
...
| Provisional family | [Commerce Economy](/pentas/families/commerce-economy) |
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Routing, Interop & Transport](/pentas/layers/routing-transport), [Commerce & Economic](/pentas/layers/commerce-economic) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Route](/pentas/jobs/route), [Retrieve](/pentas/jobs/retrieve), [Transform](/pentas/jobs/transform), [Transact & Economic](/pentas/jobs/transact-economic) |
...
Route work to PentaBudget when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, route, retrieve, transform, transact-economic.
...
2. Match the request to the documented jobs: `govern`, `document`, `route`, `retrieve`, `transform`, `transact-economic`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaBudget` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `3fbf1fde136e88db93a2fb46e9bf87f36bc2867fd27a79571e9de94a42c736b6`
