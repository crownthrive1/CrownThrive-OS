...
Route work to PentaBudget when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: transact-economic, govern, observe, route, retrieve, transform.
...
- This record hash: `72d7c3837c191d3c266cb6cb928c776124a286e6900d809ee194886c564aa4d8`
