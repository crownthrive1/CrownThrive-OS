---
title: "PentaSustain"
sidebarTitle: "PentaSustain"
description: "Penta namespace reference and canonicalization guide for PentaSustain."
...
<Info>
  ...
  **This page:** PentaSustain — Penta namespace reference and canonicalization guide for PentaSustain.
...
Route work to PentaSustain when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: recover, observe, support-operate.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaSustain` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `f81af873b94c2240cf7f58fca8743f488a900c904ef674ab8995ed5a1c5e5a23`
