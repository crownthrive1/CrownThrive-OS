...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Commerce & Economic](/pentas/layers/commerce-economic) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Transact & Economic](/pentas/jobs/transact-economic) |
...
Route work to Penta Revenue Funnel Mapper when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, transact-economic.
...
2. Match the request to the documented jobs: `govern`, `document`, `transact-economic`.
...
- This record hash: `1b7ac6497b2eac1fcb33a116b78977409270400a92e2821768a4c66a4fdb96cd`
