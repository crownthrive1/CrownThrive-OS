---
title: "Penta Revenue Funnel Mapper"
sidebarTitle: "Penta Revenue Funnel Mapper"
description: "Penta namespace reference and canonicalization guide for Penta Revenue Funnel Mapper."
...
<Info>
  ...
  **This page:** Penta Revenue Funnel Mapper — Penta namespace reference and canonicalization guide for Penta Revenue Funnel Mapper.
...
Route work to Penta Revenue Funnel Mapper when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: communicate-grow, support-operate, analyze-research, transact-economic.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Revenue Funnel Mapper` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `7034247842b07607922d4949955a6230225cdb78623f5cc98c3c54cb8aad0ffe`
