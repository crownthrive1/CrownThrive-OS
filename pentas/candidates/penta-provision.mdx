---
title: "PentaProvision"
sidebarTitle: "PentaProvision"
description: "Penta namespace reference and canonicalization guide for PentaProvision."
...
<Info>
  ...
  **This page:** PentaProvision — Penta namespace reference and canonicalization guide for PentaProvision.
...
| Source state | `governed_registry_reference` |
...
Route work to PentaProvision when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaProvision` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `2153297238593af6485562e0053f6adf31e899101cb9519a2dbd40ca613e8cbc`
