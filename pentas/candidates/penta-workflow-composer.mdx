---
title: "Penta Workflow Composer"
sidebarTitle: "Penta Workflow Composer"
description: "Penta namespace reference and canonicalization guide for Penta Workflow Composer."
...
<Info>
  ...
  **This page:** Penta Workflow Composer — Penta namespace reference and canonicalization guide for Penta Workflow Composer.
...
| Provisional family | [Automation Agentic](/pentas/families/automation-agentic) |
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Automation & Agentic](/pentas/layers/automation-agentic) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Orchestrate](/pentas/jobs/orchestrate) |
...
Route work to Penta Workflow Composer when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, orchestrate.
...
2. Match the request to the documented jobs: `govern`, `document`, `orchestrate`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Workflow Composer` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `ce33740b7185642d08a968a3c60e503c65f465bbdb3ffae37d6a3b93528e39fc`
