...
Route work to PentaBroadcast when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: publish, build, communicate-grow.
...
- This record hash: `70430545db5c0b410964d4e9efcf44417ca8aea0a623750250d7ddd59462ff56`
