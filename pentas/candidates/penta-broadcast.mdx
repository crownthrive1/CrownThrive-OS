---
title: "PentaBroadcast"
sidebarTitle: "PentaBroadcast"
description: "Penta namespace reference and canonicalization guide for PentaBroadcast."
...
<Info>
  ...
  **This page:** PentaBroadcast — Penta namespace reference and canonicalization guide for PentaBroadcast.
...
Route work to PentaBroadcast when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, publish, build.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaBroadcast` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `da14f472390b6b8c1b370296f5061ca4c8bc094e71db577f815451c3f27e488f`
