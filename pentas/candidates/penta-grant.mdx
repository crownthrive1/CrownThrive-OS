---
title: "PentaGrant"
sidebarTitle: "PentaGrant"
description: "Penta namespace reference and canonicalization guide for PentaGrant."
...
<Info>
  ...
  **This page:** PentaGrant — Penta namespace reference and canonicalization guide for PentaGrant.
...
Route work to PentaGrant when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaGrant` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `bacfc4b84409c1718b4ae54cfb2d21b0b5126c1503236971a2662357f0be25a9`
