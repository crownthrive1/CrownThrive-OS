...
Route work to PentaVoice when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: communicate-grow, support-operate, analyze-research.
...
- This record hash: `9b0f17faf24bf1262922acc01eaa33483c1bc03f3696935f9bd6b49b5b55dff0`
