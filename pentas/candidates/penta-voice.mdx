---
title: "PentaVoice"
sidebarTitle: "PentaVoice"
description: "Penta namespace reference and canonicalization guide for PentaVoice."
...
<Info>
  ...
  **This page:** PentaVoice — Penta namespace reference and canonicalization guide for PentaVoice.
...
Route work to PentaVoice when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, communicate-grow.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaVoice` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `2a7b58e8ff1fd82063da3a52c1b64c445f82c8b6f124a8c55efab601e8a85633`
