---
title: "Penta Narrative Generator"
sidebarTitle: "Penta Narrative Generator"
description: "Penta namespace reference and canonicalization guide for Penta Narrative Generator."
...
<Info>
  ...
  **This page:** Penta Narrative Generator — Penta namespace reference and canonicalization guide for Penta Narrative Generator.
...
Route work to Penta Narrative Generator when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: communicate-grow, support-operate, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Narrative Generator` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `b7afeba9b82621b9b3edda42dd46842a090e81a8ba1b0d05d41cbd1c0bba806b`
