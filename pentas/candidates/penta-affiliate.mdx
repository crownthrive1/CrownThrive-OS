---
title: "PentaAffiliate"
sidebarTitle: "PentaAffiliate"
description: "Penta namespace reference and canonicalization guide for PentaAffiliate."
...
<Info>
  ...
  **This page:** PentaAffiliate — Penta namespace reference and canonicalization guide for PentaAffiliate.
...
Route work to PentaAffiliate when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, communicate-grow.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaAffiliate` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `697ec10449e84388fb035832239cd89302a0d9b2af38d8944ebe99054ed3eb7e`
