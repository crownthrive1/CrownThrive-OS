---
title: "PentaBrand"
sidebarTitle: "PentaBrand"
description: "Penta namespace reference and canonicalization guide for PentaBrand."
...
<Info>
  ...
  **This page:** PentaBrand — Penta namespace reference and canonicalization guide for PentaBrand.
...
Route work to PentaBrand when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, communicate-grow.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaBrand` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `8ea2e7daee0019d9a388d443559541d609f705b1f2d32e0889263fd020511cb5`
