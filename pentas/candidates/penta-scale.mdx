...
Route work to PentaScale when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: classification pending.
...
- This record hash: `db5806cb18396318a8c3ec99b72fcd7deea4c2dd998d8ce178b803370ff375a1`
