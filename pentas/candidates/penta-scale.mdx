---
title: "PentaScale"
sidebarTitle: "PentaScale"
description: "Penta namespace reference and canonicalization guide for PentaScale."
...
<Info>
  ...
  **This page:** PentaScale — Penta namespace reference and canonicalization guide for PentaScale.
...
Route work to PentaScale when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaScale` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `0d84f87a87913ca6c19df92c71d607f5aeecc91269c35b152f736476fdc8eb21`
