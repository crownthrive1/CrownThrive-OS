...
Route work to PentaPatent when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, secure, document.
...
- This record hash: `8412494c5fe163115438ad35bf56fe8c364a0c1b7935f41389d3ec01f9ceee76`
