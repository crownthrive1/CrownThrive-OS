---
title: "PentaPatent"
sidebarTitle: "PentaPatent"
description: "Penta namespace reference and canonicalization guide for PentaPatent."
...
<Info>
  ...
  **This page:** PentaPatent — Penta namespace reference and canonicalization guide for PentaPatent.
...
Route work to PentaPatent when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaPatent` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `38266a9962edbdc907f08350f9dae9bf07a494ee4273c362cac49175616fdd5f`
