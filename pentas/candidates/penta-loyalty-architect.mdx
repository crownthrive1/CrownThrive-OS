---
title: "Penta Loyalty Architect"
sidebarTitle: "Penta Loyalty Architect"
description: "Penta namespace reference and canonicalization guide for Penta Loyalty Architect."
...
<Info>
  ...
  **This page:** Penta Loyalty Architect — Penta namespace reference and canonicalization guide for Penta Loyalty Architect.
...
Route work to Penta Loyalty Architect when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: communicate-grow, support-operate, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Loyalty Architect` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `ebd3fe6b20cf5b4766ed0a3ba99dca004b22db2631dc48ee21f35848a887dc06`
