---
title: "PentaFlow"
sidebarTitle: "PentaFlow"
description: "Penta namespace reference and canonicalization guide for PentaFlow."
...
<Info>
  ...
  **This page:** PentaFlow — Penta namespace reference and canonicalization guide for PentaFlow.
...
Route work to PentaFlow when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, orchestrate.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaFlow` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `baae73c7c96e3bfcc1ced951c2bef6c854afcc5f466d0816ee556d774b8df8d5`
