...
Route work to Penta Brand Equity Mapper when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: communicate-grow, support-operate, analyze-research.
...
- This record hash: `fb8451e212941737371484b6009e7bfea180c5b0410db9e68394bdb995a5d943`
