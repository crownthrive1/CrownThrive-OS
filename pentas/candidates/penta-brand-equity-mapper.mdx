---
title: "Penta Brand Equity Mapper"
sidebarTitle: "Penta Brand Equity Mapper"
description: "Penta namespace reference and canonicalization guide for Penta Brand Equity Mapper."
...
<Info>
  ...
  **This page:** Penta Brand Equity Mapper — Penta namespace reference and canonicalization guide for Penta Brand Equity Mapper.
...
Route work to Penta Brand Equity Mapper when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, communicate-grow.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Brand Equity Mapper` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `60287bde82fa724c2d8b053befe5b966bebfada96a89ab2773b6be4c8b7d654d`
