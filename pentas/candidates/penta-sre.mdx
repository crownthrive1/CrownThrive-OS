---
title: "PentaSRE"
sidebarTitle: "PentaSRE"
description: "Penta namespace reference and canonicalization guide for PentaSRE."
...
<Info>
  ...
  **This page:** PentaSRE — Penta namespace reference and canonicalization guide for PentaSRE.
...
Route work to PentaSRE when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, observe, recover.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaSRE` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `802fdee4159be11838521e203f722e6e310fdfeb176313282cf0e6479fdc25ed`
