---
title: "PentaMaintain"
sidebarTitle: "PentaMaintain"
description: "Penta namespace reference and canonicalization guide for PentaMaintain."
...
<Info>
  ...
  **This page:** PentaMaintain — Penta namespace reference and canonicalization guide for PentaMaintain.
...
Route work to PentaMaintain when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: recover, observe, support-operate.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaMaintain` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `c9b796c42af997448a6ace384514983534efeda0131b656851e884364650c144`
