---
title: "PentaCampus"
sidebarTitle: "PentaCampus"
description: "Penta namespace reference and canonicalization guide for PentaCampus."
...
<Info>
  ...
  **This page:** PentaCampus — Penta namespace reference and canonicalization guide for PentaCampus.
...
Route work to PentaCampus when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, manage-people-community.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaCampus` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `c88282a819445cffc6b590acc8f2972167a432bfcc1944661faba4cf94f25a43`
