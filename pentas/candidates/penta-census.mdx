...
Route work to PentaCensus when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: analyze-research, retrieve, observe.
...
- This record hash: `1df2d9ece0eba8c1ae69dfbc743761abab92f0228d992adeead9d2bf3dd64272`
