...
description: "Penta namespace reference and canonicalization guide for PentaCensus."
...
<Info>
  ...
  **This page:** PentaCensus — Penta namespace reference and canonicalization guide for PentaCensus.
...
Route work to PentaCensus when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaCensus` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `618921137dcfdf03a2e8bec2d84c6f36f7fdc9118c5969bb63d5ab9360036131`
