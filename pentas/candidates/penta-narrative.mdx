---
title: "PentaNarrative"
sidebarTitle: "PentaNarrative"
description: "Penta namespace reference and canonicalization guide for PentaNarrative."
...
<Info>
  ...
  **This page:** PentaNarrative — Penta namespace reference and canonicalization guide for PentaNarrative.
...
Route work to PentaNarrative when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: communicate-grow, support-operate, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaNarrative` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `0d0b07b6105ecde236b258ee2cec7ab6a5c46a1aa39eea8a735079b55ab25822`
