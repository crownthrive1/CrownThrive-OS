---
title: "PentaEnergy"
sidebarTitle: "PentaEnergy"
description: "Penta namespace reference and canonicalization guide for PentaEnergy."
...
<Info>
  ...
  **This page:** PentaEnergy — Penta namespace reference and canonicalization guide for PentaEnergy.
...
Route work to PentaEnergy when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaEnergy` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `4c18b828e0ccca210a8e91b9cb77520b1bd4314cc323569dcef41bb24ab6f43c`
