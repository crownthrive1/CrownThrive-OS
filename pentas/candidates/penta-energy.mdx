...
Route work to PentaEnergy when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: classification pending.
...
- This record hash: `64198d9da5a22f8a7724cd6daf66f59937508f3cea49a7f0be352d8149d4931f`
