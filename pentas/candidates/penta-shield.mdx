---
title: "PentaShield"
sidebarTitle: "PentaShield"
description: "Penta namespace reference and canonicalization guide for PentaShield."
...
<Info>
  ...
  **This page:** PentaShield — Penta namespace reference and canonicalization guide for PentaShield.
...
Route work to PentaShield when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, secure.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaShield` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `4778fd7ce74200f2c866cd510bace76a88de16f140d176be1866e8ab0f3ffd18`
