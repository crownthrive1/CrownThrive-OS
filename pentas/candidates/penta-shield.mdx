...
Route work to PentaShield when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: secure, govern, observe.
...
- This record hash: `b3b982921a6323eff3ac957a7f6f3814617e125ff7fcdc744eb0d84adfc24bef`
