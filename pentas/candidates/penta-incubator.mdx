---
title: "PentaIncubator"
sidebarTitle: "PentaIncubator"
description: "Penta namespace reference and canonicalization guide for PentaIncubator."
...
<Info>
  ...
  **This page:** PentaIncubator — Penta namespace reference and canonicalization guide for PentaIncubator.
...
Route work to PentaIncubator when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaIncubator` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `6b7bc8a75fd4c22392cdfb81b3216cc08457967d1852e03ebc6edf5ed598587e`
