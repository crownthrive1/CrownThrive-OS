---
title: "Penta SEO Content Optimizer"
sidebarTitle: "Penta SEO Content Optimizer"
description: "Penta namespace reference and canonicalization guide for Penta SEO Content Optimizer."
...
<Info>
  ...
  **This page:** Penta SEO Content Optimizer — Penta namespace reference and canonicalization guide for Penta SEO Content Optimizer.
...
Route work to Penta SEO Content Optimizer when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, communicate-grow.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta SEO Content Optimizer` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `2a6615a426c3cba66bbc981d8afc0a82a5b4ac0fa314dbda8071f1c79e127bff`
