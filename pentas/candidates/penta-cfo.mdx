---
title: "PentaCFO"
sidebarTitle: "PentaCFO"
description: "Penta namespace reference and canonicalization guide for PentaCFO."
...
<Info>
  ...
  **This page:** PentaCFO — Penta namespace reference and canonicalization guide for PentaCFO.
...
Route work to PentaCFO when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: transact-economic, govern, observe.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaCFO` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `61472b234a623fe253b05bcecfebc30b02dcfed188b573115a6ef4283a090f3d`
