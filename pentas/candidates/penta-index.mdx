---
title: "PentaIndex"
sidebarTitle: "PentaIndex"
description: "Penta namespace reference and canonicalization guide for PentaIndex."
...
<Info>
  ...
  **This page:** PentaIndex — Penta namespace reference and canonicalization guide for PentaIndex.
...
Route work to PentaIndex when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, retrieve.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaIndex` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `86669a96125281bf3142c7cc9d30f501aa069eed4cd4a2eef616fc7259f84408`
