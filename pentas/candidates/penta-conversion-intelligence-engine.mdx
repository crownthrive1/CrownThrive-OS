...
Route work to Penta Conversion Intelligence Engine when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: recover, observe, support-operate, build, test-certify, publish.
...
- This record hash: `59584e7e3d4d3f9efec23112d2fcc0956b09a8109bfe7d6e4d011576b756abe6`
