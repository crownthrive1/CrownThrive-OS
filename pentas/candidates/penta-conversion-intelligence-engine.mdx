---
title: "Penta Conversion Intelligence Engine"
sidebarTitle: "Penta Conversion Intelligence Engine"
description: "Penta namespace reference and canonicalization guide for Penta Conversion Intelligence Engine."
...
<Info>
  ...
  **This page:** Penta Conversion Intelligence Engine — Penta namespace reference and canonicalization guide for Penta Conversion Intelligence Engine.
...
## Penta Conversion Intelligence Engine
...
| Provisional family | [Resilience Continuity](/pentas/families/resilience-continuity) |
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Build, Test & Release](/pentas/layers/build-release) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Build](/pentas/jobs/build), [Test & Certify](/pentas/jobs/test-certify), [Publish](/pentas/jobs/publish), [Analyze & Research](/pentas/jobs/analyze-research) |
...
Route work to Penta Conversion Intelligence Engine when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, build, test-certify, publish, analyze-research.
...
2. Match the request to the documented jobs: `govern`, `document`, `build`, `test-certify`, `publish`, `analyze-research`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Conversion Intelligence Engine` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `a6d66fa455c4042f541ce60196eafcc4d9ab62172c76cfbf1d696c3065d2db10`
