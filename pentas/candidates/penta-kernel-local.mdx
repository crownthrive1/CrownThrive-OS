---
title: "PentaKernelLocal"
sidebarTitle: "PentaKernelLocal"
description: "Penta namespace reference and canonicalization guide for PentaKernelLocal."
...
<Info>
  ...
  **This page:** PentaKernelLocal — Penta namespace reference and canonicalization guide for PentaKernelLocal.
...
Route work to PentaKernelLocal when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: architect, govern, support-operate.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaKernelLocal` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `eed1ee460c11cead7ec78232ad9bd54dd6a05ed263018674083e2e09dfc450a3`
