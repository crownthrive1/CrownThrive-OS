...
Route work to PentaKernelLocal when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
- This record hash: `215d89dfea65e82b9ab114b46e8267a9dcbafffe403b1cc29b1e22945c1026f0`
