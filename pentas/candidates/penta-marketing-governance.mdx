---
title: "Penta Marketing Governance"
sidebarTitle: "Penta Marketing Governance"
description: "Penta namespace reference and canonicalization guide for Penta Marketing Governance."
...
<Info>
  ...
  **This page:** Penta Marketing Governance — Penta namespace reference and canonicalization guide for Penta Marketing Governance.
...
| Provisional family | [Governance Legal](/pentas/families/governance-legal) |
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Security & Trust](/pentas/layers/security-trust), [Communications, Growth & Service](/pentas/layers/communications-growth) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Secure](/pentas/jobs/secure), [Document](/pentas/jobs/document), [Communicate & Grow](/pentas/jobs/communicate-grow) |
...
Route work to Penta Marketing Governance when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, secure, document, communicate-grow.
...
2. Match the request to the documented jobs: `govern`, `secure`, `document`, `communicate-grow`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Marketing Governance` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `95a14b0b7ea6b63386f8d62e9a5ff61a90f13766c5506ba5ea287e62b07d7713`
