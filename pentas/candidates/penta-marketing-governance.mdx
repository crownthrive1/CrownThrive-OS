...
Route work to Penta Marketing Governance when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, communicate-grow.
...
- This record hash: `bc1ddfdd20f49bdabc7e20adecff9fa76b89e2a557efb62ec9eeb9cad8d4a179`
