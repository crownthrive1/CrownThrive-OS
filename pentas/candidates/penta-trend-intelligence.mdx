---
title: "Penta Trend Intelligence"
sidebarTitle: "Penta Trend Intelligence"
description: "Penta namespace reference and canonicalization guide for Penta Trend Intelligence."
...
<Info>
  ...
  **This page:** Penta Trend Intelligence — Penta namespace reference and canonicalization guide for Penta Trend Intelligence.
...
Route work to Penta Trend Intelligence when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Trend Intelligence` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `1c58c6d54d273c96a1ed2acc29de868e686ecadadba9f1436c2a1491f1fbfc18`
