...
Route work to Penta Trend Intelligence when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: analyze-research, retrieve, observe.
...
- This record hash: `a1273faa4242c89aa0baaec52aa84dbecdefef74c814a767f699faf19d44ba72`
