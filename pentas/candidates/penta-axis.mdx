---
title: "PentaAxis"
sidebarTitle: "PentaAxis"
description: "Penta namespace reference and canonicalization guide for PentaAxis."
...
<Info>
  ...
  **This page:** PentaAxis — Penta namespace reference and canonicalization guide for PentaAxis.
...
Route work to PentaAxis when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: architect, govern, support-operate.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaAxis` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `663dda7cc31b8fde01439c63f0690bc9be54391384e464cd255adb9dada0472c`
