---
title: "PentaCoach"
sidebarTitle: "PentaCoach"
description: "Penta namespace reference and canonicalization guide for PentaCoach."
...
<Info>
  ...
  **This page:** PentaCoach — Penta namespace reference and canonicalization guide for PentaCoach.
...
Route work to PentaCoach when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, manage-people-community.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaCoach` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `90a28352c00a4f8917985e2bf1918c327aeb4d53a30c365f6c14f148ec0fd1cf`
