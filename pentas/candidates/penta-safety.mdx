---
title: "PentaSafety"
sidebarTitle: "PentaSafety"
description: "Penta namespace reference and canonicalization guide for PentaSafety."
...
<Info>
  ...
  **This page:** PentaSafety — Penta namespace reference and canonicalization guide for PentaSafety.
...
Route work to PentaSafety when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaSafety` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `9861cd0e68e050c5956705675bf981da41d90dabcd491d53398291258289a4de`
