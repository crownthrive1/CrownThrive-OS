---
title: "PentaRecruit"
sidebarTitle: "PentaRecruit"
description: "Penta namespace reference and canonicalization guide for PentaRecruit."
...
<Info>
  ...
  **This page:** PentaRecruit — Penta namespace reference and canonicalization guide for PentaRecruit.
...
Route work to PentaRecruit when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, manage-people-community.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaRecruit` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `49a88ce8fedbd8937743b065c92679d573c90f1e05f438adc5483e46dde3b3ee`
