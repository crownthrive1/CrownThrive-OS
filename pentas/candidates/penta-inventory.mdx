---
title: "PentaInventory"
sidebarTitle: "PentaInventory"
description: "Penta namespace reference and canonicalization guide for PentaInventory."
...
<Info>
  ...
  **This page:** PentaInventory — Penta namespace reference and canonicalization guide for PentaInventory.
...
Route work to PentaInventory when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaInventory` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `cbf8828b9faa75665d012c191da342ebe3bb9682c6431e376fae1ed991b98fcb`
