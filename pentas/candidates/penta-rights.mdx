---
title: "PentaRights"
sidebarTitle: "PentaRights"
description: "Penta namespace reference and canonicalization guide for PentaRights."
...
<Info>
  ...
  **This page:** PentaRights — Penta namespace reference and canonicalization guide for PentaRights.
...
Route work to PentaRights when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaRights` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `6bd7edfd63d47cb2d2eb5db0593144919a8f3c7f36da595b3d3baaa717ed0e50`
