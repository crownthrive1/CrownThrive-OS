---
title: "PentaOps"
sidebarTitle: "PentaOps"
description: "Penta namespace reference and canonicalization guide for PentaOps."
...
<Info>
  ...
  **This page:** PentaOps — Penta namespace reference and canonicalization guide for PentaOps.
...
Route work to PentaOps when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaOps` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `1db802efb719ddb4dc637a9ced395eed8b43f4c2131beedf7848fa4ed8b14173`
