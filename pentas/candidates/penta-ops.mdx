...
Route work to PentaOps when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: classification pending.
...
- This record hash: `bd5a66c0ddd818a807998f5d44e29cab7ca2f25b4f1e06bba42d1f7960a69732`
