---
title: "PentaFinance"
sidebarTitle: "PentaFinance"
description: "Penta namespace reference and canonicalization guide for PentaFinance."
...
<Info>
  ...
  **This page:** PentaFinance — Penta namespace reference and canonicalization guide for PentaFinance.
...
Route work to PentaFinance when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, transact-economic.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaFinance` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `232d20b285828d490891c437a0d24cfacd4c87c36b90edb2d6569c571eef5948`
