---
title: "PentaStudio"
sidebarTitle: "PentaStudio"
description: "Penta namespace reference and canonicalization guide for PentaStudio."
...
<Info>
  ...
  **This page:** PentaStudio — Penta namespace reference and canonicalization guide for PentaStudio.
...
Route work to PentaStudio when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, publish, build.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaStudio` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `6f6e00801a251f01af5241dc6430cf7924a6b8323f0e0fa253b4742f5cc24761`
