...
Route work to PentaStudio when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: publish, build, communicate-grow.
...
- This record hash: `4309f9aab4fdf713336cfb650edda9508c14e1e06e0a9902ee4f90750002823d`
