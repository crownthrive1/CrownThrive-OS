...
Route work to PentaStory when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: publish, build, communicate-grow.
...
- This record hash: `1b0704f1926e4c9678c5cd9df50dd494a504e8491b1b6a107a9c1c4bdcf041a4`
