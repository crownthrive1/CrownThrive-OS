---
title: "PentaStory"
sidebarTitle: "PentaStory"
description: "Penta namespace reference and canonicalization guide for PentaStory."
...
<Info>
  ...
  **This page:** PentaStory — Penta namespace reference and canonicalization guide for PentaStory.
...
Route work to PentaStory when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, publish, build.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaStory` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `5406c395b3d6e6bf467960693a4532c6a97da8d1947793738b055736cbc1cd66`
