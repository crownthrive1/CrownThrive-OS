---
title: "PentaUX"
sidebarTitle: "PentaUX"
description: "Penta namespace reference and canonicalization guide for PentaUX."
...
<Info>
  ...
  **This page:** PentaUX — Penta namespace reference and canonicalization guide for PentaUX.
...
Route work to PentaUX when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, support-operate.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaUX` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `f80f2a0badd02fee1c5df9ce6830974e724aafe86bae3106df5e7f6a6e9c8cc6`
