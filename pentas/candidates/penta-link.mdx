---
title: "PentaLink"
sidebarTitle: "PentaLink"
description: "Penta namespace reference and canonicalization guide for PentaLink."
...
<Info>
  ...
  **This page:** PentaLink — Penta namespace reference and canonicalization guide for PentaLink.
...
Route work to PentaLink when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: route, orchestrate, support-operate.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaLink` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `6ce8be7cd1c37f7ac42e8d0cdfadaeae7551918fca84e5549525965e8ba2db41`
