---
title: "Penta Customer Journey Mapper"
sidebarTitle: "Penta Customer Journey Mapper"
description: "Penta namespace reference and canonicalization guide for Penta Customer Journey Mapper."
...
<Info>
  ...
  **This page:** Penta Customer Journey Mapper — Penta namespace reference and canonicalization guide for Penta Customer Journey Mapper.
...
Route work to Penta Customer Journey Mapper when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: communicate-grow, support-operate, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Customer Journey Mapper` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `64c20a3eb71e50647f0382eca28a0912c1b0e69d72585e61c2250c7cfa714ffb`
