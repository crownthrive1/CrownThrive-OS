...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Experience & Interface](/pentas/layers/experience-interface) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Support & Operate](/pentas/jobs/support-operate) |
...
Route work to Penta Customer Journey Mapper when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, support-operate.
...
2. Match the request to the documented jobs: `govern`, `document`, `support-operate`.
...
- This record hash: `17016f9287607488f02b64c884ade3d4b1cb887007df8cb1f8ae0996b9e6f51f`
