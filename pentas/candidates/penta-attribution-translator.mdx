---
title: "Penta Attribution Translator"
sidebarTitle: "Penta Attribution Translator"
description: "Penta namespace reference and canonicalization guide for Penta Attribution Translator."
...
<Info>
  ...
  **This page:** Penta Attribution Translator — Penta namespace reference and canonicalization guide for Penta Attribution Translator.
...
Route work to Penta Attribution Translator when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: recover, observe, support-operate.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Attribution Translator` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `dad68f9b7071cd908904e38a19c058e9b8e3b2ec3178f835fea951d081deb386`
