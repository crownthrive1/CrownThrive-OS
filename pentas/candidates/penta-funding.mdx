---
title: "PentaFunding"
sidebarTitle: "PentaFunding"
description: "Penta namespace reference and canonicalization guide for PentaFunding."
...
<Info>
  ...
  **This page:** PentaFunding — Penta namespace reference and canonicalization guide for PentaFunding.
...
Route work to PentaFunding when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: transact-economic, govern, observe.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaFunding` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `a806b5b64e9d198dccbebe781f2e394f6ffe881a019e2e41ccfedd3d60a16dc8`
