---
title: "PentaTemplate"
sidebarTitle: "PentaTemplate"
description: "Penta namespace reference and canonicalization guide for PentaTemplate."
...
<Info>
  ...
  **This page:** PentaTemplate — Penta namespace reference and canonicalization guide for PentaTemplate.
...
Route work to PentaTemplate when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaTemplate` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `c73f07797bcb30d2e47bdb949f4a354831cbd6e82ff28cffcb4c070fd0389cf6`
