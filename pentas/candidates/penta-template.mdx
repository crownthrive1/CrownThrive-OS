...
Route work to PentaTemplate when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: document, retrieve, transform.
...
- This record hash: `db479bb681e40727b9ffd0511bfca2b269e8be4a93f393e7268e425121a84f49`
