---
title: "PentaProfit"
sidebarTitle: "PentaProfit"
description: "Penta namespace reference and canonicalization guide for PentaProfit."
...
<Info>
  ...
  **This page:** PentaProfit — Penta namespace reference and canonicalization guide for PentaProfit.
...
Route work to PentaProfit when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: transact-economic, govern, observe.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaProfit` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `2f0618dc0d964c81bcfc00dd11013b47142c31041e7d4c960c1e8b454b45bacd`
