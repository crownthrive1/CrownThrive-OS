---
title: "PentaCulture"
sidebarTitle: "PentaCulture"
description: "Penta namespace reference and canonicalization guide for PentaCulture."
...
<Info>
  ...
  **This page:** PentaCulture — Penta namespace reference and canonicalization guide for PentaCulture.
...
Route work to PentaCulture when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaCulture` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `4f08e94e6322d9c57a5e73d00b741cca14c59d8c03cc285687c95d9ed2efadc7`
