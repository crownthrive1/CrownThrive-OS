...
Route work to PentaToolkit when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: orchestrate, build, support-operate.
...
- This record hash: `3a2e65ae3197f658766e76a3ba057a8286820f667568565a22e5eb88c8fff740`
