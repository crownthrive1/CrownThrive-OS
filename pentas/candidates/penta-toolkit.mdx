---
title: "PentaToolkit"
sidebarTitle: "PentaToolkit"
description: "Penta namespace reference and canonicalization guide for PentaToolkit."
...
<Info>
  ...
  **This page:** PentaToolkit — Penta namespace reference and canonicalization guide for PentaToolkit.
...
Route work to PentaToolkit when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaToolkit` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `688a80a11032e20b548705f71697a6d347640b58975a542b57d4c47a5b25b23a`
