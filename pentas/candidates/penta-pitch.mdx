---
title: "PentaPitch"
sidebarTitle: "PentaPitch"
description: "Penta namespace reference and canonicalization guide for PentaPitch."
...
<Info>
  ...
  **This page:** PentaPitch — Penta namespace reference and canonicalization guide for PentaPitch.
...
Route work to PentaPitch when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaPitch` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `424fbbbc5a4d5b98723ef0e06cc62f60328fb1924948bc689e6853d1b34ae731`
