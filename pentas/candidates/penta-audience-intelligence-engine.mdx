---
title: "Penta Audience Intelligence Engine"
sidebarTitle: "Penta Audience Intelligence Engine"
description: "Penta namespace reference and canonicalization guide for Penta Audience Intelligence Engine."
...
<Info>
  ...
  **This page:** Penta Audience Intelligence Engine — Penta namespace reference and canonicalization guide for Penta Audience Intelligence Engine.
...
## Penta Audience Intelligence Engine
...
Route work to Penta Audience Intelligence Engine when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, communicate-grow, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Audience Intelligence Engine` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `8896e2b85dbbc2fddeeb10f33cac8dc6f1767b244cc0df7e8adf521cf47195f5`
