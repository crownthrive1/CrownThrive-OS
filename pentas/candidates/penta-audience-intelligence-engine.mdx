...
Route work to Penta Audience Intelligence Engine when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: analyze-research, retrieve, observe, communicate-grow.
...
- This record hash: `232b666e93a2244f83374b64d2715b6e9770a7d1df8a8ca7c76d85696beb5c65`
