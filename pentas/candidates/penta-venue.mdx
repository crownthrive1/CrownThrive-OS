---
title: "PentaVenue"
sidebarTitle: "PentaVenue"
description: "Penta namespace reference and canonicalization guide for PentaVenue."
...
<Info>
  ...
  **This page:** PentaVenue — Penta namespace reference and canonicalization guide for PentaVenue.
...
Route work to PentaVenue when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: publish, build, communicate-grow.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaVenue` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `7012830363c32792652bca7aa4897a3d6834e484686f57c77eac9122388a2d4f`
