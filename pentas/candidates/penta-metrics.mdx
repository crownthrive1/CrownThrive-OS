---
title: "PentaMetrics"
sidebarTitle: "PentaMetrics"
description: "Penta namespace reference and canonicalization guide for PentaMetrics."
...
<Info>
  ...
  **This page:** PentaMetrics — Penta namespace reference and canonicalization guide for PentaMetrics.
...
| Candidate class | `alias_reference` |
| Source state | `prior_namespace_reconciliation` |
| Canonical target | [PentaMetric](/pentas/canonical/penta-metric) |
...
Route work to PentaMetrics when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, observe, recover.
...
- This record hash: `1fe1bbd538647f0b3c52c88248c3bce96d5bbdd51ab82cdd3ee40480f5c31919`
