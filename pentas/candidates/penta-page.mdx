---
title: "PentaPage"
sidebarTitle: "PentaPage"
description: "Penta namespace reference and canonicalization guide for PentaPage."
...
<Info>
  ...
  **This page:** PentaPage — Penta namespace reference and canonicalization guide for PentaPage.
...
Route work to PentaPage when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, support-operate.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaPage` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `a90e3ebda0fc4705b3c160b9a5247933a92ccb1a33fedb7f0bb94d1a1ed849b8`
