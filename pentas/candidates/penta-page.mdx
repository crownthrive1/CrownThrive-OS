...
Route work to PentaPage when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: support-operate.
...
- This record hash: `a68b792f67d8d9bf581ff0acdceb5f92ebbff1011031feba5fc56f8185cada28`
