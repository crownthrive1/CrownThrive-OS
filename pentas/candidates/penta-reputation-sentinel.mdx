---
title: "Penta Reputation Sentinel"
sidebarTitle: "Penta Reputation Sentinel"
description: "Penta namespace reference and canonicalization guide for Penta Reputation Sentinel."
...
<Info>
  ...
  **This page:** Penta Reputation Sentinel — Penta namespace reference and canonicalization guide for Penta Reputation Sentinel.
...
Route work to Penta Reputation Sentinel when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Reputation Sentinel` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `0c068df8d83b5cb065a738b6784d1c768e21dfe6ffe8d2d66bd4de4c29844e69`
