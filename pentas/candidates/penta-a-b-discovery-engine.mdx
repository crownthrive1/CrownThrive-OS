---
title: "Penta A/B Discovery Engine"
sidebarTitle: "Penta A/B Discovery Engine"
description: "Penta namespace reference and canonicalization guide for Penta A/B Discovery Engine."
...
<Info>
  ...
  **This page:** Penta A/B Discovery Engine — Penta namespace reference and canonicalization guide for Penta A/B Discovery Engine.
...
Route work to Penta A/B Discovery Engine when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta A/B Discovery Engine` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `e2de6c6c8bef4a339b3c46e8211298893a5d16903cdcf887432c97c315ad6449`
