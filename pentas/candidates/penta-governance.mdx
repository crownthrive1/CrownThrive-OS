---
title: "PentaGovernance"
sidebarTitle: "PentaGovernance"
description: "Penta namespace reference and canonicalization guide for PentaGovernance."
...
<Info>
  ...
  **This page:** PentaGovernance — Penta namespace reference and canonicalization guide for PentaGovernance.
...
| Source state | `founder_referenced_candidate` |
...
Route work to PentaGovernance when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaGovernance` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `c1ff40652d381bcd15d40fa1948ba2dd36f5e2dbe5759be7c5357c7aa0db334c`
