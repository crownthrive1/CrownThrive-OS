---
title: "PentaVolunteer"
sidebarTitle: "PentaVolunteer"
description: "Penta namespace reference and canonicalization guide for PentaVolunteer."
...
<Info>
  ...
  **This page:** PentaVolunteer — Penta namespace reference and canonicalization guide for PentaVolunteer.
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Workforce, People & Community](/pentas/layers/workforce-community) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Manage People & Community](/pentas/jobs/manage-people-community) |
...
Route work to PentaVolunteer when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, manage-people-community.
...
2. Match the request to the documented jobs: `govern`, `document`, `manage-people-community`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaVolunteer` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `4718e5b078a7df6856c27d9827a168ffe9b9dd878df62128ea0aa20ada4f6ad5`
