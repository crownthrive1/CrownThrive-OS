---
title: "PentaTreasury"
sidebarTitle: "PentaTreasury"
description: "Penta namespace reference and canonicalization guide for PentaTreasury."
...
<Info>
  ...
  **This page:** PentaTreasury — Penta namespace reference and canonicalization guide for PentaTreasury.
...
Route work to PentaTreasury when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, transact-economic.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaTreasury` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `c80619419347805d7c90fb8317b0b3462d77edb0ce5256d34bfca97347d39707`
