---
title: "Penta Media Mix Modeler"
sidebarTitle: "Penta Media Mix Modeler"
description: "Penta namespace reference and canonicalization guide for Penta Media Mix Modeler."
...
<Info>
  ...
  **This page:** Penta Media Mix Modeler — Penta namespace reference and canonicalization guide for Penta Media Mix Modeler.
...
Route work to Penta Media Mix Modeler when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, publish, build.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Media Mix Modeler` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `1e2fca6625b1867501e7674ff64007227f141c555a0899a3901c27166b333c39`
