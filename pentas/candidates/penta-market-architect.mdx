---
title: "Penta Market Architect"
sidebarTitle: "Penta Market Architect"
description: "Penta namespace reference and canonicalization guide for Penta Market Architect."
...
<Info>
  ...
  **This page:** Penta Market Architect — Penta namespace reference and canonicalization guide for Penta Market Architect.
...
Route work to Penta Market Architect when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: transact-economic, govern, observe, communicate-grow.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Market Architect` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `521ebb93642727495e3b6e1c2b7faceb093c6943a7556cdc6f6006f75589d90e`
