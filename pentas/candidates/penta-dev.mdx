---
title: "PentaDev"
sidebarTitle: "PentaDev"
description: "Penta namespace reference and canonicalization guide for PentaDev."
...
<Info>
  ...
  **This page:** PentaDev — Penta namespace reference and canonicalization guide for PentaDev.
...
Route work to PentaDev when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: architect, govern, support-operate.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaDev` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `f305f40c4f57f078bfdd1f0dbf8228931b3b66e12f8f9f81110bbf7f79cc5f9c`
