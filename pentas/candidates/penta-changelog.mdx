---
title: "PentaChangelog"
sidebarTitle: "PentaChangelog"
description: "Penta namespace reference and canonicalization guide for PentaChangelog."
...
<Info>
  ...
  **This page:** PentaChangelog — Penta namespace reference and canonicalization guide for PentaChangelog.
...
Route work to PentaChangelog when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaChangelog` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `7bd79f125139cbd46d6b47024f0dd705ba43b4e370d1e29e635cb3ba05e4951a`
