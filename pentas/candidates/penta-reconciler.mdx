...
| --- | --- |
| Architectural layers | [Build, Test & Release](/pentas/layers/build-release), [Observability & Reliability](/pentas/layers/observability-reliability) |
...
Route work to Penta-reconciler when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: build, test-certify, publish, observe, recover.
...
- This record hash: `14a82daeaa0f0a9efc7cb72ddbe74a727e5dae4db4defbc775678a015e6182b8`
