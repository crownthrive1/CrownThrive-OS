---
title: "Penta-reconciler"
sidebarTitle: "Penta-reconciler"
description: "Penta namespace reference and canonicalization guide for Penta-reconciler."
...
<Info>
  ...
  **This page:** Penta-reconciler — Penta namespace reference and canonicalization guide for Penta-reconciler.
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Build, Test & Release](/pentas/layers/build-release), [Observability & Reliability](/pentas/layers/observability-reliability) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Build](/pentas/jobs/build), [Test & Certify](/pentas/jobs/test-certify), [Publish](/pentas/jobs/publish), [Observe](/pentas/jobs/observe) |
...
Route work to Penta-reconciler when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, build, test-certify, publish, observe.
...
2. Match the request to the documented jobs: `govern`, `document`, `build`, `test-certify`, `publish`, `observe`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta-reconciler` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `dab993a8de177d513cc3820773894f290238e8e0123380f8fbd69cd726618546`
