---
title: "Penta Landing Page Architect"
sidebarTitle: "Penta Landing Page Architect"
description: "Penta namespace reference and canonicalization guide for Penta Landing Page Architect."
...
<Info>
  ...
  **This page:** Penta Landing Page Architect — Penta namespace reference and canonicalization guide for Penta Landing Page Architect.
...
Route work to Penta Landing Page Architect when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: communicate-grow, support-operate, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Landing Page Architect` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `e013d1197ff8b106baabd29dd2e8c13893c5209dfaf366bb111a084be9b4cccd`
