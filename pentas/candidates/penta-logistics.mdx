---
title: "PentaLogistics"
sidebarTitle: "PentaLogistics"
description: "Penta namespace reference and canonicalization guide for PentaLogistics."
...
<Info>
  ...
  **This page:** PentaLogistics — Penta namespace reference and canonicalization guide for PentaLogistics.
...
Route work to PentaLogistics when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaLogistics` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `2d7e84fb73262754458bfa59339db750b7dd5bf22832d97a39af93c7c72e6ee8`
