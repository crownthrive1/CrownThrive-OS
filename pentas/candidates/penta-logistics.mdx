...
Route work to PentaLogistics when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: classification pending.
...
- This record hash: `f6cd76ee97e40424d21e6c1171b05f005197a3537be7c927f4732e721c0f8efe`
