---
title: "PentaSite"
sidebarTitle: "PentaSite"
description: "Penta namespace reference and canonicalization guide for PentaSite."
...
<Info>
  ...
  **This page:** PentaSite — Penta namespace reference and canonicalization guide for PentaSite.
...
| Provisional family | [System Architecture](/pentas/families/system-architecture) |
...
Route work to PentaSite when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, support-operate.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaSite` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `afb4e315f2853492244ce28e9cf2ce552b9cbc1f107b392668b053e1320859e4`
