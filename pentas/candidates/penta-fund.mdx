---
title: "PentaFund"
sidebarTitle: "PentaFund"
description: "Penta namespace reference and canonicalization guide for PentaFund."
...
<Info>
  ...
  **This page:** PentaFund — Penta namespace reference and canonicalization guide for PentaFund.
...
Route work to PentaFund when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: transact-economic, govern, observe.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaFund` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `1b38554456544f26041be29abb1dd09b9742c1a7899469a83a72e3f78c8e2e99`
