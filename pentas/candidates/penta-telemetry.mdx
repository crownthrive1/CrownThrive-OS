---
title: "PentaTelemetry"
sidebarTitle: "PentaTelemetry"
description: "Penta namespace reference and canonicalization guide for PentaTelemetry."
...
<Info>
  ...
  **This page:** PentaTelemetry — Penta namespace reference and canonicalization guide for PentaTelemetry.
...
| Provisional family | [Observability Organic](/pentas/families/observability-organic) |
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Observability & Reliability](/pentas/layers/observability-reliability) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Observe](/pentas/jobs/observe), [Recover](/pentas/jobs/recover) |
...
Route work to PentaTelemetry when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, observe, recover.
...
2. Match the request to the documented jobs: `govern`, `document`, `observe`, `recover`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaTelemetry` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `e13536907cd59b4285bfd551948d15c7c1d33ebfdd28a2c621ce482c3dd8decd`
