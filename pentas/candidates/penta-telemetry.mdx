...
Route work to PentaTelemetry when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: observe, recover, support-operate.
...
- This record hash: `127c803bc200bb7396173f0da5f86264bc2aa855852e01e33c45e65f3603369a`
