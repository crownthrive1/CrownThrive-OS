---
title: "Penta Keyword Intent Mapper"
sidebarTitle: "Penta Keyword Intent Mapper"
description: "Penta namespace reference and canonicalization guide for Penta Keyword Intent Mapper."
...
<Info>
  ...
  **This page:** Penta Keyword Intent Mapper — Penta namespace reference and canonicalization guide for Penta Keyword Intent Mapper.
...
Route work to Penta Keyword Intent Mapper when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Keyword Intent Mapper` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `0953ee93f29cda1f7edc5efc7e50249bc82c16880038c8025ec3c85d2b4d7fa9`
