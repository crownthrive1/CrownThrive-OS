---
title: "PentaOnboard"
sidebarTitle: "PentaOnboard"
description: "Penta namespace reference and canonicalization guide for PentaOnboard."
...
<Info>
  ...
  **This page:** PentaOnboard — Penta namespace reference and canonicalization guide for PentaOnboard.
...
Route work to PentaOnboard when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaOnboard` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `3e26bff04113b00b21bdc6bca4a36de96459e1b449b7502cdda52c9f37f4975d`
