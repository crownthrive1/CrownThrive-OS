---
title: "PentaCrowd"
sidebarTitle: "PentaCrowd"
description: "Penta namespace reference and canonicalization guide for PentaCrowd."
...
<Info>
  ...
  **This page:** PentaCrowd — Penta namespace reference and canonicalization guide for PentaCrowd.
...
Route work to PentaCrowd when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaCrowd` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `03a93d5907770304ddf4da35cc9db381549c3d4bb406f885b274f619ee1576b8`
