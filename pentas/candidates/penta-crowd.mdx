...
Route work to PentaCrowd when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: classification pending.
...
- This record hash: `4fae50721a5e41e835408acf071b455ef7e73f9e8fa10578a90bd9cad15a8e29`
