...
Route work to PentaPartner when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: communicate-grow, support-operate, analyze-research.
...
- This record hash: `91c4caf712dcf98f804296d926a8e6a191f87397f1434a4a65b3462f85436741`
