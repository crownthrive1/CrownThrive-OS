---
title: "PentaPartner"
sidebarTitle: "PentaPartner"
description: "Penta namespace reference and canonicalization guide for PentaPartner."
...
<Info>
  ...
  **This page:** PentaPartner — Penta namespace reference and canonicalization guide for PentaPartner.
...
Route work to PentaPartner when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, communicate-grow.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaPartner` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `abe354007ed0bda849bbf74da1da9c46bb5e9674621e0cc0607895e08deb992a`
