---
title: "Penta Quarantine"
sidebarTitle: "Penta Quarantine"
description: "Penta namespace reference and canonicalization guide for Penta Quarantine."
...
<Info>
  ...
  **This page:** Penta Quarantine — Penta namespace reference and canonicalization guide for Penta Quarantine.
...
Route work to Penta Quarantine when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Quarantine` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `4794aa8e20046670534db2fdf519ab0b058f7fec966887cc49a2f493f62faf54`
