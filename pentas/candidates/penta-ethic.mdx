...
Route work to PentaEthic when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, secure, document.
...
- This record hash: `ab7e23675ecd084b1328adb73e534693542fa3114fa9eb7f98b40a5d40112ef2`
