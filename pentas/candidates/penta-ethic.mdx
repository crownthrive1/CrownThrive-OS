---
title: "PentaEthic"
sidebarTitle: "PentaEthic"
description: "Penta namespace reference and canonicalization guide for PentaEthic."
...
<Info>
  ...
  **This page:** PentaEthic — Penta namespace reference and canonicalization guide for PentaEthic.
...
Route work to PentaEthic when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaEthic` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `d4d883b189ae029745f0b66980a32f38a5d90f5c1fa781bc77f99c86c4cf5387`
