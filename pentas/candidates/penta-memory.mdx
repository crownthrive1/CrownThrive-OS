...
Route work to PentaMemory when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: document, retrieve, transform.
...
- This record hash: `51d2fb87f126004f62dbd2e4d9d67bee2465b82938bd78249a5cd7b32a854192`
