---
title: "PentaMemory"
sidebarTitle: "PentaMemory"
description: "Penta namespace reference and canonicalization guide for PentaMemory."
...
<Info>
  ...
  **This page:** PentaMemory — Penta namespace reference and canonicalization guide for PentaMemory.
...
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Retrieve](/pentas/jobs/retrieve) |
...
Route work to PentaMemory when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, retrieve.
...
2. Match the request to the documented jobs: `govern`, `document`, `retrieve`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaMemory` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `c0feba5dae18263547cdd6e68eed9ffd59e16668f8dd6b71ad2c3f2944003c12`
