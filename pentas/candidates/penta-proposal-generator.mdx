---
title: "Penta Proposal Generator"
sidebarTitle: "Penta Proposal Generator"
description: "Penta namespace reference and canonicalization guide for Penta Proposal Generator."
...
<Info>
  ...
  **This page:** Penta Proposal Generator — Penta namespace reference and canonicalization guide for Penta Proposal Generator.
...
Route work to Penta Proposal Generator when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: communicate-grow, support-operate, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Proposal Generator` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `c4b58ef02ab86d1bfaa50f05df38ed2ed2933d9a755a6ebf0c34fdbdcd3a1298`
