---
title: "PentaScribeMarketer"
sidebarTitle: "PentaScribeMarketer"
description: "Penta namespace reference and canonicalization guide for PentaScribeMarketer."
...
<Info>
  ...
  **This page:** PentaScribeMarketer — Penta namespace reference and canonicalization guide for PentaScribeMarketer.
...
| Provisional family | [Knowledge Semantics Data](/pentas/families/knowledge-semantics-data) |
...
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Retrieve](/pentas/jobs/retrieve), [Communicate & Grow](/pentas/jobs/communicate-grow) |
...
Route work to PentaScribeMarketer when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, retrieve, communicate-grow.
...
2. Match the request to the documented jobs: `govern`, `document`, `retrieve`, `communicate-grow`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaScribeMarketer` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `86436dca64a211f2df3e3f7245ab835f089e9340b72084afa8ce7dd8161678e3`
