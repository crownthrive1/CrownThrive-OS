...
| --- | --- |
| Architectural layers | [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Communications, Growth & Service](/pentas/layers/communications-growth) |
| Jobs / functions | [Document](/pentas/jobs/document), [Retrieve](/pentas/jobs/retrieve), [Transform](/pentas/jobs/transform), [Communicate & Grow](/pentas/jobs/communicate-grow) |
...
Route work to PentaScribeMarketer when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: document, retrieve, transform, communicate-grow.
...
2. Match the request to the documented jobs: `document`, `retrieve`, `transform`, `communicate-grow`.
...
- This record hash: `ef510d9a03a691c2397ef3fa65b1333caff6c77583b39fa48c738b8d7190b427`
