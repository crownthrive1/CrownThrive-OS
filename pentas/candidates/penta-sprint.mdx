...
Route work to PentaSprint when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: publish, build, communicate-grow.
...
- This record hash: `18c55ad422f38cd379a4569abf5d77f891809c1701319b9d6282ae7819fcc099`
