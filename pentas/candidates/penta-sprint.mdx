---
title: "PentaSprint"
sidebarTitle: "PentaSprint"
description: "Penta namespace reference and canonicalization guide for PentaSprint."
...
<Info>
  ...
  **This page:** PentaSprint — Penta namespace reference and canonicalization guide for PentaSprint.
...
Route work to PentaSprint when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, publish, build.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaSprint` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `abb60ab87c8e4498eaab04f321b410b1a0ed321ea5d1991d6d571c1c8f815f52`
