---
title: "Penta Competitive Intelligence Engine"
sidebarTitle: "Penta Competitive Intelligence Engine"
description: "Penta namespace reference and canonicalization guide for Penta Competitive Intelligence Engine."
...
<Info>
  ...
  **This page:** Penta Competitive Intelligence Engine — Penta namespace reference and canonicalization guide for Penta Competitive Intelligence Engine.
...
## Penta Competitive Intelligence Engine
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Analyze & Research](/pentas/jobs/analyze-research) |
...
Route work to Penta Competitive Intelligence Engine when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, analyze-research.
...
2. Match the request to the documented jobs: `govern`, `document`, `analyze-research`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Competitive Intelligence Engine` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `7acc0e4f03bfffd14e4e6673c71b753bdc1c032b637f96b9acf986098980ddf7`
