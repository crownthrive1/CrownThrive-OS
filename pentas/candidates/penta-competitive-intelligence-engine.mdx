...
| Jobs / functions | [Analyze & Research](/pentas/jobs/analyze-research), [Retrieve](/pentas/jobs/retrieve), [Observe](/pentas/jobs/observe) |
...
Route work to Penta Competitive Intelligence Engine when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: analyze-research, retrieve, observe.
...
2. Match the request to the documented jobs: `analyze-research`, `retrieve`, `observe`.
...
- This record hash: `ed1cdf52a9aee8dfab4208c88ba3707c001d91cc313cbfdbebb4a7dd271cbb00`
