---
title: "Penta Lifecycle Marketing Strategist"
sidebarTitle: "Penta Lifecycle Marketing Strategist"
description: "Penta namespace reference and canonicalization guide for Penta Lifecycle Marketing Strategist."
...
<Info>
  ...
  **This page:** Penta Lifecycle Marketing Strategist — Penta namespace reference and canonicalization guide for Penta Lifecycle Marketing Strategist.
...
## Penta Lifecycle Marketing Strategist
...
Route work to Penta Lifecycle Marketing Strategist when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, communicate-grow.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Lifecycle Marketing Strategist` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `0fd294b56cdb44243e47db7f5eeea27cf565f3141de9295ef642751453a4ed0f`
