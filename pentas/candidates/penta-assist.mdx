...
Route work to PentaAssist when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: orchestrate, build, support-operate.
...
- This record hash: `c1f28d8cd020a98a152f1cb9044c555e08e69c49a4a88efc6d0b3c362a1aede7`
