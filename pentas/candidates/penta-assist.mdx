---
title: "PentaAssist"
sidebarTitle: "PentaAssist"
description: "Penta namespace reference and canonicalization guide for PentaAssist."
...
<Info>
  ...
  **This page:** PentaAssist — Penta namespace reference and canonicalization guide for PentaAssist.
...
Route work to PentaAssist when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaAssist` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `e5e800100788a3a2a8b604ca5250602c89d5e69d35a3b6e43be7ff80470c26a9`
