...
Route work to PentaCI when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: build, test-certify, publish.
...
- This record hash: `e4fc0d7ce037cecbeabb80f573d77c42de4946e2241b12e1e3fa0f67e0242bc6`
