---
title: "PentaCI"
sidebarTitle: "PentaCI"
description: "Penta namespace reference and canonicalization guide for PentaCI."
...
<Info>
  ...
  **This page:** PentaCI — Penta namespace reference and canonicalization guide for PentaCI.
...
Route work to PentaCI when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, build, test-certify, publish.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaCI` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `2736d1c1d4fa4a0b2c4ccea5b1b2e04342ef2a2f60f786869b903d4d8eff7511`
