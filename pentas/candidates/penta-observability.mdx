...
Route work to PentaObservability when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: observe, recover, support-operate.
...
- This record hash: `a3f10fe6f8a36a686895ad51cacf149a03897d55e960023bd0200d282325fe6c`
