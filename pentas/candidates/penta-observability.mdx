---
title: "PentaObservability"
sidebarTitle: "PentaObservability"
description: "Penta namespace reference and canonicalization guide for PentaObservability."
...
<Info>
  ...
  **This page:** PentaObservability — Penta namespace reference and canonicalization guide for PentaObservability.
...
Route work to PentaObservability when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaObservability` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `34967fbca9e71a75352f94e83afe24b39c8e6b3341113056035bdccb154da20f`
