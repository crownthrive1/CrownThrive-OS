---
title: "PentaTicket"
sidebarTitle: "PentaTicket"
description: "Penta namespace reference and canonicalization guide for PentaTicket."
...
<Info>
  ...
  **This page:** PentaTicket — Penta namespace reference and canonicalization guide for PentaTicket.
...
Route work to PentaTicket when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaTicket` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `a214ce536343d2410e6f54d7a4768b54546995636718c18ca2192a2b299c462d`
