---
title: "Penta Editorial Calendar Engine"
sidebarTitle: "Penta Editorial Calendar Engine"
description: "Penta namespace reference and canonicalization guide for Penta Editorial Calendar Engine."
...
<Info>
  ...
  **This page:** Penta Editorial Calendar Engine — Penta namespace reference and canonicalization guide for Penta Editorial Calendar Engine.
...
## Penta Editorial Calendar Engine
...
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document) |
...
| Classification provenance | `candidate_canonicalization_default` / `candidate_canonicalization_default` |
...
Route work to Penta Editorial Calendar Engine when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
2. Match the request to the documented jobs: `govern`, `document`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Editorial Calendar Engine` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `53637041a415d1420416dbed6e0994d38678047b10cc86b681a8df1c02fd2fe4`
