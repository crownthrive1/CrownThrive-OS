...
| --- | --- |
| Architectural layers | Pending classification |
| Jobs / functions | Pending classification |
...
| Classification provenance | `pending_classification` / `pending_classification` |
...
Route work to Penta Editorial Calendar Engine when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: classification pending.
...
2. Match the request to the documented jobs: classification-pending.
...
- This record hash: `797b1213246577d3aa03564bc92281c8d77c81546bcf93830154d27431690f06`
