...
Route work to PentaStats when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: analyze-research, retrieve, observe.
...
- This record hash: `8bc142611001762b33f0f8a18a3b62d459d849fad8f97a519d995a085c57024c`
