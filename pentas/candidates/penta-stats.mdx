---
title: "PentaStats"
sidebarTitle: "PentaStats"
description: "Penta namespace reference and canonicalization guide for PentaStats."
...
<Info>
  ...
  **This page:** PentaStats — Penta namespace reference and canonicalization guide for PentaStats.
...
Route work to PentaStats when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaStats` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `aee4e4a3df511d6c4dcf08f966b37a06dc53932cfa22a55a3d5de00c33d9cad1`
