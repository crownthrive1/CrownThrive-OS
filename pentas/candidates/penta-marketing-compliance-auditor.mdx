---
title: "Penta Marketing Compliance Auditor"
sidebarTitle: "Penta Marketing Compliance Auditor"
description: "Penta namespace reference and canonicalization guide for Penta Marketing Compliance Auditor."
...
<Info>
  ...
  **This page:** Penta Marketing Compliance Auditor — Penta namespace reference and canonicalization guide for Penta Marketing Compliance Auditor.
...
## Penta Marketing Compliance Auditor
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Security & Trust](/pentas/layers/security-trust), [Communications, Growth & Service](/pentas/layers/communications-growth) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Secure](/pentas/jobs/secure), [Communicate & Grow](/pentas/jobs/communicate-grow) |
...
Route work to Penta Marketing Compliance Auditor when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, secure, communicate-grow.
...
2. Match the request to the documented jobs: `govern`, `document`, `secure`, `communicate-grow`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Marketing Compliance Auditor` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `6e29e5c22aaffaeeb478844e3a2642d81b91eba015477e8dccbf7943fea2fdd3`
