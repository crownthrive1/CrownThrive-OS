...
| --- | --- |
| Architectural layers | [Security & Trust](/pentas/layers/security-trust), [Control & Governance](/pentas/layers/control-governance), [Communications, Growth & Service](/pentas/layers/communications-growth) |
| Jobs / functions | [Secure](/pentas/jobs/secure), [Govern](/pentas/jobs/govern), [Observe](/pentas/jobs/observe), [Communicate & Grow](/pentas/jobs/communicate-grow) |
...
Route work to Penta Marketing Compliance Auditor when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: secure, govern, observe, communicate-grow.
...
2. Match the request to the documented jobs: `secure`, `govern`, `observe`, `communicate-grow`.
...
- This record hash: `2f43d74ba2c0de9f19b3ce69cfd420c6bc7a981ec5425b5149ca066dd49701b2`
