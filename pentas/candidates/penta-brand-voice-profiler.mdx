---
title: "Penta Brand Voice Profiler"
sidebarTitle: "Penta Brand Voice Profiler"
description: "Penta namespace reference and canonicalization guide for Penta Brand Voice Profiler."
...
<Info>
  ...
  **This page:** Penta Brand Voice Profiler — Penta namespace reference and canonicalization guide for Penta Brand Voice Profiler.
...
Route work to Penta Brand Voice Profiler when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, communicate-grow.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Brand Voice Profiler` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `c754b91eb75027751140535912dd1a6ac85a259c679214c7263b4a95f78af882`
