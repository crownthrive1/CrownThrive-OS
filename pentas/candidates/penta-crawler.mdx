...
Route work to PentaCrawler when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: analyze-research, retrieve, observe.
...
- This record hash: `ae3278d33e9c4b882294d8a32fd93b4bf4b1187fa1c8543f12bfc33a46f6f708`
