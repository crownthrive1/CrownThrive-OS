---
title: "PentaCrawler"
sidebarTitle: "PentaCrawler"
description: "Penta namespace reference and canonicalization guide for PentaCrawler."
...
<Info>
  ...
  **This page:** PentaCrawler — Penta namespace reference and canonicalization guide for PentaCrawler.
...
| Source state | `founder_declared_candidate` |
...
Route work to PentaCrawler when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaCrawler` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `4486ebb884874aa62b9d21e21d71a4a66019a8c8dc9cf4d1badd49489b9c3db0`
