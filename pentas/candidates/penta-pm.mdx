---
title: "PentaPM"
sidebarTitle: "PentaPM"
description: "Penta namespace reference and canonicalization guide for PentaPM."
...
<Info>
  ...
  **This page:** PentaPM — Penta namespace reference and canonicalization guide for PentaPM.
...
| Source state | `prior_component_prefix_reference` |
...
Route work to PentaPM when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaPM` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `760e77fb68da7894fb471107e41e92f6a592be5b7130e3ceed69c575495015e8`
