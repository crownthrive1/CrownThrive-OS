---
title: "PentaLaunch"
sidebarTitle: "PentaLaunch"
description: "Penta namespace reference and canonicalization guide for PentaLaunch."
...
<Info>
  ...
  **This page:** PentaLaunch — Penta namespace reference and canonicalization guide for PentaLaunch.
...
Route work to PentaLaunch when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaLaunch` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `bdd0c6a2180284da12bf2d7e520c6cb6c8975b57fd421fab23235f2657d59310`
