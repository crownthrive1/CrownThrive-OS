---
title: "PentaEvents"
sidebarTitle: "PentaEvents"
description: "Penta namespace reference and canonicalization guide for PentaEvents."
...
<Info>
  ...
  **This page:** PentaEvents — Penta namespace reference and canonicalization guide for PentaEvents.
...
| Provisional family | [Transport Primitives](/pentas/families/transport-primitives) |
...
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Route](/pentas/jobs/route), [Retrieve](/pentas/jobs/retrieve), [Transform](/pentas/jobs/transform) |
...
Route work to PentaEvents when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, route, retrieve, transform.
...
2. Match the request to the documented jobs: `govern`, `document`, `route`, `retrieve`, `transform`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaEvents` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `dfdef5b25ff32d467f4c57d92e33482aef0b69d6b1510646a2570387b4d12ec2`
