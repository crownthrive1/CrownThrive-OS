...
Route work to PentaEvents when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: retrieve, transform, route.
...
- This record hash: `ea80ec914d4786db13557048b4449332cffd3216cd635c2f70b0f096d7eb24c2`
