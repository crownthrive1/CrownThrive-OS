---
title: "PentaLab"
sidebarTitle: "PentaLab"
description: "Penta namespace reference and canonicalization guide for PentaLab."
...
<Info>
  ...
  **This page:** PentaLab — Penta namespace reference and canonicalization guide for PentaLab.
...
Route work to PentaLab when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaLab` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `e5d164380690f24d40c3898774e7105e61db229046fdf5f2a3c77170d79ce726`
