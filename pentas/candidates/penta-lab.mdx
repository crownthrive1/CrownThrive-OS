...
Route work to PentaLab when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: orchestrate, build, support-operate.
...
- This record hash: `7675de2ecd31ca7cc0278c78e9d5a522062e59f0e7a27455354b2eea157fda6a`
