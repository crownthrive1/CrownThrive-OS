---
title: "PentaCareer"
sidebarTitle: "PentaCareer"
description: "Penta namespace reference and canonicalization guide for PentaCareer."
...
<Info>
  ...
  **This page:** PentaCareer — Penta namespace reference and canonicalization guide for PentaCareer.
...
Route work to PentaCareer when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, manage-people-community.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaCareer` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `3dea7d6fbe0408311a9900d06fbd58cb0222bcf46cc1d50f507fe735b96752bd`
