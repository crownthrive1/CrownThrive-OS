...
Route work to PentaCareer when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: manage-people-community, support-operate, communicate-grow.
...
- This record hash: `ec2693dd13b731cf9c644f3edce56486121d1b88dd2569233c33a746858554db`
