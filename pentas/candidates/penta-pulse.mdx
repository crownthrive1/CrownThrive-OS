---
title: "PentaPulse"
sidebarTitle: "PentaPulse"
description: "Penta namespace reference and canonicalization guide for PentaPulse."
...
<Info>
  ...
  **This page:** PentaPulse — Penta namespace reference and canonicalization guide for PentaPulse.
...
Route work to PentaPulse when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaPulse` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `49491fbec2f67a95e98c2175a01f8c17bd7ffc306ecc2fd5556acee9f743c18f`
