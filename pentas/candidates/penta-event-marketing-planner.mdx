---
title: "Penta Event Marketing Planner"
sidebarTitle: "Penta Event Marketing Planner"
description: "Penta namespace reference and canonicalization guide for Penta Event Marketing Planner."
...
<Info>
  ...
  **This page:** Penta Event Marketing Planner — Penta namespace reference and canonicalization guide for Penta Event Marketing Planner.
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Routing, Interop & Transport](/pentas/layers/routing-transport), [Communications, Growth & Service](/pentas/layers/communications-growth) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Route](/pentas/jobs/route), [Retrieve](/pentas/jobs/retrieve), [Transform](/pentas/jobs/transform), [Communicate & Grow](/pentas/jobs/communicate-grow) |
...
Route work to Penta Event Marketing Planner when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, route, retrieve, transform, communicate-grow.
...
2. Match the request to the documented jobs: `govern`, `document`, `route`, `retrieve`, `transform`, `communicate-grow`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Event Marketing Planner` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `d48a84688f1faf5a7450ce7f39955469ebe46108fa1e6ff03aa4656902295881`
