...
| --- | --- |
| Architectural layers | [Communications, Growth & Service](/pentas/layers/communications-growth), [Experience & Interface](/pentas/layers/experience-interface), [Routing, Interop & Transport](/pentas/layers/routing-transport) |
...
Route work to Penta Event Marketing Planner when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: communicate-grow, support-operate, analyze-research, route, retrieve, transform.
...
- This record hash: `089a2564bc8b849130a603b1a0908b412b8d1625551ccc2e18a7079fc1c1e2b2`
