...
Route work to PentaAsset when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: document, retrieve, transform.
...
- This record hash: `63111b15a2659cd7a7ce012c5ee24a14f9c22e56ee5410e437ccac78d4190353`
