---
title: "PentaAsset"
sidebarTitle: "PentaAsset"
description: "Penta namespace reference and canonicalization guide for PentaAsset."
...
<Info>
  ...
  **This page:** PentaAsset — Penta namespace reference and canonicalization guide for PentaAsset.
...
Route work to PentaAsset when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaAsset` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `3c81f770dabaa862dd44ecda045dbe746944a0222b51d1aa41e79ffd3d27c966`
