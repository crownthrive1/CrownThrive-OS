---
title: "PentaPass"
sidebarTitle: "PentaPass"
description: "Penta namespace reference and canonicalization guide for PentaPass."
...
<Info>
  ...
  **This page:** PentaPass — Penta namespace reference and canonicalization guide for PentaPass.
...
Route work to PentaPass when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaPass` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `379339f28c475c93bd525d2280147ee0b62ccd69356648869cc9b05b980756f7`
