---
title: "PentaReason"
sidebarTitle: "PentaReason"
description: "Penta namespace reference and canonicalization guide for PentaReason."
...
<Info>
  ...
  **This page:** PentaReason — Penta namespace reference and canonicalization guide for PentaReason.
...
Route work to PentaReason when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: analyze-research, retrieve, observe.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaReason` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `afca5f7e2ef4e65a95e68407e4809c0c4c354ce376126e35a262329f7f9e009c`
