...
Route work to PentaStartup when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: classification pending.
...
- This record hash: `fa57114de14edfdbbb0fc1166816508bbd93ed9c22329be916d5805406407d13`
