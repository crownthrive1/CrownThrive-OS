---
title: "PentaStartup"
sidebarTitle: "PentaStartup"
description: "Penta namespace reference and canonicalization guide for PentaStartup."
...
<Info>
  ...
  **This page:** PentaStartup — Penta namespace reference and canonicalization guide for PentaStartup.
...
Route work to PentaStartup when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaStartup` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `c88de0db7b15bd7ded6c3fc65323e13f7530a394978ae7febfd17f9a19c1ffd0`
