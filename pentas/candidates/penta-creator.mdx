---
title: "PentaCreator"
sidebarTitle: "PentaCreator"
description: "Penta namespace reference and canonicalization guide for PentaCreator."
...
<Info>
  ...
  **This page:** PentaCreator — Penta namespace reference and canonicalization guide for PentaCreator.
...
Route work to PentaCreator when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, publish, build.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaCreator` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `931c00de86f3c251d51271b9f925e4b97f7a095117d7229d2a0bf1a30edc6d38`
