---
title: "PentaLaw"
sidebarTitle: "PentaLaw"
description: "Penta namespace reference and canonicalization guide for PentaLaw."
...
<Info>
  ...
  **This page:** PentaLaw — Penta namespace reference and canonicalization guide for PentaLaw.
...
Route work to PentaLaw when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaLaw` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `d4569b9f25f6b6b2b1fac58d7d43411cf2ab98d4b61c90b42d41efbb643224c8`
