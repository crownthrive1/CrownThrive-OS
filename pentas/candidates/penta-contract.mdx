---
title: "PentaContract"
sidebarTitle: "PentaContract"
description: "Penta namespace reference and canonicalization guide for PentaContract."
...
<Info>
  ...
  **This page:** PentaContract — Penta namespace reference and canonicalization guide for PentaContract.
...
Route work to PentaContract when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaContract` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `f5036f8bbe1035c8c209166e549b0537654e07f9c2cf67a1c3f566d18a960c06`
