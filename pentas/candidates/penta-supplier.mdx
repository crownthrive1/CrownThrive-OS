---
title: "PentaSupplier"
sidebarTitle: "PentaSupplier"
description: "Penta namespace reference and canonicalization guide for PentaSupplier."
...
<Info>
  ...
  **This page:** PentaSupplier — Penta namespace reference and canonicalization guide for PentaSupplier.
...
Route work to PentaSupplier when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaSupplier` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `a8afd85d1806fb2f4d5f80e5ca43f6b4ad6ca53ada133ae4b34cfe4059d78c8c`
