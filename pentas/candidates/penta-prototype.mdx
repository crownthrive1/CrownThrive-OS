---
title: "PentaPrototype"
sidebarTitle: "PentaPrototype"
description: "Penta namespace reference and canonicalization guide for PentaPrototype."
...
<Info>
  ...
  **This page:** PentaPrototype — Penta namespace reference and canonicalization guide for PentaPrototype.
...
Route work to PentaPrototype when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaPrototype` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `0aea645a7676523da57fb4146acbdecec99de2f29b2d88e836a3e3ec1b5b179e`
