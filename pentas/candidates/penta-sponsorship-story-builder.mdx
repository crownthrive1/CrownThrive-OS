---
title: "Penta Sponsorship Story Builder"
sidebarTitle: "Penta Sponsorship Story Builder"
description: "Penta namespace reference and canonicalization guide for Penta Sponsorship Story Builder."
...
<Info>
  ...
  **This page:** Penta Sponsorship Story Builder — Penta namespace reference and canonicalization guide for Penta Sponsorship Story Builder.
...
## Penta Sponsorship Story Builder
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Build, Test & Release](/pentas/layers/build-release), [Media, Creative & Publishing](/pentas/layers/media-creative) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Build](/pentas/jobs/build), [Test & Certify](/pentas/jobs/test-certify), [Publish](/pentas/jobs/publish) |
...
Route work to Penta Sponsorship Story Builder when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, build, test-certify, publish.
...
2. Match the request to the documented jobs: `govern`, `document`, `build`, `test-certify`, `publish`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Sponsorship Story Builder` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `1a6bea15285c60d973b21a4961a0815b7fa216687c041dc419023318c59c7cb0`
