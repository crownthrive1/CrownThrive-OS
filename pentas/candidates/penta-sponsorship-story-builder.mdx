...
| --- | --- |
| Architectural layers | [Build, Test & Release](/pentas/layers/build-release), [Media, Creative & Publishing](/pentas/layers/media-creative) |
...
Route work to Penta Sponsorship Story Builder when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: build, test-certify, publish.
...
- This record hash: `52a5e43fa85ca81526fd10d46ede9ee6b3a22fd60df9b595ebb769c3edc4a7ac`
