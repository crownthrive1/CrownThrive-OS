---
title: "PentaMentor"
sidebarTitle: "PentaMentor"
description: "Penta namespace reference and canonicalization guide for PentaMentor."
...
<Info>
  ...
  **This page:** PentaMentor — Penta namespace reference and canonicalization guide for PentaMentor.
...
Route work to PentaMentor when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, manage-people-community.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaMentor` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `02a8a3109afc9a07de5fbcd7aa77369b48a770f8bdb2ab2dd01feac40baf7007`
