---
title: "PentaTalent"
sidebarTitle: "PentaTalent"
description: "Penta namespace reference and canonicalization guide for PentaTalent."
...
<Info>
  ...
  **This page:** PentaTalent — Penta namespace reference and canonicalization guide for PentaTalent.
...
Route work to PentaTalent when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, manage-people-community.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaTalent` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `3e4e9a92205469e61b644df50d4d1654a749953dbb3becafb73c2089cc6f870e`
