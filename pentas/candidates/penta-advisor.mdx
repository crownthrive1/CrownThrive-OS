...
Route work to PentaAdvisor when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: orchestrate, build, support-operate.
...
- This record hash: `2e1cefdf83d5c5a8705ad65ab178476aac138a0ce68d1afa227490dd0e0d67b1`
