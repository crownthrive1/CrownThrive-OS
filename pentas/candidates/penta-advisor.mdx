---
title: "PentaAdvisor"
sidebarTitle: "PentaAdvisor"
description: "Penta namespace reference and canonicalization guide for PentaAdvisor."
...
<Info>
  ...
  **This page:** PentaAdvisor — Penta namespace reference and canonicalization guide for PentaAdvisor.
...
Route work to PentaAdvisor when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaAdvisor` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `b8ef4e54c52f204da216383c3b833380c6e133dd0f19e0f357eca24d5a7f6e3c`
