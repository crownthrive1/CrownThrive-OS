---
title: "PentaTrain"
sidebarTitle: "PentaTrain"
description: "Penta namespace reference and canonicalization guide for PentaTrain."
...
<Info>
  ...
  **This page:** PentaTrain — Penta namespace reference and canonicalization guide for PentaTrain.
...
Route work to PentaTrain when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: manage-people-community, support-operate, communicate-grow.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaTrain` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `00a08a3c7044a84c11aa4bfa13d3a3998c6094bc922e25365d1432967d37be71`
