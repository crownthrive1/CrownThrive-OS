...
description: "Penta namespace reference and canonicalization guide for PentaKit."
...
<Info>
  ...
  **This page:** PentaKit — Penta namespace reference and canonicalization guide for PentaKit.
...
Route work to PentaKit when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaKit` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `a9835392eca0aea51e5213f39466ee65eb5fb9c43ed2569f2ce54a08237a5c7e`
