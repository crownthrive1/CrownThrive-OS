---
title: "PentaContent"
sidebarTitle: "PentaContent"
description: "Penta namespace reference and canonicalization guide for PentaContent."
...
<Info>
  ...
  **This page:** PentaContent — Penta namespace reference and canonicalization guide for PentaContent.
...
Route work to PentaContent when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: communicate-grow, support-operate, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaContent` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `a7a282a9abaab1be052a8152b89bc36f9b573a866745def0ac048400b718b548`
