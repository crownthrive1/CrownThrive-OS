---
title: "Penta Trust Signal Scorer"
sidebarTitle: "Penta Trust Signal Scorer"
description: "Penta namespace reference and canonicalization guide for Penta Trust Signal Scorer."
...
<Info>
  ...
  **This page:** Penta Trust Signal Scorer — Penta namespace reference and canonicalization guide for Penta Trust Signal Scorer.
...
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Secure](/pentas/jobs/secure), [Analyze & Research](/pentas/jobs/analyze-research) |
...
Route work to Penta Trust Signal Scorer when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, secure, analyze-research.
...
2. Match the request to the documented jobs: `govern`, `document`, `secure`, `analyze-research`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Trust Signal Scorer` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `cd002c989ac2725794f9e0b82031ad6b71f0f3965764f164a6facada671a0bfd`
