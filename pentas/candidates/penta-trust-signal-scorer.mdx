...
Route work to Penta Trust Signal Scorer when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: secure, govern, observe, analyze-research.
...
- This record hash: `a408dafded708cd76560a84bf6ffbd67c4c87c4ba3ca44f3a0331f002d3103b4`
