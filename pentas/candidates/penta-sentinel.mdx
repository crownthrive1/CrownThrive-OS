---
title: "PentaSentinel"
sidebarTitle: "PentaSentinel"
description: "Penta namespace reference and canonicalization guide for PentaSentinel."
...
<Info>
  ...
  **This page:** PentaSentinel — Penta namespace reference and canonicalization guide for PentaSentinel.
...
Route work to PentaSentinel when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaSentinel` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `e777d64ba26ff54df446b6f95637092682df7bf96c5ceb44769fd22ac908ff91`
