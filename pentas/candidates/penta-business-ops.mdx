---
title: "PentaBusiness Ops"
sidebarTitle: "PentaBusiness Ops"
description: "Penta namespace reference and canonicalization guide for PentaBusiness Ops."
...
<Info>
  ...
  **This page:** PentaBusiness Ops — Penta namespace reference and canonicalization guide for PentaBusiness Ops.
...
Route work to PentaBusiness Ops when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: recover, observe, support-operate.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaBusiness Ops` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `e90f20d1c529fdc4422a5482dd95d2642edd7b449532fc7f60882ddc95d505ae`
