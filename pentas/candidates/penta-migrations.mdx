---
title: "Penta-migrations"
sidebarTitle: "Penta-migrations"
description: "Penta namespace reference and canonicalization guide for Penta-migrations."
...
<Info>
  ...
  **This page:** Penta-migrations — Penta namespace reference and canonicalization guide for Penta-migrations.
...
| Provisional family | [Pending canonical family](/pentas/families) |
...
Route work to Penta-migrations when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, build, test-certify, publish.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta-migrations` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `61ecde73bd073ca325ab18eeb4dccdd8947799d87d75e0ef937b30830d2f338e`
