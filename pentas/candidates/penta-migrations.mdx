...
Route work to Penta-migrations when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: build, test-certify, publish.
...
- This record hash: `f3f9dea4a6a256322075a5c84ad5308defb7888f51253bd7ca8ea8f009306005`
