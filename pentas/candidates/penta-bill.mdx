---
title: "PentaBill"
sidebarTitle: "PentaBill"
description: "Penta namespace reference and canonicalization guide for PentaBill."
...
<Info>
  ...
  **This page:** PentaBill — Penta namespace reference and canonicalization guide for PentaBill.
...
Route work to PentaBill when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, transact-economic.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaBill` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `0dd044535dc1a80500e5098cd0171c6fd12dc16a82e22bc6815d234bf45e92ef`
