---
title: "PentaNodes"
sidebarTitle: "PentaNodes"
description: "Penta namespace reference and canonicalization guide for PentaNodes."
...
<Info>
  ...
  **This page:** PentaNodes — Penta namespace reference and canonicalization guide for PentaNodes.
...
| Provisional family | [Routing Interoperability](/pentas/families/routing-interoperability) |
...
Route work to PentaNodes when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: route, orchestrate, support-operate.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaNodes` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `d75f53f3a99a9cd3ee75b256eda277fab0bf082f98582defaa5b649d77aa9e64`
