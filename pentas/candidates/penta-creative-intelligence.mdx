---
title: "Penta Creative Intelligence"
sidebarTitle: "Penta Creative Intelligence"
description: "Penta namespace reference and canonicalization guide for Penta Creative Intelligence."
...
<Info>
  ...
  **This page:** Penta Creative Intelligence — Penta namespace reference and canonicalization guide for Penta Creative Intelligence.
...
Route work to Penta Creative Intelligence when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Creative Intelligence` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `d32e37be24a000187de7de7b6029c0f3c40f3efabbc50df44d2b6b489493e92e`
