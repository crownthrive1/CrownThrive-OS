---
title: "PentaFlags"
sidebarTitle: "PentaFlags"
description: "Penta namespace reference and canonicalization guide for PentaFlags."
...
<Info>
  ...
  **This page:** PentaFlags — Penta namespace reference and canonicalization guide for PentaFlags.
...
Route work to PentaFlags when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaFlags` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `87bb3b83f9ac56a7ae0fb794e014fa6e92356bd8bbe40c00b1dc877f9ca9b99c`
