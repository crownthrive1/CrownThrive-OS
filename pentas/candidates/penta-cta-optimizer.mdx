---
title: "Penta CTA Optimizer"
sidebarTitle: "Penta CTA Optimizer"
description: "Penta namespace reference and canonicalization guide for Penta CTA Optimizer."
...
<Info>
  ...
  **This page:** Penta CTA Optimizer — Penta namespace reference and canonicalization guide for Penta CTA Optimizer.
...
Route work to Penta CTA Optimizer when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: communicate-grow, support-operate, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta CTA Optimizer` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `458d01e63bdbb117d0a86b98c3713df91eaa7353250909242ce1be16f96e9425`
