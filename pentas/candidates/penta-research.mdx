...
Route work to PentaResearch when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: analyze-research, retrieve, observe, route, transform.
...
- This record hash: `403ff73cef6ab1c111f65b411b051be6512a095567719b31112dcbe25180966c`
