---
title: "PentaResearch"
sidebarTitle: "PentaResearch"
description: "Penta namespace reference and canonicalization guide for PentaResearch."
...
<Info>
  ...
  **This page:** PentaResearch — Penta namespace reference and canonicalization guide for PentaResearch.
...
Route work to PentaResearch when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, route, retrieve, transform, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaResearch` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `ecc533915cd5a31c06dbede069cb83b85ada6f65b3b32970a49169d68f6da4a0`
