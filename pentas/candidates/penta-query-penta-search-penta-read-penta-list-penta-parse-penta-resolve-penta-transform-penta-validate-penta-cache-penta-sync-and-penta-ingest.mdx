---
title: "PentaQuery, PentaSearch, PentaRead, PentaList, PentaParse, PentaResolve, PentaTransform, PentaValidate, PentaCache, PentaSync, and PentaIngest"
sidebarTitle: "PentaQuery, PentaSearch, PentaRead, PentaList, PentaParse, PentaResolve, PentaTransform, PentaValidate, PentaCache, PentaSync, and PentaIngest"
description: "Penta namespace reference and canonicalization guide for PentaQuery, PentaSearch, PentaRead, PentaList, PentaParse, PentaResolve, PentaTransform, PentaValidate, PentaCache, PentaSync, and PentaIngest."
---
...
| Source state | `governed_family_extension` |
| Canonical target | No canonical target is established. |
| Extension maturity | `not asserted` |
| Provisional family | [Penta Transport & Capability Primitives Family](/pentas/families/transport-primitives) |
