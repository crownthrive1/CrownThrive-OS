...
Route work to PentaPayroll when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: transact-economic, govern, observe.
...
- This record hash: `4ad19225e470cbfe4793de28d7d516431d99714302cbabde9e4f6b78e2f06693`
