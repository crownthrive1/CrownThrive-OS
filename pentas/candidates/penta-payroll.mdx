---
title: "PentaPayroll"
sidebarTitle: "PentaPayroll"
description: "Penta namespace reference and canonicalization guide for PentaPayroll."
...
<Info>
  ...
  **This page:** PentaPayroll — Penta namespace reference and canonicalization guide for PentaPayroll.
...
Route work to PentaPayroll when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, transact-economic.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaPayroll` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `0c20a2538f58908a7270fb7f4f8f53c4264e99fe4d366c6133ce69d4a7322985`
