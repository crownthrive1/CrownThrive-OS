---
title: "PentaCopy"
sidebarTitle: "PentaCopy"
description: "Penta namespace reference and canonicalization guide for PentaCopy."
...
<Info>
  ...
  **This page:** PentaCopy — Penta namespace reference and canonicalization guide for PentaCopy.
...
Route work to PentaCopy when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: communicate-grow, support-operate, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaCopy` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `7bf749902c99ea7f32b8ab4e02e8f32b8210bdbaafb0f91785d2e199aaa72d1f`
