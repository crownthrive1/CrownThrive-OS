---
title: "PentaHost"
sidebarTitle: "PentaHost"
description: "Penta namespace reference and canonicalization guide for PentaHost."
...
<Info>
  ...
  **This page:** PentaHost — Penta namespace reference and canonicalization guide for PentaHost.
...
Route work to PentaHost when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: route, orchestrate, support-operate.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaHost` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `eefc5fb8eff457ba1444c672594757f96605f31cef0edc80fbe46e273c11d382`
