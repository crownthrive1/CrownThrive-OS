---
title: "PentaFacilities"
sidebarTitle: "PentaFacilities"
description: "Penta namespace reference and canonicalization guide for PentaFacilities."
...
<Info>
  ...
  **This page:** PentaFacilities — Penta namespace reference and canonicalization guide for PentaFacilities.
...
Route work to PentaFacilities when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, build, test-certify, publish.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaFacilities` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `1a241c14ff568bb2ac40ede866e06c57927336c1106e09aefa9f7f85d348630f`
