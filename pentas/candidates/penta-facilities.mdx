...
Route work to PentaFacilities when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: build, test-certify, publish.
...
- This record hash: `182a16f6dac87d8e10e35d522cb789a285f17dab6cfd54b0e7160b1f4491fc97`
