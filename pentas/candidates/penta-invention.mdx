---
title: "PentaInvention"
sidebarTitle: "PentaInvention"
description: "Penta namespace reference and canonicalization guide for PentaInvention."
...
<Info>
  ...
  **This page:** PentaInvention — Penta namespace reference and canonicalization guide for PentaInvention.
...
Route work to PentaInvention when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaInvention` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `e645396d82c1d4667f794d50dbc24ac1a596e0b3b710bfafcc749a2f53176eea`
