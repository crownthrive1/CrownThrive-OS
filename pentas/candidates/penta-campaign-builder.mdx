...
Route work to Penta Campaign Builder when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: build, test-certify, publish, communicate-grow.
...
- This record hash: `df6215d9c824849d00c7716f63f2ce7abf104520606db3e4fe3d5a5af683901d`
