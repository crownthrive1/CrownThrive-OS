---
title: "Penta Campaign Builder"
sidebarTitle: "Penta Campaign Builder"
description: "Penta namespace reference and canonicalization guide for Penta Campaign Builder."
...
<Info>
  ...
  **This page:** Penta Campaign Builder — Penta namespace reference and canonicalization guide for Penta Campaign Builder.
...
Route work to Penta Campaign Builder when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, build, test-certify, publish, communicate-grow.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Campaign Builder` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `7ae602e2fc4a00db01ff76ccd9dc9193f3769d1308aee698a444b1f4697e380e`
