---
title: "PentaSound"
sidebarTitle: "PentaSound"
description: "Penta namespace reference and canonicalization guide for PentaSound."
...
<Info>
  ...
  **This page:** PentaSound — Penta namespace reference and canonicalization guide for PentaSound.
...
Route work to PentaSound when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, publish, build.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaSound` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `3d22f28d655c4337b42459d915aea73fbd6fafbd1ff911ca93dbbf2d93a1dde2`
