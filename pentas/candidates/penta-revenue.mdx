---
title: "PentaRevenue"
sidebarTitle: "PentaRevenue"
description: "Penta namespace reference and canonicalization guide for PentaRevenue."
...
<Info>
  ...
  **This page:** PentaRevenue — Penta namespace reference and canonicalization guide for PentaRevenue.
...
| --- | --- |
| Architectural layers | [Media, Creative & Publishing](/pentas/layers/media-creative), [Experience & Interface](/pentas/layers/experience-interface), [Commerce & Economic](/pentas/layers/commerce-economic) |
| Jobs / functions | [Publish](/pentas/jobs/publish), [Build](/pentas/jobs/build), [Communicate & Grow](/pentas/jobs/communicate-grow), [Transact & Economic](/pentas/jobs/transact-economic) |
...
Route work to PentaRevenue when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: publish, build, communicate-grow, transact-economic.
...
2. Match the request to the documented jobs: `publish`, `build`, `communicate-grow`, `transact-economic`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaRevenue` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `42b64b2ed3b094b994df63a3d17b7bcd02c49fa00493c72adcd90b4a28e0beb0`
