...
| --- | --- |
| Architectural layers | [Workforce, People & Community](/pentas/layers/workforce-community), [Experience & Interface](/pentas/layers/experience-interface), [Communications, Growth & Service](/pentas/layers/communications-growth), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge) |
| Jobs / functions | [Manage People & Community](/pentas/jobs/manage-people-community), [Support & Operate](/pentas/jobs/support-operate), [Communicate & Grow](/pentas/jobs/communicate-grow), [Analyze & Research](/pentas/jobs/analyze-research) |
...
Route work to Penta Marketing Cohort Analytics when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: manage-people-community, support-operate, communicate-grow, analyze-research.
...
2. Match the request to the documented jobs: `manage-people-community`, `support-operate`, `communicate-grow`, `analyze-research`.
...
- This record hash: `785da17e716560482f0ef637b6202083fd0b95e34047c8b077746694c7eef186`
