---
title: "Penta Marketing Cohort Analytics"
sidebarTitle: "Penta Marketing Cohort Analytics"
description: "Penta namespace reference and canonicalization guide for Penta Marketing Cohort Analytics."
...
<Info>
  ...
  **This page:** Penta Marketing Cohort Analytics — Penta namespace reference and canonicalization guide for Penta Marketing Cohort Analytics.
...
## Penta Marketing Cohort Analytics
...
| Provisional family | [Workforce People](/pentas/families/workforce-people) |
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Communications, Growth & Service](/pentas/layers/communications-growth), [Workforce, People & Community](/pentas/layers/workforce-community) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Communicate & Grow](/pentas/jobs/communicate-grow), [Analyze & Research](/pentas/jobs/analyze-research), [Manage People & Community](/pentas/jobs/manage-people-community) |
...
Route work to Penta Marketing Cohort Analytics when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, communicate-grow, analyze-research, manage-people-community.
...
2. Match the request to the documented jobs: `govern`, `document`, `communicate-grow`, `analyze-research`, `manage-people-community`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Marketing Cohort Analytics` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `fa6ecfabb4bd9e4033c5074495771be388c9b3cbf50f8d9f97f03ffb99eccefe`
