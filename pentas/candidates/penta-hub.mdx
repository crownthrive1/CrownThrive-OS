---
title: "PentaHub"
sidebarTitle: "PentaHub"
description: "Penta namespace reference and canonicalization guide for PentaHub."
...
<Info>
  ...
  **This page:** PentaHub — Penta namespace reference and canonicalization guide for PentaHub.
...
Route work to PentaHub when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: architect, govern, support-operate.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaHub` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `fdbb26edf531e735ec5b9f524f5043b63fd3b3f4476bcd0432cf20ee54d6146c`
