---
title: "PentaCXO"
sidebarTitle: "PentaCXO"
description: "Penta namespace reference and canonicalization guide for PentaCXO."
...
<Info>
  ...
  **This page:** PentaCXO — Penta namespace reference and canonicalization guide for PentaCXO.
...
Route work to PentaCXO when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaCXO` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `017e9c1430d786e70e3ed3074648cf1d92c7f62c86e6de60ab8187d33967c123`
