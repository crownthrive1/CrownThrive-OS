---
title: "PentaCollab"
sidebarTitle: "PentaCollab"
description: "Penta namespace reference and canonicalization guide for PentaCollab."
...
<Info>
  ...
  **This page:** PentaCollab — Penta namespace reference and canonicalization guide for PentaCollab.
...
Route work to PentaCollab when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaCollab` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `01169397379fa10289ba2f9edbd5f483ade63259bffd8e2afd0ff38a354b4713`
