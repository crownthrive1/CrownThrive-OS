---
title: "PentaVenture"
sidebarTitle: "PentaVenture"
description: "Penta namespace reference and canonicalization guide for PentaVenture."
...
<Info>
  ...
  **This page:** PentaVenture — Penta namespace reference and canonicalization guide for PentaVenture.
...
Route work to PentaVenture when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: transact-economic, govern, observe.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaVenture` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `bf4c9e3c6108ec72470a7a34c5b74a3a9ee3211c196fcb11d4ddbd6e4758c1f0`
