...
| --- | --- |
| Architectural layers | [Media, Creative & Publishing](/pentas/layers/media-creative), [Experience & Interface](/pentas/layers/experience-interface) |
| Jobs / functions | [Publish](/pentas/jobs/publish), [Build](/pentas/jobs/build), [Communicate & Grow](/pentas/jobs/communicate-grow) |
...
Route work to Penta Sales Enablement Studio when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: publish, build, communicate-grow.
...
2. Match the request to the documented jobs: `publish`, `build`, `communicate-grow`.
...
- This record hash: `5735519dc59b439710bca6cb935e2c144830cc8d20daab69114f9fa076aacc05`
