---
title: "Penta Sales Enablement Studio"
sidebarTitle: "Penta Sales Enablement Studio"
description: "Penta namespace reference and canonicalization guide for Penta Sales Enablement Studio."
...
<Info>
  ...
  **This page:** Penta Sales Enablement Studio — Penta namespace reference and canonicalization guide for Penta Sales Enablement Studio.
...
| Provisional family | [Media Creative](/pentas/families/media-creative) |
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Media, Creative & Publishing](/pentas/layers/media-creative) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Publish](/pentas/jobs/publish), [Build](/pentas/jobs/build) |
...
Route work to Penta Sales Enablement Studio when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, publish, build.
...
2. Match the request to the documented jobs: `govern`, `document`, `publish`, `build`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Sales Enablement Studio` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `05c9bdca6b66f0a8cc5f552ad73f979b02af702dd2b9e3da11a77766fe88c723`
