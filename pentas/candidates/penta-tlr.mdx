---
title: "PentaTLR"
sidebarTitle: "PentaTLR"
description: "Penta namespace reference and canonicalization guide for PentaTLR."
...
<Info>
  ...
  **This page:** PentaTLR — Penta namespace reference and canonicalization guide for PentaTLR.
...
Route work to PentaTLR when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaTLR` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `f8e4389a20b4d26026d0b56d03eab3b144ecc5210ed7246b74253be07efb735b`
