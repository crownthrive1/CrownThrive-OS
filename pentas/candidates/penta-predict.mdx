...
<Info>
  ...
  **This page:** PentaPredict — Penta namespace reference and canonicalization guide for PentaPredict.
...
Route work to PentaPredict when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: secure, govern, observe, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaPredict` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `753d049a27ee26de94d2aa05f978a5b06d5a400712df0f83a2b5a77df27c892a`
