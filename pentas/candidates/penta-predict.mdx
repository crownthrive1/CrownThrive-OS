...
Route work to PentaPredict when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, analyze-research.
...
- This record hash: `b6041bd0a4b71541455898754144f8ea074a5084577c8c4ab9b82e05d57967b2`
