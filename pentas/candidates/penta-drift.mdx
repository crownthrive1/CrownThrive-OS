---
title: "Penta-drift"
sidebarTitle: "Penta-drift"
description: "Penta namespace reference and canonicalization guide for Penta-drift."
...
<Info>
  ...
  **This page:** Penta-drift — Penta namespace reference and canonicalization guide for Penta-drift.
...
Route work to Penta-drift when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta-drift` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `0646263ce63fd64de832a583201260be12ac689070e8a7cc7b805d192d50f854`
