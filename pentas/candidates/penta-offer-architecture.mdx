---
title: "Penta Offer Architecture"
sidebarTitle: "Penta Offer Architecture"
description: "Penta namespace reference and canonicalization guide for Penta Offer Architecture."
...
<Info>
  ...
  **This page:** Penta Offer Architecture — Penta namespace reference and canonicalization guide for Penta Offer Architecture.
...
Route work to Penta Offer Architecture when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: communicate-grow, support-operate, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Offer Architecture` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `6f99e04755de31ad229a02598ce84ce969c04e9221e68d595e9c6a7ee51a1dff`
