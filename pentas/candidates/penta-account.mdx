---
title: "PentaAccount"
sidebarTitle: "PentaAccount"
description: "Penta namespace reference and canonicalization guide for PentaAccount."
...
<Info>
  ...
  **This page:** PentaAccount — Penta namespace reference and canonicalization guide for PentaAccount.
...
Route work to PentaAccount when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: transact-economic, govern, observe.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaAccount` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `a33d47016fb75b03a2f07da877354e6995ff644b02f3398ce0e06eab710d299a`
