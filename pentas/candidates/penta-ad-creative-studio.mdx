---
title: "Penta Ad Creative Studio"
sidebarTitle: "Penta Ad Creative Studio"
description: "Penta namespace reference and canonicalization guide for Penta Ad Creative Studio."
...
<Info>
  ...
  **This page:** Penta Ad Creative Studio — Penta namespace reference and canonicalization guide for Penta Ad Creative Studio.
...
Route work to Penta Ad Creative Studio when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, publish, build.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Ad Creative Studio` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `2e392d7a825f02bc26df997732c2af1af4bcdf467cebff441d3ea932d665343f`
