...
Route work to Penta Ad Creative Studio when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: publish, build, communicate-grow.
...
- This record hash: `2dd98a3b517c10a06feacd6f23b07f38be3d4e83d4771ac7875b3ba2efc2e3cc`
