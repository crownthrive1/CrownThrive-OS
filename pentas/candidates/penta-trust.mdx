---
title: "PentaTrust"
sidebarTitle: "PentaTrust"
description: "Penta namespace reference and canonicalization guide for PentaTrust."
...
<Info>
  ...
  **This page:** PentaTrust — Penta namespace reference and canonicalization guide for PentaTrust.
...
Route work to PentaTrust when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, secure.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaTrust` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `a7d516fd9317f33ed408dd8e2137c9464210da1128d3f0b715f6faebcf851b80`
