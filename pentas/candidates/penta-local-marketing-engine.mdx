---
title: "Penta Local Marketing Engine"
sidebarTitle: "Penta Local Marketing Engine"
description: "Penta namespace reference and canonicalization guide for Penta Local Marketing Engine."
...
<Info>
  ...
  **This page:** Penta Local Marketing Engine — Penta namespace reference and canonicalization guide for Penta Local Marketing Engine.
...
Route work to Penta Local Marketing Engine when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, communicate-grow.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Local Marketing Engine` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `5cbf996c0707c486f6144f79a19717dc59818b8479017b276d50afda092115c0`
