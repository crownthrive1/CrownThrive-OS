---
title: "PentaDonor"
sidebarTitle: "PentaDonor"
description: "Penta namespace reference and canonicalization guide for PentaDonor."
...
<Info>
  ...
  **This page:** PentaDonor — Penta namespace reference and canonicalization guide for PentaDonor.
...
Route work to PentaDonor when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaDonor` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `237eb6c0f79fbbc77e6fe84e03fba0537e77a5420fb4275b76d5f336381d98c0`
