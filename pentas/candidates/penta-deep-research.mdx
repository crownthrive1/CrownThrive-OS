---
title: "PentaDeepResearch"
sidebarTitle: "PentaDeepResearch"
description: "Penta namespace reference and canonicalization guide for PentaDeepResearch."
...
<Info>
  ...
  **This page:** PentaDeepResearch — Penta namespace reference and canonicalization guide for PentaDeepResearch.
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Routing, Interop & Transport](/pentas/layers/routing-transport) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Route](/pentas/jobs/route), [Retrieve](/pentas/jobs/retrieve), [Transform](/pentas/jobs/transform), [Analyze & Research](/pentas/jobs/analyze-research) |
...
Route work to PentaDeepResearch when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, route, retrieve, transform, analyze-research.
...
2. Match the request to the documented jobs: `govern`, `document`, `route`, `retrieve`, `transform`, `analyze-research`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaDeepResearch` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `c46104b705f0abafbd1973d4bd5e11aa9444753cd824624003ab96d4d83948e3`
