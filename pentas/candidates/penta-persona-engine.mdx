---
title: "Penta Persona Engine"
sidebarTitle: "Penta Persona Engine"
description: "Penta namespace reference and canonicalization guide for Penta Persona Engine."
...
<Info>
  ...
  **This page:** Penta Persona Engine — Penta namespace reference and canonicalization guide for Penta Persona Engine.
...
Route work to Penta Persona Engine when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: communicate-grow, support-operate, analyze-research.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `Penta Persona Engine` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `fe00b0762445acee599c471a17540ee53250f1aea0916293627f579ab510ba3b`
