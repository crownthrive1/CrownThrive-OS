---
title: "PentaProject"
sidebarTitle: "PentaProject"
description: "Penta namespace reference and canonicalization guide for PentaProject."
...
<Info>
  ...
  **This page:** PentaProject — Penta namespace reference and canonicalization guide for PentaProject.
...
Route work to PentaProject when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaProject` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `b9791c3813d3c0e3d3f0d2e4e4b7fcd1134a1ca78126d5d54b33f7a09f844644`
