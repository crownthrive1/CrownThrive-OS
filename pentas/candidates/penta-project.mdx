...
Route work to PentaProject when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: orchestrate, build, support-operate.
...
- This record hash: `d3d5c208678fa3a6f4de1c9f4705f426a4e3a8b52394cdbb9097ccae7aeaeccf`
