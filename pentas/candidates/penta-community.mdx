---
title: "PentaCommunity"
sidebarTitle: "PentaCommunity"
description: "Penta namespace reference and canonicalization guide for PentaCommunity."
...
<Info>
  ...
  **This page:** PentaCommunity — Penta namespace reference and canonicalization guide for PentaCommunity.
...
Route work to PentaCommunity when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, communicate-grow.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaCommunity` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `de5e6ec07bdc46773ebfee75a1cb444bbe6f44cb16fc9f54380cf6e0f29dbde6`
