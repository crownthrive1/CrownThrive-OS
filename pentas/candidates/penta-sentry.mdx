---
title: "PentaSentry"
sidebarTitle: "PentaSentry"
description: "Penta namespace reference and canonicalization guide for PentaSentry."
...
<Info>
  ...
  **This page:** PentaSentry — Penta namespace reference and canonicalization guide for PentaSentry.
...
Route work to PentaSentry when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaSentry` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `9f93f2a1d8df25926fe93c2404b69f64ea1b42bea7fefc4b1f8102e26177bc4d`
