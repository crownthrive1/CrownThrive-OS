---
title: "PentaGuardian — Legacy Candidate Record"
sidebarTitle: "PentaGuardian (Promoted)"
description: "Historical candidate record retained for PentaGuardian namespace continuity. PentaGuardian is now canonical and active; use the canonical page for current operating truth."
...
<Info>
  ...
  **This page:** PentaGuardian — Penta namespace reference and canonicalization guide for PentaGuardian.
...
> **PROMOTED / SUPERSEDED CANDIDATE RECORD.** PentaGuardian is now canonical and active. Use [PentaGuardian](/pentas/canonical/penta-guardian) for current operating truth and [PentaGuardian Family](/pentas/families/penta-guardian) for its certified technical family. This page remains only as append-only namespace lineage.

## Overview

This candidate record is preserved so CrownThrive retains the full canonicalization trail. Its former candidate-only assertions are historical and are superseded by the current runtime, DAIL, repository, and PentaDocs projections.
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Security & Trust](/pentas/layers/security-trust) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Document](/pentas/jobs/document), [Secure](/pentas/jobs/secure) |
...
Route work to PentaGuardian when the request matches its recorded role (Role unresolved; use canonicalization/governance evidence before operational use.) and one of its job classifications: govern, document, secure.
...
2. Match the request to the documented jobs: `govern`, `document`, `secure`.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `PentaGuardian` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `dbff87c7e4d9be71babaa50f87e93530d1c4de3e440f1c2ab36394775d4bc895`
