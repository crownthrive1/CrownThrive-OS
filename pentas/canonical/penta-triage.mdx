---
title: "PentaTriage"
sidebarTitle: "PentaTriage"
description: "Registry-driven PentaDocs portal guide for PentaTriage."
...
<Info>
  ...
  **This page:** PentaTriage — Registry-driven PentaDocs portal guide for PentaTriage.
...
## Overview
**Mission / role:** Triage incidents, requests, failures, alerts and worker/system needs by severity, ownership, urgency, route and required authority.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.triage` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D2` |
...
| Operator route | `/io/pentas/triage` |
| Public status route | `/penta/triage` |
...
## Dependencies
`penta.managers`, `penta.route`, `penta.signal`, `penta.status`
...
| --- | --- |
| Architectural layers | [Workforce, People & Community](/pentas/layers/workforce-community), [Experience & Interface](/pentas/layers/experience-interface), [Security & Trust](/pentas/layers/security-trust), [Routing, Interop & Transport](/pentas/layers/routing-transport), [Build, Test & Release](/pentas/layers/build-release) |
| Jobs / functions | [Manage People & Community](/pentas/jobs/manage-people-community), [Support & Operate](/pentas/jobs/support-operate), [Communicate & Grow](/pentas/jobs/communicate-grow), [Secure](/pentas/jobs/secure), [Govern](/pentas/jobs/govern), [Route](/pentas/jobs/route) |
...
Route work to PentaTriage when the request matches its recorded role (Triage incidents, requests, failures, alerts and worker/system needs by severity, ownership, urgency, route and required authority.) and one of its job classifications: manage-people-community, support-operate, communicate-grow, secure, govern, route.
...
5. Verify declared dependencies before execution: penta.managers, penta.route, penta.signal, penta.status.
...
1. Start from this exact identity and machine key: `penta.triage`.
2. Match the request to the documented jobs: `manage-people-community`, `support-operate`, `communicate-grow`, `secure`, `govern`, `route`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.triage` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.triage` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `8987921e9b44f9c8220c03bfe0f02e1559656ac0016956f8cd6325c65309e382`
