---
title: "PentaImmune"
sidebarTitle: "PentaImmune"
description: "Registry-driven PentaDocs portal guide for PentaImmune."
...
<Info>
  ...
  **This page:** PentaImmune — Registry-driven PentaDocs portal guide for PentaImmune.
...
## Overview
**Mission / role:** Continuously discover and rank authorized repository-local weaknesses, create bounded reversible repair work, verify exact-head outcomes and preserve reusable repair intelligence without crossing governance boundaries.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.immune` |
| Kind | `system` |
| Maturity | `production` |
| Risk ceiling | `D2` |
...
| Operator route | `/io/pentas/immune` |
| Public status route | `/penta/immune` |
...
## Dependencies
`penta.assure`, `penta.certify`, `penta.docs`, `penta.error`, `penta.evi-builder`, `penta.factory`, `penta.logger`, `penta.pr`, `penta.trace`
...
| --- | --- |
| Architectural layers | [Security & Trust](/pentas/layers/security-trust), [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge) |
| Jobs / functions | [Secure](/pentas/jobs/secure), [Govern](/pentas/jobs/govern), [Observe](/pentas/jobs/observe), [Analyze & Research](/pentas/jobs/analyze-research) |
| Lifecycle stages | [Discover](/pentas/lifecycle/discover), [Design](/pentas/lifecycle/design), [Build](/pentas/lifecycle/build), [Verify](/pentas/lifecycle/verify), [Release](/pentas/lifecycle/release), [Operate](/pentas/lifecycle/operate), [Observe](/pentas/lifecycle/observe), [Govern](/pentas/lifecycle/govern), [Evolve](/pentas/lifecycle/evolve) |
...
Route work to PentaImmune when the request matches its recorded role (Continuously discover and rank authorized repository-local weaknesses, create bounded reversible repair work, verify exact-head outcomes and preserve reusable repair intelligence without crossing governance boundaries.) and one of its job classifications: secure, govern, observe, analyze-research.
...
5. Verify declared dependencies before execution: penta.assure, penta.certify, penta.docs, penta.error, penta.evi-builder, penta.factory, penta.logger, penta.pr, penta.trace.
...
1. Start from this exact identity and machine key: `penta.immune`.
2. Match the request to the documented jobs: `secure`, `govern`, `observe`, `analyze-research`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.immune` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.immune` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `74e594f7acd8f5f81d106a4b08b344db0908e571e52f10443b9b9c8fe8cb1583`
