---
title: "PentaCensus"
sidebarTitle: "PentaCensus"
description: "Registry-driven PentaDocs portal guide for PentaCensus."
...
<Info>
  ...
  **This page:** PentaCensus — Registry-driven PentaDocs portal guide for PentaCensus.
...
## Overview
**Mission / role:** Continuously census the governed CrownThrive Penta namespace, detect previously unseen institutional Penta identity declarations, preserve advisory Penta-named references for semantic/topology review, and route unresolved discoveries into fail-closed canonicalization and documentation lanes.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.census` |
| Kind | `system` |
| Maturity | `implemented` |
| Risk ceiling | `D1` |
| Execution eligible by registry | `false` |
| Strict readiness | `HOLD_MEMBER_MATURITY` |
| Family | [Penta Intelligence, Research & Impact Family](/pentas/families/intelligence-research) |
| Family assignment | `registry_backed` |
| Operator route | `/io/pentas/census` |
| Public status route | `/penta/census` |
...
Primary family context: [Penta Intelligence, Research & Impact Family](/pentas/families/intelligence-research). Sibling, upstream, downstream, and cross-family relationships resolve through the family topology and dependency graph rather than prose inference.

## Dependencies
`penta.assure`, `penta.docs`, `penta.route`, `penta.scribe`, `penta.status`
...
| --- | --- |
| Architectural layers | [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Observability & Reliability](/pentas/layers/observability-reliability), [Routing, Interop & Transport](/pentas/layers/routing-transport) |
| Jobs / functions | [Analyze & Research](/pentas/jobs/analyze-research), [Retrieve](/pentas/jobs/retrieve), [Observe](/pentas/jobs/observe), [Route](/pentas/jobs/route), [Transform](/pentas/jobs/transform) |
| Lifecycle stages | [Discover](/pentas/lifecycle/discover), [Design](/pentas/lifecycle/design), [Build](/pentas/lifecycle/build), [Verify](/pentas/lifecycle/verify), [Operate](/pentas/lifecycle/operate), [Observe](/pentas/lifecycle/observe), [Govern](/pentas/lifecycle/govern), [Evolve](/pentas/lifecycle/evolve) |
...
Route work to PentaCensus when the request matches its recorded role (Continuously census the governed CrownThrive Penta namespace, detect previously unseen institutional Penta identity declarations, preserve advisory Penta-named references for semantic/topology review, and route unresolved discoveries into fail-closed canonicalization and documentation lanes.) and one of its job classifications: analyze-research, retrieve, observe, route, transform.
...
5. Verify declared dependencies before execution: penta.assure, penta.docs, penta.route, penta.scribe, penta.status.
...
1. Start from this exact identity and machine key: `penta.census`.
2. Match the request to the documented jobs: `analyze-research`, `retrieve`, `observe`, `route`, `transform`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.census` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.census` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `da95658bb020d90c862b6c0c263b5f196c4bd09fc2308d85dcbff7e8760c7088`
