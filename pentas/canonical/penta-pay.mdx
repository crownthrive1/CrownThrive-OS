---
title: "PentaPay"
sidebarTitle: "PentaPay"
description: "Registry-driven PentaDocs portal guide for PentaPay."
...
<Info>
  ...
  **This page:** PentaPay — Registry-driven PentaDocs portal guide for PentaPay.
...
## Overview
**Mission / role:** Govern compensation calculations, approved pay obligations, payout preparation and payment-provider reconciliation for authorized workers/agents.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.pay` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
| Execution eligible by registry | `false` |
| Strict readiness | `HOLD_UNCLASSIFIED_DEPENDENCY_CYCLE` |
| Family | [Penta Commerce & Economy Family](/pentas/families/commerce-economy) |
| Family assignment | `registry_backed` |
| Operator route | `/io/pentas/pay` |
| Public status route | `/penta/pay` |
...
Primary family context: [Penta Commerce & Economy Family](/pentas/families/commerce-economy). Sibling, upstream, downstream, and cross-family relationships resolve through the family topology and dependency graph rather than prose inference.

## Dependencies
`penta.audit`, `penta.cost`, `penta.credentials`, `penta.hr`
...
| --- | --- |
| Architectural layers | [Commerce & Economic](/pentas/layers/commerce-economic), [Control & Governance](/pentas/layers/control-governance), [Security & Trust](/pentas/layers/security-trust), [Build, Test & Release](/pentas/layers/build-release), [Automation & Agentic](/pentas/layers/automation-agentic) |
| Jobs / functions | [Transact & Economic](/pentas/jobs/transact-economic), [Govern](/pentas/jobs/govern), [Observe](/pentas/jobs/observe), [Secure](/pentas/jobs/secure), [Build](/pentas/jobs/build), [Test & Certify](/pentas/jobs/test-certify) |
...
Route work to PentaPay when the request matches its recorded role (Govern compensation calculations, approved pay obligations, payout preparation and payment-provider reconciliation for authorized workers/agents.) and one of its job classifications: transact-economic, govern, observe, secure, build, test-certify.
...
5. Verify declared dependencies before execution: penta.audit, penta.cost, penta.credentials, penta.hr.
...
1. Start from this exact identity and machine key: `penta.pay`.
2. Match the request to the documented jobs: `transact-economic`, `govern`, `observe`, `secure`, `build`, `test-certify`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.pay` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.pay` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `1f49943f3e2d6e64777d62bfdcf23136329efb4337ee999b52600bf3b16610b7`
