---
title: "PentaPology"
sidebarTitle: "PentaPology"
description: "Registry-driven PentaDocs portal guide for PentaPology."
...
<Info>
  ...
  **This page:** PentaPology — Registry-driven PentaDocs portal guide for PentaPology.
...
## Overview
**Mission / role:** topology, relationship, dependency, and system-graph authority

| Field | Registry value |
| --- | --- |
| Machine key | `penta.pology` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/pology` |
| Public status route | `/penta/pology` |
...
Route work to PentaPology when the request matches its recorded role (topology, relationship, dependency, and system-graph authority) and one of its job classifications: architect, govern, support-operate, secure.
...
1. Start from this exact identity and machine key: `penta.pology`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.pology` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.pology` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `22ddd8f0f9a04b88f1e7a563b0c3d04b0d3ccf81ff938b0992bf5790ad480428`
