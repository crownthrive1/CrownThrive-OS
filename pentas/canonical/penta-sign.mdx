---
title: "PentaSign"
sidebarTitle: "PentaSign"
description: "Registry-driven PentaDocs portal guide for PentaSign."
...
<Info>
  ...
  **This page:** PentaSign — Registry-driven PentaDocs portal guide for PentaSign.
...
| Operator route | `/io/pentas/primitives#sign` |
| Public status route | `/penta/sign` |
...
Route work to PentaSign when the request matches its recorded role (Governed PentaRoute capability primitive.) and one of its job classifications: secure, govern, observe, route, retrieve, transform.
...
1. Start from this exact identity and machine key: `penta.sign`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.sign` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.sign` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `0082ca57159cc1ead8c547848cdea5044899d6b30e5589649a7cc2e776565fff`
