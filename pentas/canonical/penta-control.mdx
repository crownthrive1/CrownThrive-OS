---
title: "PentaControl"
sidebarTitle: "PentaControl"
description: "Registry-driven PentaDocs portal guide for PentaControl."
...
<Info>
  ...
  **This page:** PentaControl — Registry-driven PentaDocs portal guide for PentaControl.
...
## Overview
**Mission / role:** Portfolio-level coordination, intent decomposition, governed dispatch, state convergence, and operator control.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.control` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/control` |
| Public status route | `/penta/control` |
...
## Dependencies
`penta.docs`, `penta.mcp`, `penta.route`
...
Route work to PentaControl when the request matches its recorded role (Portfolio-level coordination, intent decomposition, governed dispatch, state convergence, and operator control.) and one of its job classifications: architect, govern, support-operate.
...
5. Verify declared dependencies before execution: penta.docs, penta.mcp, penta.route.
...
1. Start from this exact identity and machine key: `penta.control`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.control` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.control` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `c403cec096d20647f9026bac84792a24237cbb6016e5e809454a201efc1c6c67`
