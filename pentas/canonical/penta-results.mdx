---
title: "PentaResults"
sidebarTitle: "PentaResults"
description: "Registry-driven PentaDocs portal guide for PentaResults."
...
<Info>
  ...
  **This page:** PentaResults — Registry-driven PentaDocs portal guide for PentaResults.
...
## Overview
**Mission / role:** hash-sealed execution receipts and result evidence

| Field | Registry value |
| --- | --- |
| Machine key | `penta.results` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D2` |
...
| Operator route | `/io/pentas/results` |
| Public status route | `/penta/results` |
...
Route work to PentaResults when the request matches its recorded role (hash-sealed execution receipts and result evidence) and one of its job classifications: build, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.results`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.results` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.results` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `1d081e2ebd714d59749b0c3383c022414f0d9c271ea6c93ea4fc8241b626d5e0`
