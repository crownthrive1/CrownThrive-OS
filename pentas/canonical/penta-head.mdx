---
title: "PentaHead"
sidebarTitle: "PentaHead"
description: "Registry-driven PentaDocs portal guide for PentaHead."
...
<Info>
  ...
  **This page:** PentaHead — Registry-driven PentaDocs portal guide for PentaHead.
...
## Overview
**Mission / role:** certified HEAD/request primitive

| Field | Registry value |
| --- | --- |
| Machine key | `penta.head` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/head` |
| Public status route | `/penta/head` |
...
Route work to PentaHead when the request matches its recorded role (certified HEAD/request primitive) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.head`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.head` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.head` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `161034dfd935c058783bd2fd47125d1e06873a5d860e3ad93855d89c2b2553fa`
