---
title: "PentaBound"
sidebarTitle: "PentaBound"
description: "Registry-driven PentaDocs portal guide for PentaBound."
...
<Info>
  ...
  **This page:** PentaBound — Registry-driven PentaDocs portal guide for PentaBound.
...
## Overview
**Mission / role:** authority/resource boundary definitions

| Field | Registry value |
| --- | --- |
| Machine key | `penta.bound` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/bound` |
| Public status route | `/penta/bound` |
...
Route work to PentaBound when the request matches its recorded role (authority/resource boundary definitions) and one of its job classifications: secure, govern, observe.
...
1. Start from this exact identity and machine key: `penta.bound`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.bound` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.bound` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `a98d328c0b0e8f5bb6f927768879bbfdfdbdf3dc187d5865a89c523c2484a6c2`
