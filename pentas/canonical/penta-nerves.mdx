---
title: "PentaNerves"
sidebarTitle: "PentaNerves"
description: "Registry-driven PentaDocs portal guide for PentaNerves."
...
<Info>
  ...
  **This page:** PentaNerves — Registry-driven PentaDocs portal guide for PentaNerves.
...
## Overview
**Mission / role:** Internal and external signal ingestion and organ/governance routing.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.nerves` |
| Kind | `system` |
...
| Operator route | `/io/pentas/nerves` |
| Public status route | `/penta/nerves` |
...
| Jobs / functions | [Observe](/pentas/jobs/observe), [Recover](/pentas/jobs/recover), [Support & Operate](/pentas/jobs/support-operate), [Analyze & Research](/pentas/jobs/analyze-research) |
| Lifecycle stages | [Discover](/pentas/lifecycle/discover), [Design](/pentas/lifecycle/design), [Build](/pentas/lifecycle/build), [Verify](/pentas/lifecycle/verify), [Operate](/pentas/lifecycle/operate), [Observe](/pentas/lifecycle/observe), [Recover](/pentas/lifecycle/recover), [Govern](/pentas/lifecycle/govern), [Evolve](/pentas/lifecycle/evolve) |
...
Route work to PentaNerves when the request matches its recorded role (Internal and external signal ingestion and organ/governance routing.) and one of its job classifications: observe, recover, support-operate, analyze-research.
...
1. Start from this exact identity and machine key: `penta.nerves`.
2. Match the request to the documented jobs: `observe`, `recover`, `support-operate`, `analyze-research`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.nerves` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.nerves` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `89d2c45bc0b706fdb809e446b61ff5b2d7bc3a1e6022ca463d8d85f200ba9424`
