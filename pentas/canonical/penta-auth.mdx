---
title: "PentaAuth"
sidebarTitle: "PentaAuth"
description: "Registry-driven PentaDocs portal guide for PentaAuth."
...
<Info>
  ...
  **This page:** PentaAuth — Registry-driven PentaDocs portal guide for PentaAuth.
...
| Operator route | `/io/pentas/primitives#auth` |
| Public status route | `/penta/auth` |
...
Route work to PentaAuth when the request matches its recorded role (Governed PentaRoute capability primitive.) and one of its job classifications: secure, govern, observe, route, retrieve, transform.
...
1. Start from this exact identity and machine key: `penta.auth`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.auth` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.auth` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `a61e3a6168ee4a78caf62207a2c99c8998c95cbd44800210d8be400ef475dd43`
