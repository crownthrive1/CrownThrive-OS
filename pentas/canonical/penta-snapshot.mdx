---
title: "PentaSnapshot"
sidebarTitle: "PentaSnapshot"
description: "Registry-driven PentaDocs portal guide for PentaSnapshot."
...
<Info>
  ...
  **This page:** PentaSnapshot — Registry-driven PentaDocs portal guide for PentaSnapshot.
...
## Overview
**Mission / role:** SHA-256 evidence-backed snapshot, manifest, and restore-baseline authority

| Field | Registry value |
| --- | --- |
| Machine key | `penta.snapshot` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/snapshot` |
| Public status route | `/penta/snapshot` |
...
| Jobs / functions | [Recover](/pentas/jobs/recover), [Observe](/pentas/jobs/observe), [Support & Operate](/pentas/jobs/support-operate), [Secure](/pentas/jobs/secure), [Govern](/pentas/jobs/govern) |
...
Route work to PentaSnapshot when the request matches its recorded role (SHA-256 evidence-backed snapshot, manifest, and restore-baseline authority) and one of its job classifications: recover, observe, support-operate, secure, govern.
...
1. Start from this exact identity and machine key: `penta.snapshot`.
2. Match the request to the documented jobs: `recover`, `observe`, `support-operate`, `secure`, `govern`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.snapshot` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.snapshot` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `5038dc9afbb9c186b8159fbc0e4dd82c351f0dc02954caff86088c8103e8e110`
