---
title: "PentaFlex"
sidebarTitle: "PentaFlex"
description: "Registry-driven PentaDocs portal guide for PentaFlex."
...
<Info>
  ...
  **This page:** PentaFlex — Registry-driven PentaDocs portal guide for PentaFlex.
...
## Overview
**Mission / role:** MCP/API framework and adaptable interface layer

| Field | Registry value |
| --- | --- |
| Machine key | `penta.flex` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/flex` |
| Public status route | `/penta/flex` |
...
| --- | --- |
| Architectural layers | [Routing, Interop & Transport](/pentas/layers/routing-transport), [Foundation & Kernel](/pentas/layers/foundation-kernel), [Experience & Interface](/pentas/layers/experience-interface) |
| Jobs / functions | [Route](/pentas/jobs/route), [Orchestrate](/pentas/jobs/orchestrate), [Support & Operate](/pentas/jobs/support-operate) |
...
Route work to PentaFlex when the request matches its recorded role (MCP/API framework and adaptable interface layer) and one of its job classifications: route, orchestrate, support-operate.
...
1. Start from this exact identity and machine key: `penta.flex`.
2. Match the request to the documented jobs: `route`, `orchestrate`, `support-operate`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.flex` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.flex` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `27ee33f1b0254fc929eba61cdaeab1c545cea779d87ff5db4be82b178b1878a8`
