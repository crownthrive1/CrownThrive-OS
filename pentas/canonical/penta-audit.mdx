---
title: "PentaAudit"
sidebarTitle: "PentaAudit"
description: "Registry-driven PentaDocs portal guide for PentaAudit."
...
<Info>
  ...
  **This page:** PentaAudit — Registry-driven PentaDocs portal guide for PentaAudit.
...
## Overview
**Mission / role:** Independent evidence-led control testing, execution audit trails, findings, remediation tracking and re-test verification.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.audit` |
| Kind | `system` |
...
| Operator route | `/io/pentas/audit` |
| Public status route | `/penta/audit` |
...
| --- | --- |
| Architectural layers | [Security & Trust](/pentas/layers/security-trust), [Control & Governance](/pentas/layers/control-governance), [Build, Test & Release](/pentas/layers/build-release), [Observability & Reliability](/pentas/layers/observability-reliability), [Media, Creative & Publishing](/pentas/layers/media-creative) |
...
Route work to PentaAudit when the request matches its recorded role (Independent evidence-led control testing, execution audit trails, findings, remediation tracking and re-test verification.) and one of its job classifications: secure, govern, observe, build, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.audit`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.audit` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.audit` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `6a41231f5fab24326397f158f3d1741f8f5de924bcc1aa49507331e03905922f`
