---
title: "PentaReports"
sidebarTitle: "PentaReports"
description: "Registry-driven PentaDocs portal guide for PentaReports."
...
<Info>
  ...
  **This page:** PentaReports — Registry-driven PentaDocs portal guide for PentaReports.
...
## Overview
**Mission / role:** Evidence-backed operational, incident, verification, and after-action reporting.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.reports` |
| Kind | `system` |
| Maturity | `implemented` |
| Risk ceiling | `D2` |
| Execution eligible by registry | `false` |
| Strict readiness | `HOLD_DEPENDENCY_INVENTORY_UNASSESSED` |
| Family | [Observability Organic](/pentas/families/observability-organic) |
| Family assignment | `docs_inferred` |
| Operator route | `/io/pentas/reports` |
| Public status route | `/penta/reports` |
...
Primary family context: [Observability Organic](/pentas/families/observability-organic). Sibling, upstream, downstream, and cross-family relationships resolve through the family topology and dependency graph rather than prose inference.
...
Route work to PentaReports when the request matches its recorded role (Evidence-backed operational, incident, verification, and after-action reporting.) and one of its job classifications: observe, recover, support-operate, build, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.reports`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.reports` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.reports` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `bfebccaba58d55fdb0cc2631f0849fbfe771b2e9d4e0e07731042aef2a9d54ed`
