---
title: "PentaInstitute"
sidebarTitle: "PentaInstitute"
description: "Registry-driven PentaDocs portal guide for PentaInstitute."
...
<Info>
  ...
  **This page:** PentaInstitute — Registry-driven PentaDocs portal guide for PentaInstitute.
...
## Overview
**Mission / role:** Institutional research, strategic studies, decision science, scenario planning, foresight, policy analysis, red teaming and evidence synthesis.
...
| Operator route | `/io/pentas/institute` |
| Public status route | `/penta/institute` |
...
## Dependencies
`penta.docs`, `penta.hybrid`, `penta.signal`
...
| --- | --- |
| Architectural layers | [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Observability & Reliability](/pentas/layers/observability-reliability), [Routing, Interop & Transport](/pentas/layers/routing-transport), [Build, Test & Release](/pentas/layers/build-release) |
| Jobs / functions | [Analyze & Research](/pentas/jobs/analyze-research), [Retrieve](/pentas/jobs/retrieve), [Observe](/pentas/jobs/observe), [Route](/pentas/jobs/route), [Transform](/pentas/jobs/transform), [Build](/pentas/jobs/build) |
...
Route work to PentaInstitute when the request matches its recorded role (Institutional research, strategic studies, decision science, scenario planning, foresight, policy analysis, red teaming and evidence synthesis.) and one of its job classifications: analyze-research, retrieve, observe, route, transform, build.
...
5. Verify declared dependencies before execution: penta.docs, penta.hybrid, penta.signal.
...
1. Start from this exact identity and machine key: `penta.institute`.
2. Match the request to the documented jobs: `analyze-research`, `retrieve`, `observe`, `route`, `transform`, `build`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.institute` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.institute` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `b221baabb792652cb2244bc6b740abe64a23e0b83679404ad19541d5e2b6662c`
