---
title: "PentaLoad"
sidebarTitle: "PentaLoad"
description: "Registry-driven PentaDocs portal guide for PentaLoad."
...
<Info>
  ...
  **This page:** PentaLoad — Registry-driven PentaDocs portal guide for PentaLoad.
...
## Overview
**Mission / role:** Demand, capacity, and utilization measurement.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.load` |
| Kind | `system` |
...
| Operator route | `/io/pentas/load` |
| Public status route | `/penta/load` |
...
Route work to PentaLoad when the request matches its recorded role (Demand, capacity, and utilization measurement.) and one of its job classifications: observe, recover, support-operate, build, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.load`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.load` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.load` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `fec3ee37805cea6164eff637ab19b32748c36178163c44fc5ac1b763edda0c69`
