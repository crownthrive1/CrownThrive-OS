---
title: "PentaLLM"
sidebarTitle: "PentaLLM"
description: "Registry-driven PentaDocs portal guide for PentaLLM."
...
<Info>
  ...
  **This page:** PentaLLM — Registry-driven PentaDocs portal guide for PentaLLM.
...
## Overview
**Mission / role:** LLM provider/model governance and runtime bindings

| Field | Registry value |
| --- | --- |
| Machine key | `penta.llm` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/llm` |
| Public status route | `/penta/llm` |
...
Route work to PentaLLM when the request matches its recorded role (LLM provider/model governance and runtime bindings) and one of its job classifications: orchestrate, build, support-operate, route, retrieve, transform.
...
1. Start from this exact identity and machine key: `penta.llm`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.llm` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.llm` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `2bbe4a5ebf81780afcea03fbbd966766201f157bdd1d0960dc7881ae1289b5fc`
