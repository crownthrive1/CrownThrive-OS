---
title: "PentaVault"
sidebarTitle: "PentaVault"
description: "Registry-driven PentaDocs portal guide for PentaVault."
...
<Info>
  ...
  **This page:** PentaVault — Registry-driven PentaDocs portal guide for PentaVault.
...
## Overview
**Mission / role:** governed secret/reference/valuable-asset custody and vault binding layer

| Field | Registry value |
| --- | --- |
| Machine key | `penta.vault` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/vault` |
| Public status route | `/penta/vault` |
...
Route work to PentaVault when the request matches its recorded role (governed secret/reference/valuable-asset custody and vault binding layer) and one of its job classifications: secure, govern, observe, route, retrieve, transform.
...
1. Start from this exact identity and machine key: `penta.vault`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.vault` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.vault` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `e84ca7e938a7b9844a88a06a517d47d099a4246694bf9629a40d7b7fd9a12f5b`
