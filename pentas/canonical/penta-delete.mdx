---
title: "PentaDelete"
sidebarTitle: "PentaDelete"
description: "Registry-driven PentaDocs portal guide for PentaDelete."
...
<Info>
  ...
  **This page:** PentaDelete — Registry-driven PentaDocs portal guide for PentaDelete.
...
## Overview
**Mission / role:** certified deletion primitive

| Field | Registry value |
| --- | --- |
| Machine key | `penta.delete` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/delete` |
| Public status route | `/penta/delete` |
...
Route work to PentaDelete when the request matches its recorded role (certified deletion primitive) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.delete`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.delete` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.delete` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `4aec7cdefe063b820e99fcb54eec0ced2857d221b0295a783df351b0090c19d7`
