---
title: "PentaWave"
sidebarTitle: "PentaWave"
description: "Registry-driven PentaDocs portal guide for PentaWave."
...
<Info>
  ...
  **This page:** PentaWave — Registry-driven PentaDocs portal guide for PentaWave.
...
## Overview
**Mission / role:** Generation-61 PentaFabric release-wave subcomponent.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.wave` |
| Kind | `subcomponent` |
| Maturity | `specified` |
| Risk ceiling | `D2` |
...
| Operator route | `/io/pentas/wave` |
| Public status route | `/penta/wave` |
...
Route work to PentaWave when the request matches its recorded role (Generation-61 PentaFabric release-wave subcomponent.) and one of its job classifications: architect, govern, support-operate, build, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.wave`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.wave` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.wave` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `503be0a8a369adf0a7e780eb5930a5c0abfaf0f32c747cec9c632e681e57bb8e`
