---
title: "PentaSearch"
sidebarTitle: "PentaSearch"
description: "Registry-driven PentaDocs portal guide for PentaSearch."
...
<Info>
  ...
  **This page:** PentaSearch — Registry-driven PentaDocs portal guide for PentaSearch.
...
| Operator route | `/io/pentas/primitives#search` |
| Public status route | `/penta/search` |
...
Route work to PentaSearch when the request matches its recorded role (Governed capability primitive under PentaRoute and the universal Penta OS contract.) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.search`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.search` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.search` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `0c646da460c155a8bb15e53da5733cff64259be4c2f13eeb798fad0664575e2c`
