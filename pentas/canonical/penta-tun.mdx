---
title: "PentaTun"
sidebarTitle: "PentaTun"
description: "Registry-driven PentaDocs portal guide for PentaTun."
...
<Info>
  ...
  **This page:** PentaTun — Registry-driven PentaDocs portal guide for PentaTun.
...
## Overview
**Mission / role:** bounded runtime execution primitive

| Field | Registry value |
| --- | --- |
| Machine key | `penta.tun` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/tun` |
| Public status route | `/penta/tun` |
...
Route work to PentaTun when the request matches its recorded role (bounded runtime execution primitive) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.tun`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.tun` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.tun` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `bc9f7f1c19ca5f497757ee71135aa1cf3684840d666570013e423f73902bc022`
