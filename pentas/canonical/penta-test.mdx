---
title: "PentaTest"
sidebarTitle: "PentaTest"
description: "Registry-driven PentaDocs portal guide for PentaTest."
...
<Info>
  ...
  **This page:** PentaTest — Registry-driven PentaDocs portal guide for PentaTest.
...
| Operator route | `/io/pentas/primitives#test` |
| Public status route | `/penta/test` |
...
Route work to PentaTest when the request matches its recorded role (Governed PentaRoute capability primitive.) and one of its job classifications: retrieve, transform, route, build, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.test`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.test` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.test` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `1564ce02a67b63534e705c43a4f6f6c439045bf2afcb51410198c2dc0dbe5aef`
