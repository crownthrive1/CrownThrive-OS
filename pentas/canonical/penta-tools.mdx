---
title: "PentaTools"
sidebarTitle: "PentaTools"
description: "Registry-driven PentaDocs portal guide for PentaTools."
...
<Info>
  ...
  **This page:** PentaTools — Registry-driven PentaDocs portal guide for PentaTools.
...
## Overview
**Mission / role:** governed tool registry and execution bindings

| Field | Registry value |
| --- | --- |
| Machine key | `penta.tools` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/tools` |
| Public status route | `/penta/tools` |
...
| --- | --- |
| Architectural layers | [Automation & Agentic](/pentas/layers/automation-agentic), [Routing, Interop & Transport](/pentas/layers/routing-transport) |
...
Route work to PentaTools when the request matches its recorded role (governed tool registry and execution bindings) and one of its job classifications: orchestrate, build, support-operate, route, retrieve, transform.
...
1. Start from this exact identity and machine key: `penta.tools`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.tools` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.tools` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `5e0ec30fa63eebd324dec4b6efc394ede042c4462e5f4fc21f28120f88388894`
