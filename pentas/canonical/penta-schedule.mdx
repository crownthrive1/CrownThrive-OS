---
title: "PentaSchedule"
sidebarTitle: "PentaSchedule"
description: "Registry-driven PentaDocs portal guide for PentaSchedule."
...
<Info>
  ...
  **This page:** PentaSchedule — Registry-driven PentaDocs portal guide for PentaSchedule.
...
| Operator route | `/io/pentas/primitives#schedule` |
| Public status route | `/penta/schedule` |
...
Route work to PentaSchedule when the request matches its recorded role (Governed PentaRoute capability primitive.) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.schedule`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.schedule` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.schedule` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `35715e2d093fd50afab216a57cc1ad45b13579fbd86992e85a24be9b6c3a6adb`
