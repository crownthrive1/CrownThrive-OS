---
title: "PentaInterOps"
sidebarTitle: "PentaInterOps"
description: "Registry-driven PentaDocs portal guide for PentaInterOps."
...
<Info>
  ...
  **This page:** PentaInterOps — Registry-driven PentaDocs portal guide for PentaInterOps.
...
## Overview
**Mission / role:** interoperability contracts across Penta and CrownThrive systems

| Field | Registry value |
| --- | --- |
| Machine key | `penta.interops` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/interops` |
| Public status route | `/penta/interops` |
...
Route work to PentaInterOps when the request matches its recorded role (interoperability contracts across Penta and CrownThrive systems) and one of its job classifications: route, orchestrate, support-operate.
...
1. Start from this exact identity and machine key: `penta.interops`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.interops` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.interops` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `466471c479b754cd5681ad30d9d1fff30d33b71aa9b62b7275e3479419bfb91d`
