---
title: "PentaSets"
sidebarTitle: "PentaSets"
description: "Registry-driven PentaDocs portal guide for PentaSets."
...
<Info>
  ...
  **This page:** PentaSets — Registry-driven PentaDocs portal guide for PentaSets.
...
## Overview
**Mission / role:** asset-set registry, packaging, ownership, and lifecycle

| Field | Registry value |
| --- | --- |
| Machine key | `penta.sets` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/sets` |
| Public status route | `/penta/sets` |
...
Route work to PentaSets when the request matches its recorded role (asset-set registry, packaging, ownership, and lifecycle) and one of its job classifications: document, retrieve, transform.
...
1. Start from this exact identity and machine key: `penta.sets`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.sets` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.sets` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `32c5754c5a7b8e104d818b610224d4e9f967e483ee718e6251802494aac0264b`
