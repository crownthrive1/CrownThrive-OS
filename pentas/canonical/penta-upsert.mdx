---
title: "PentaUpsert"
sidebarTitle: "PentaUpsert"
description: "Registry-driven PentaDocs portal guide for PentaUpsert."
...
<Info>
  ...
  **This page:** PentaUpsert — Registry-driven PentaDocs portal guide for PentaUpsert.
...
| Operator route | `/io/pentas/primitives#upsert` |
| Public status route | `/penta/upsert` |
...
Route work to PentaUpsert when the request matches its recorded role (Governed PentaRoute capability primitive.) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.upsert`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.upsert` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.upsert` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `fb7d0bcd7138bef7f73613618e35e86c52b49848ca4647f4d2f2092921baea56`
