---
title: "PentaVergence"
sidebarTitle: "PentaVergence"
description: "Registry-driven PentaDocs portal guide for PentaVergence."
...
<Info>
  ...
  **This page:** PentaVergence — Registry-driven PentaDocs portal guide for PentaVergence.
...
## Overview
**Mission / role:** convergence of CrownThrive systems, lanes, and execution surfaces

| Field | Registry value |
| --- | --- |
| Machine key | `penta.vergence` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/vergence` |
| Public status route | `/penta/vergence` |
...
Route work to PentaVergence when the request matches its recorded role (convergence of CrownThrive systems, lanes, and execution surfaces) and one of its job classifications: architect, govern, support-operate.
...
1. Start from this exact identity and machine key: `penta.vergence`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.vergence` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.vergence` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `ee3667e6ed752573b56e75b4ff9c2cf6b0017710d2bef3d42959c9f47bf7455a`
