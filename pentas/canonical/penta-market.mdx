---
title: "PentaMarket"
sidebarTitle: "PentaMarket"
description: "Registry-driven PentaDocs portal guide for PentaMarket."
...
<Info>
  ...
  **This page:** PentaMarket — Registry-driven PentaDocs portal guide for PentaMarket.
...
## Overview
**Mission / role:** PentaGreen governed market projection subcomponent.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.market` |
| Kind | `subcomponent` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/market` |
| Public status route | `/penta/market` |
...
| --- | --- |
| Architectural layers | [Commerce & Economic](/pentas/layers/commerce-economic), [Control & Governance](/pentas/layers/control-governance), [Communications, Growth & Service](/pentas/layers/communications-growth) |
| Jobs / functions | [Transact & Economic](/pentas/jobs/transact-economic), [Govern](/pentas/jobs/govern), [Observe](/pentas/jobs/observe), [Communicate & Grow](/pentas/jobs/communicate-grow) |
...
Route work to PentaMarket when the request matches its recorded role (PentaGreen governed market projection subcomponent.) and one of its job classifications: transact-economic, govern, observe, communicate-grow.
...
1. Start from this exact identity and machine key: `penta.market`.
2. Match the request to the documented jobs: `transact-economic`, `govern`, `observe`, `communicate-grow`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.market` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.market` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `007e474eba0b2043bb040f2ea892bcdc3f012e341e338abdc8029410ece8bdc8`
