---
title: "PentaSKU"
sidebarTitle: "PentaSKU"
description: "Registry-driven PentaDocs portal guide for PentaSKU."
...
<Info>
  ...
  **This page:** PentaSKU — Registry-driven PentaDocs portal guide for PentaSKU.
...
## Overview
**Mission / role:** PentaGreen governed commercial SKU identity subcomponent.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.sku` |
| Kind | `subcomponent` |
| Maturity | `specified` |
| Risk ceiling | `D2` |
...
| Operator route | `/io/pentas/sku` |
| Public status route | `/penta/sku` |
...
Route work to PentaSKU when the request matches its recorded role (PentaGreen governed commercial SKU identity subcomponent.) and one of its job classifications: transact-economic, govern, observe, build, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.sku`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.sku` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.sku` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `7ea36389dea1336b5acde6a36a6e863a99bf8994f914ab88994fdb36ddfe67d7`
