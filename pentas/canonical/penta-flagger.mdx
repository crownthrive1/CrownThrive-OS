---
title: "PentaFlagger"
sidebarTitle: "PentaFlagger"
description: "Registry-driven PentaDocs portal guide for PentaFlagger."
...
<Info>
  ...
  **This page:** PentaFlagger — Registry-driven PentaDocs portal guide for PentaFlagger.
...
## Overview
**Mission / role:** Durable fault and policy-condition flagging without final disposition authority.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.flagger` |
| Kind | `system` |
...
| Operator route | `/io/pentas/flagger` |
| Public status route | `/penta/flagger` |
...
| --- | --- |
| Architectural layers | [Observability & Reliability](/pentas/layers/observability-reliability), [Security & Trust](/pentas/layers/security-trust) |
| Jobs / functions | [Observe](/pentas/jobs/observe), [Recover](/pentas/jobs/recover), [Support & Operate](/pentas/jobs/support-operate), [Secure](/pentas/jobs/secure), [Govern](/pentas/jobs/govern) |
...
Route work to PentaFlagger when the request matches its recorded role (Durable fault and policy-condition flagging without final disposition authority.) and one of its job classifications: observe, recover, support-operate, secure, govern.
...
1. Start from this exact identity and machine key: `penta.flagger`.
2. Match the request to the documented jobs: `observe`, `recover`, `support-operate`, `secure`, `govern`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.flagger` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.flagger` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `c17b3ad6c6b713bb3ec409b5c086278a8de8b49a8311dae7aa1827b0d528b9cd`
