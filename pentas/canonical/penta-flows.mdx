---
title: "PentaFlows"
sidebarTitle: "PentaFlows"
description: "Registry-driven PentaDocs portal guide for PentaFlows."
...
<Info>
  ...
  **This page:** PentaFlows — Registry-driven PentaDocs portal guide for PentaFlows.
...
## Overview
**Mission / role:** workflow definitions, state machines, transitions, and evidence

| Field | Registry value |
| --- | --- |
| Machine key | `penta.flows` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/flows` |
| Public status route | `/penta/flows` |
...
Route work to PentaFlows when the request matches its recorded role (workflow definitions, state machines, transitions, and evidence) and one of its job classifications: orchestrate, build, support-operate.
...
1. Start from this exact identity and machine key: `penta.flows`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.flows` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.flows` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `7d1d1edbe4eb9d7645d1d768a16d2b9c6dadb6319fbbf2d1c78f27ea704f1fd9`
