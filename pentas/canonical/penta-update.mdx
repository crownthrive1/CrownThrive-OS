---
title: "PentaUpdate"
sidebarTitle: "PentaUpdate"
description: "Registry-driven PentaDocs portal guide for PentaUpdate."
...
<Info>
  ...
  **This page:** PentaUpdate — Registry-driven PentaDocs portal guide for PentaUpdate.
...
| Operator route | `/io/pentas/primitives#update` |
| Public status route | `/penta/update` |
...
Route work to PentaUpdate when the request matches its recorded role (Governed PentaRoute capability primitive.) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.update`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.update` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.update` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `351167f6d5f168b4ec9d42996cdbf10a0d401805a63680a8ca9fd5ad29f783fa`
