---
title: "PentaValidate"
sidebarTitle: "PentaValidate"
description: "Registry-driven PentaDocs portal guide for PentaValidate."
...
<Info>
  ...
  **This page:** PentaValidate — Registry-driven PentaDocs portal guide for PentaValidate.
...
| Operator route | `/io/pentas/primitives#validate` |
| Public status route | `/penta/validate` |
...
Route work to PentaValidate when the request matches its recorded role (Governed capability primitive under PentaRoute and the universal Penta OS contract.) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.validate`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.validate` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.validate` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `198b92e0bbdc194532ae4fbb92e9c2a4cadcdf09013d8c7cba31341dd8d996a9`
