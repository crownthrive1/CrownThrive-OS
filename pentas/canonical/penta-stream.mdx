---
title: "PentaStream"
sidebarTitle: "PentaStream"
description: "Registry-driven PentaDocs portal guide for PentaStream."
...
<Info>
  ...
  **This page:** PentaStream — Registry-driven PentaDocs portal guide for PentaStream.
...
| Operator route | `/io/pentas/primitives#stream` |
| Public status route | `/penta/stream` |
...
Route work to PentaStream when the request matches its recorded role (Governed PentaRoute capability primitive.) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.stream`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.stream` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.stream` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `ec788afb997e26d251da6458199d1d770c33c8343ae95db19cdf7bdf26cc83fa`
