---
title: "PentaManagers"
sidebarTitle: "PentaManagers"
description: "Registry-driven PentaDocs portal guide for PentaManagers."
...
<Info>
  ...
  **This page:** PentaManagers — Registry-driven PentaDocs portal guide for PentaManagers.
...
## Overview
**Mission / role:** Manage agents/workers, assign bounded work, maintain role contracts, capacity, performance obligations and escalation paths.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.managers` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D2` |
...
| Operator route | `/io/pentas/managers` |
| Public status route | `/penta/managers` |
...
## Dependencies
`penta.cost`, `penta.directors`, `penta.hr`, `penta.notes`
...
| --- | --- |
| Architectural layers | [Workforce, People & Community](/pentas/layers/workforce-community), [Experience & Interface](/pentas/layers/experience-interface), [Build, Test & Release](/pentas/layers/build-release), [Automation & Agentic](/pentas/layers/automation-agentic) |
...
Route work to PentaManagers when the request matches its recorded role (Manage agents/workers, assign bounded work, maintain role contracts, capacity, performance obligations and escalation paths.) and one of its job classifications: manage-people-community, support-operate, communicate-grow, build, test-certify, publish.
...
5. Verify declared dependencies before execution: penta.cost, penta.directors, penta.hr, penta.notes.
...
1. Start from this exact identity and machine key: `penta.managers`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.managers` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.managers` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `73634a6a4b6349e4357dac6d5e87159d40af7242c58f010242d167f4528d7d54`
