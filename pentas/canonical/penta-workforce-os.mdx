---
title: "PentaWorkforceOS"
sidebarTitle: "PentaWorkforceOS"
description: "Registry-driven PentaDocs portal guide for PentaWorkforceOS."
...
<Info>
  ...
  **This page:** PentaWorkforceOS — Registry-driven PentaDocs portal guide for PentaWorkforceOS.
...
## Overview
**Mission / role:** institutional digital-workforce operating environment

| Field | Registry value |
| --- | --- |
| Machine key | `penta.workforce` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/workforce` |
| Public status route | `/penta/workforce` |
...
| --- | --- |
| Architectural layers | [Workforce, People & Community](/pentas/layers/workforce-community), [Experience & Interface](/pentas/layers/experience-interface) |
| Jobs / functions | [Manage People & Community](/pentas/jobs/manage-people-community), [Support & Operate](/pentas/jobs/support-operate), [Communicate & Grow](/pentas/jobs/communicate-grow) |
...
Route work to PentaWorkforceOS when the request matches its recorded role (institutional digital-workforce operating environment) and one of its job classifications: manage-people-community, support-operate, communicate-grow.
...
1. Start from this exact identity and machine key: `penta.workforce`.
2. Match the request to the documented jobs: `manage-people-community`, `support-operate`, `communicate-grow`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.workforce` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.workforce` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `d8e84bfdede4798adacec83c82b9107a74e677d2da15e05550f92ff90f3296cb`
