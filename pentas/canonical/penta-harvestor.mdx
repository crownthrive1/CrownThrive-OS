---
title: "PentaHarvestor"
sidebarTitle: "PentaHarvestor"
description: "Registry-driven PentaDocs portal guide for PentaHarvestor."
...
<Info>
  ...
  **This page:** PentaHarvestor — Registry-driven PentaDocs portal guide for PentaHarvestor.
...
## Overview
**Mission / role:** Bounded evidence capture with payload hashing and source preservation.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.harvestor` |
| Kind | `system` |
...
| Operator route | `/io/pentas/harvestor` |
| Public status route | `/penta/harvestor` |
...
| --- | --- |
| Architectural layers | [Commerce & Economic](/pentas/layers/commerce-economic) |
| Jobs / functions | [Transact & Economic](/pentas/jobs/transact-economic) |
...
Route work to PentaHarvestor when the request matches its recorded role (Bounded evidence capture with payload hashing and source preservation.) and one of its job classifications: transact-economic.
...
1. Start from this exact identity and machine key: `penta.harvestor`.
2. Match the request to the documented jobs: `transact-economic`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.harvestor` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.harvestor` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `8a7b4ece81f144a4a43247daf5a30ff381b6e2c146416c03b27e1190ec31efb6`
