---
title: "PentaSettle"
sidebarTitle: "PentaSettle"
description: "Registry-driven PentaDocs portal guide for PentaSettle."
...
<Info>
  ...
  **This page:** PentaSettle — Registry-driven PentaDocs portal guide for PentaSettle.
...
## Overview
**Mission / role:** PentaGreen governed settlement subcomponent.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.settle` |
| Kind | `subcomponent` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/settle` |
| Public status route | `/penta/settle` |
...
Route work to PentaSettle when the request matches its recorded role (PentaGreen governed settlement subcomponent.) and one of its job classifications: transact-economic, govern, observe.
...
1. Start from this exact identity and machine key: `penta.settle`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.settle` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.settle` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `6cb3724eb6043d16431cd204c0b53a891a26a7c41c48682c2c6face2e9db5630`
