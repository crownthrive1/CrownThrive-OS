---
title: "PentaHook"
sidebarTitle: "PentaHook"
description: "Registry-driven PentaDocs portal guide for PentaHook."
...
<Info>
  ...
  **This page:** PentaHook — Registry-driven PentaDocs portal guide for PentaHook.
...
| Operator route | `/io/pentas/primitives#hook` |
| Public status route | `/penta/hook` |
...
Route work to PentaHook when the request matches its recorded role (Governed PentaRoute capability primitive.) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.hook`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.hook` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.hook` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `ab0b0a7df3601284d3a0b9028077ab71637ddfed17cc78e00b6dd1b95ff20569`
