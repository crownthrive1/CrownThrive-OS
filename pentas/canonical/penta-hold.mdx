---
title: "PentaHold"
sidebarTitle: "PentaHold"
description: "Registry-driven PentaDocs portal guide for PentaHold."
...
<Info>
  ...
  **This page:** PentaHold — Registry-driven PentaDocs portal guide for PentaHold.
...
## Overview
**Mission / role:** PentaGreen economic hold and fail-closed disposition subcomponent.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.hold` |
| Kind | `subcomponent` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/hold` |
| Public status route | `/penta/hold` |
...
Route work to PentaHold when the request matches its recorded role (PentaGreen economic hold and fail-closed disposition subcomponent.) and one of its job classifications: transact-economic, govern, observe.
...
1. Start from this exact identity and machine key: `penta.hold`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.hold` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.hold` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `97a08c26ed28adda6f7e6256cab02b69efbd44bea64c9e14e38496479e2fe444`
