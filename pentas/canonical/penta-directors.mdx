---
title: "PentaDirectors"
sidebarTitle: "PentaDirectors"
description: "Registry-driven PentaDocs portal guide for PentaDirectors."
...
<Info>
  ...
  **This page:** PentaDirectors — Registry-driven PentaDocs portal guide for PentaDirectors.
...
## Overview
**Mission / role:** Supervise managers and workers and issue governed policies, SOPs, SLAs, service standards and operating directives within delegated scope.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.directors` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/directors` |
| Public status route | `/penta/directors` |
...
## Dependencies
`penta.board`, `penta.docs`, `penta.managers`, `penta.policy`
...
| --- | --- |
| Architectural layers | [Workforce, People & Community](/pentas/layers/workforce-community), [Experience & Interface](/pentas/layers/experience-interface), [Build, Test & Release](/pentas/layers/build-release) |
| Jobs / functions | [Manage People & Community](/pentas/jobs/manage-people-community), [Support & Operate](/pentas/jobs/support-operate), [Communicate & Grow](/pentas/jobs/communicate-grow), [Build](/pentas/jobs/build), [Test & Certify](/pentas/jobs/test-certify), [Publish](/pentas/jobs/publish) |
...
Route work to PentaDirectors when the request matches its recorded role (Supervise managers and workers and issue governed policies, SOPs, SLAs, service standards and operating directives within delegated scope.) and one of its job classifications: manage-people-community, support-operate, communicate-grow, build, test-certify, publish.
...
5. Verify declared dependencies before execution: penta.board, penta.docs, penta.managers, penta.policy.
...
1. Start from this exact identity and machine key: `penta.directors`.
2. Match the request to the documented jobs: `manage-people-community`, `support-operate`, `communicate-grow`, `build`, `test-certify`, `publish`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.directors` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.directors` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `ff2b5dc82f0d4396dae23997bf20ad6a8d3e04430bec10fdf4562d0abaa9840b`
