---
title: "PentaHybrid"
sidebarTitle: "PentaHybrid"
description: "Registry-driven PentaDocs portal guide for PentaHybrid."
...
<Info>
  ...
  **This page:** PentaHybrid — Registry-driven PentaDocs portal guide for PentaHybrid.
...
## Overview
**Mission / role:** Human + AI operating integration, handoff, escalation, approval, override, quorum, separation of duties and accountability.
...
| Operator route | `/io/pentas/hybrid` |
| Public status route | `/penta/hybrid` |
...
Route work to PentaHybrid when the request matches its recorded role (Human + AI operating integration, handoff, escalation, approval, override, quorum, separation of duties and accountability.) and one of its job classifications: manage-people-community, support-operate, communicate-grow.
...
5. Verify declared dependencies before execution: penta.alumni, penta.docs.
...
1. Start from this exact identity and machine key: `penta.hybrid`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.hybrid` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.hybrid` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `fa6a6f66a36006b3eff1f19d880ad0dd0878f86b5d4722b48565c79ba6c1da22`
