---
title: "PentaSLAs"
sidebarTitle: "PentaSLAs"
description: "Registry-driven PentaDocs portal guide for PentaSLAs."
...
<Info>
  ...
  **This page:** PentaSLAs — Registry-driven PentaDocs portal guide for PentaSLAs.
...
## Overview
**Mission / role:** governed SLA/SLO registry, effective targets, escalation ownership, measurement lineage, and service-commitment continuity

| Field | Registry value |
| --- | --- |
| Machine key | `penta.slas` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/slas` |
| Public status route | `/penta/slas` |
...
Route work to PentaSLAs when the request matches its recorded role (governed SLA/SLO registry, effective targets, escalation ownership, measurement lineage, and service-commitment continuity) and one of its job classifications: recover, observe, support-operate, route, retrieve, transform.
...
1. Start from this exact identity and machine key: `penta.slas`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.slas` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.slas` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `55a0e29438d084a6b73020dfb9bb91ad934d8abae8b8a60234bbaef737557e50`
