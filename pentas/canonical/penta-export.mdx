---
title: "PentaExport"
sidebarTitle: "PentaExport"
description: "Registry-driven PentaDocs portal guide for PentaExport."
...
<Info>
  ...
  **This page:** PentaExport — Registry-driven PentaDocs portal guide for PentaExport.
...
| Operator route | `/io/pentas/primitives#export` |
| Public status route | `/penta/export` |
...
Route work to PentaExport when the request matches its recorded role (Governed PentaRoute capability primitive.) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.export`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.export` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.export` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `f196618778b44b4c67049f6cef18775a3c7d44c0872cb1b301d18e09479403e1`
