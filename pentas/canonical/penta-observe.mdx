---
title: "PentaObserve"
sidebarTitle: "PentaObserve"
description: "Registry-driven PentaDocs portal guide for PentaObserve."
...
<Info>
  ...
  **This page:** PentaObserve — Registry-driven PentaDocs portal guide for PentaObserve.
...
| Operator route | `/io/pentas/primitives#observe` |
| Public status route | `/penta/observe` |
...
Route work to PentaObserve when the request matches its recorded role (Governed PentaRoute capability primitive.) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.observe`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.observe` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.observe` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `9bf51b58b3c6a01681fbad1e68e86911af58e18c768bdf743d33b562e11b0b09`
