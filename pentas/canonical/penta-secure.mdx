---
title: "PentaSecure"
sidebarTitle: "PentaSecure"
description: "Registry-driven PentaDocs portal guide for PentaSecure."
...
<Info>
  ...
  **This page:** PentaSecure — Registry-driven PentaDocs portal guide for PentaSecure.
...
## Overview
**Mission / role:** security-control, prevention, detection, response, and security-readiness layer

| Field | Registry value |
| --- | --- |
| Machine key | `penta.secure` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/secure` |
| Public status route | `/penta/secure` |
...
| --- | --- |
| Architectural layers | [Security & Trust](/pentas/layers/security-trust), [Control & Governance](/pentas/layers/control-governance), [Routing, Interop & Transport](/pentas/layers/routing-transport) |
...
Route work to PentaSecure when the request matches its recorded role (security-control, prevention, detection, response, and security-readiness layer) and one of its job classifications: secure, govern, observe, route, retrieve, transform.
...
1. Start from this exact identity and machine key: `penta.secure`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.secure` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.secure` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `1e437a146d767ded7e93a4b67f705792468ce54a7ef5b8610dbd61e8baeecd18`
