...
description: "Registry-driven PentaDocs portal guide for PentaGreen."
...
<Info>
  ...
  **This page:** PentaGreen — Registry-driven PentaDocs portal guide for PentaGreen.
...
## Overview
**Mission / role:** Govern Commerce & Economic Activation optimization across authorized CrownThrive economic rails while preserving constitutional limits.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.green` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/green` |
| Public status route | `/penta/green` |
...
## Dependencies
`penta.assure`, `penta.cost`, `penta.credits`, `penta.pay`
...
| --- | --- |
| Architectural layers | [Commerce & Economic](/pentas/layers/commerce-economic), [Control & Governance](/pentas/layers/control-governance), [Security & Trust](/pentas/layers/security-trust) |
| Jobs / functions | [Transact & Economic](/pentas/jobs/transact-economic), [Govern](/pentas/jobs/govern), [Observe](/pentas/jobs/observe), [Secure](/pentas/jobs/secure) |
...
Route work to PentaGreen when the request matches its recorded role (Govern Commerce & Economic Activation optimization across authorized CrownThrive economic rails while preserving constitutional limits.) and one of its job classifications: transact-economic, govern, observe, secure.
...
5. Verify declared dependencies before execution: penta.assure, penta.cost, penta.credits, penta.pay.
...
1. Start from this exact identity and machine key: `penta.green`.
2. Match the request to the documented jobs: `transact-economic`, `govern`, `observe`, `secure`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.green` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.green` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `49e961f4c95ed45c1f6bbcb7ba00f1fba06f4120cd02b1f6ea52b89f890bfca0`
