---
title: "PentaBridge"
sidebarTitle: "PentaBridge"
description: "Registry-driven PentaDocs portal guide for PentaBridge."
...
<Info>
  ...
  **This page:** PentaBridge — Registry-driven PentaDocs portal guide for PentaBridge.
...
## Overview
**Mission / role:** PentaGreen governed provider and commerce-system bridge subcomponent.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.bridge` |
| Kind | `subcomponent` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/bridge` |
| Public status route | `/penta/bridge` |
...
Route work to PentaBridge when the request matches its recorded role (PentaGreen governed provider and commerce-system bridge subcomponent.) and one of its job classifications: transact-economic, govern, observe.
...
1. Start from this exact identity and machine key: `penta.bridge`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.bridge` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.bridge` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `3106d5707ca67251eb854d548d60e099197daf4aded17466a8bd597b00b71b89`
