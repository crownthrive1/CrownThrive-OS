---
title: "PentaRisk"
sidebarTitle: "PentaRisk"
description: "Registry-driven PentaDocs portal guide for PentaRisk."
...
<Info>
  ...
  **This page:** PentaRisk — Registry-driven PentaDocs portal guide for PentaRisk.
...
## Overview
**Mission / role:** Enterprise risk taxonomy, risk registers, exposure scoring, control mapping, tolerance, limits, escalation and residual-risk tracking.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.risk` |
| Kind | `system` |
...
| Operator route | `/io/pentas/risk` |
| Public status route | `/penta/risk` |
...
| --- | --- |
| Architectural layers | [Security & Trust](/pentas/layers/security-trust), [Control & Governance](/pentas/layers/control-governance) |
| Jobs / functions | [Secure](/pentas/jobs/secure), [Govern](/pentas/jobs/govern), [Observe](/pentas/jobs/observe) |
...
Route work to PentaRisk when the request matches its recorded role (Enterprise risk taxonomy, risk registers, exposure scoring, control mapping, tolerance, limits, escalation and residual-risk tracking.) and one of its job classifications: secure, govern, observe.
...
1. Start from this exact identity and machine key: `penta.risk`.
2. Match the request to the documented jobs: `secure`, `govern`, `observe`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.risk` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.risk` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `3c0f7119c998b2ca5cf6ac5f86654da5c1ff1ecc0a71db4e59be13a78185f9cc`
