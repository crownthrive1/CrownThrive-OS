---
title: "PentaCatalog"
sidebarTitle: "PentaCatalog"
description: "Registry-driven PentaDocs portal guide for PentaCatalog."
...
<Info>
  ...
  **This page:** PentaCatalog — Registry-driven PentaDocs portal guide for PentaCatalog.
...
## Overview
**Mission / role:** PentaGreen governed commercial catalog subcomponent.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.catalog` |
| Kind | `subcomponent` |
| Maturity | `specified` |
| Risk ceiling | `D2` |
...
| Operator route | `/io/pentas/catalog` |
| Public status route | `/penta/catalog` |
...
| --- | --- |
| Architectural layers | [Commerce & Economic](/pentas/layers/commerce-economic), [Control & Governance](/pentas/layers/control-governance), [Build, Test & Release](/pentas/layers/build-release), [Observability & Reliability](/pentas/layers/observability-reliability) |
...
Route work to PentaCatalog when the request matches its recorded role (PentaGreen governed commercial catalog subcomponent.) and one of its job classifications: transact-economic, govern, observe, build, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.catalog`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.catalog` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.catalog` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `4e7e19e709d95b7613ca7614fbcb6e3a5df1ef2d94fb4bcf514a08dafd776fce`
