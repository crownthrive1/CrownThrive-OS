---
title: "PentaIP"
sidebarTitle: "PentaIP"
description: "Registry-driven PentaDocs portal guide for PentaIP."
...
<Info>
  ...
  **This page:** PentaIP — Registry-driven PentaDocs portal guide for PentaIP.
...
## Overview
**Mission / role:** intellectual-property, marks, rights metadata, provenance, and governance

| Field | Registry value |
| --- | --- |
| Machine key | `penta.ip` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/ip` |
| Public status route | `/penta/ip` |
...
Route work to PentaIP when the request matches its recorded role (intellectual-property, marks, rights metadata, provenance, and governance) and one of its job classifications: document, retrieve, transform.
...
1. Start from this exact identity and machine key: `penta.ip`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.ip` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.ip` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `bf00406b467acd6f3e67514fafef192cba5c252ef2981a53e8cde8128764f8c9`
