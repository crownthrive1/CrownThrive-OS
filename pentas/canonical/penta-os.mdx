---
title: "PentaOS"
sidebarTitle: "PentaOS"
description: "Registry-driven PentaDocs portal guide for PentaOS."
...
<Info>
  ...
  **This page:** PentaOS — Registry-driven PentaDocs portal guide for PentaOS.
...
## Overview
**Mission / role:** Penta operating-system coordination layer

| Field | Registry value |
| --- | --- |
| Machine key | `penta.os` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/os` |
| Public status route | `/penta/os` |
...
Route work to PentaOS when the request matches its recorded role (Penta operating-system coordination layer) and one of its job classifications: architect, govern, support-operate.
...
1. Start from this exact identity and machine key: `penta.os`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.os` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.os` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `582cc19b8091804a7a3786236541518aaa386f13c8d05293d09a9e293d13f4c0`
