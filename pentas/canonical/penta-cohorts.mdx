---
title: "PentaCohorts"
sidebarTitle: "PentaCohorts"
description: "Registry-driven PentaDocs portal guide for PentaCohorts."
...
<Info>
  ...
  **This page:** PentaCohorts — Registry-driven PentaDocs portal guide for PentaCohorts.
...
## Overview
**Mission / role:** Organize governed worker/agent cohorts, shared missions, lifecycle stages, learning groups and bounded collaborative assignments.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.cohorts` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D1` |
...
| Operator route | `/io/pentas/cohorts` |
| Public status route | `/penta/cohorts` |
...
## Dependencies
`penta.accelerator`, `penta.managers`, `penta.notes`
...
| --- | --- |
| Architectural layers | [Workforce, People & Community](/pentas/layers/workforce-community), [Experience & Interface](/pentas/layers/experience-interface), [Automation & Agentic](/pentas/layers/automation-agentic) |
| Jobs / functions | [Manage People & Community](/pentas/jobs/manage-people-community), [Support & Operate](/pentas/jobs/support-operate), [Communicate & Grow](/pentas/jobs/communicate-grow), [Orchestrate](/pentas/jobs/orchestrate) |
...
Route work to PentaCohorts when the request matches its recorded role (Organize governed worker/agent cohorts, shared missions, lifecycle stages, learning groups and bounded collaborative assignments.) and one of its job classifications: manage-people-community, support-operate, communicate-grow, orchestrate.
...
5. Verify declared dependencies before execution: penta.accelerator, penta.managers, penta.notes.
...
1. Start from this exact identity and machine key: `penta.cohorts`.
2. Match the request to the documented jobs: `manage-people-community`, `support-operate`, `communicate-grow`, `orchestrate`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.cohorts` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.cohorts` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `b1cef60173f6089b2f02264358d93867d2ab3e34d3c1b755c63de9ab68806fb9`
