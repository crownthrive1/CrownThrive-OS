---
title: "PentaInteroperation"
sidebarTitle: "PentaInteroperation"
description: "Registry-driven PentaDocs portal guide for PentaInteroperation."
...
<Info>
  ...
  **This page:** PentaInteroperation — Registry-driven PentaDocs portal guide for PentaInteroperation.
...
## Overview
**Mission / role:** Interoperation-axis event relay, compatibility, and cross-system envelope contract.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.interoperation` |
| Kind | `layer` |
...
| Operator route | `/io/pentas/interoperation` |
| Public status route | `/penta/interoperation` |
...
## Evidence
- `developers/manifests/phase4-gate-replication.v4.json`
...
| --- | --- |
| Architectural layers | [Foundation & Kernel](/pentas/layers/foundation-kernel), [Control & Governance](/pentas/layers/control-governance), [Routing, Interop & Transport](/pentas/layers/routing-transport) |
| Jobs / functions | [Architect](/pentas/jobs/architect), [Govern](/pentas/jobs/govern), [Support & Operate](/pentas/jobs/support-operate), [Route](/pentas/jobs/route), [Retrieve](/pentas/jobs/retrieve), [Transform](/pentas/jobs/transform) |
...
Route work to PentaInteroperation when the request matches its recorded role (Interoperation-axis event relay, compatibility, and cross-system envelope contract.) and one of its job classifications: architect, govern, support-operate, route, retrieve, transform.
...
1. Start from this exact identity and machine key: `penta.interoperation`.
2. Match the request to the documented jobs: `architect`, `govern`, `support-operate`, `route`, `retrieve`, `transform`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.interoperation` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.interoperation` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `6c5455fd457a80e4c59a6325940310bda13f57ac90095e084f8a4486f680c5ae`
