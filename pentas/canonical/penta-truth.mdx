---
title: "PentaTruth"
sidebarTitle: "PentaTruth"
description: "Registry-driven PentaDocs portal guide for PentaTruth."
...
<Info>
  ...
  **This page:** PentaTruth — Registry-driven PentaDocs portal guide for PentaTruth.
...
## Overview
**Mission / role:** Truth-axis evidence, provenance, source, and factual-lineage contract.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.truth` |
| Kind | `layer` |
...
| Operator route | `/io/pentas/truth` |
| Public status route | `/penta/truth` |
...
Route work to PentaTruth when the request matches its recorded role (Truth-axis evidence, provenance, source, and factual-lineage contract.) and one of its job classifications: architect, govern, support-operate.
...
1. Start from this exact identity and machine key: `penta.truth`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.truth` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.truth` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `fec59cc3a0600a2947d1191ce9380c8815c81ccb502aaa8051acd0bf1a507583`
