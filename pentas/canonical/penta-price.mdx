---
title: "PentaPrice"
sidebarTitle: "PentaPrice"
description: "Registry-driven PentaDocs portal guide for PentaPrice."
...
<Info>
  ...
  **This page:** PentaPrice — Registry-driven PentaDocs portal guide for PentaPrice.
...
## Overview
**Mission / role:** PentaGreen governed pricing and price-evidence subcomponent.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.price` |
| Kind | `subcomponent` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/price` |
| Public status route | `/penta/price` |
...
Route work to PentaPrice when the request matches its recorded role (PentaGreen governed pricing and price-evidence subcomponent.) and one of its job classifications: transact-economic, govern, observe, build, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.price`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.price` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.price` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `13f2e4f7b3f9fdeaacd6b13cb824a6c58422b9744e4f2ae972e33a46a1874538`
