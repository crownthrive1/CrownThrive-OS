---
title: "PentaInvoice"
sidebarTitle: "PentaInvoice"
description: "Registry-driven PentaDocs portal guide for PentaInvoice."
...
<Info>
  ...
  **This page:** PentaInvoice — Registry-driven PentaDocs portal guide for PentaInvoice.
...
## Overview
**Mission / role:** PentaGreen governed invoicing subcomponent.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.invoice` |
| Kind | `subcomponent` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/invoice` |
| Public status route | `/penta/invoice` |
...
| --- | --- |
| Architectural layers | [Commerce & Economic](/pentas/layers/commerce-economic), [Control & Governance](/pentas/layers/control-governance), [Build, Test & Release](/pentas/layers/build-release), [Communications, Growth & Service](/pentas/layers/communications-growth) |
...
Route work to PentaInvoice when the request matches its recorded role (PentaGreen governed invoicing subcomponent.) and one of its job classifications: transact-economic, govern, observe, build, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.invoice`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.invoice` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.invoice` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `42c63eeadb56f5fc228e661c6700d77f81e0791c506795dce365fc6fbc42b94a`
