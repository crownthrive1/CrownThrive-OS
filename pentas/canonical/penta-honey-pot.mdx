---
title: "PentaHoneyPot"
sidebarTitle: "PentaHoneyPot"
description: "Registry-driven PentaDocs portal guide for PentaHoneyPot."
...
<Info>
  ...
  **This page:** PentaHoneyPot — Registry-driven PentaDocs portal guide for PentaHoneyPot.
...
## Overview
**Mission / role:** ephemeral OS-clone range, Red/Blue duel orchestration, evidence, and teardown

| Field | Registry value |
| --- | --- |
| Machine key | `penta.honeypot` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/honeypot` |
| Public status route | `/penta/honeypot` |
...
Route work to PentaHoneyPot when the request matches its recorded role (ephemeral OS-clone range, Red/Blue duel orchestration, evidence, and teardown) and one of its job classifications: secure, govern, observe, orchestrate.
...
1. Start from this exact identity and machine key: `penta.honeypot`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.honeypot` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.honeypot` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `ca2cbac05cfe0df7887785b300ed8cb2344a5449a7e07f37d90eb7dac63528af`
