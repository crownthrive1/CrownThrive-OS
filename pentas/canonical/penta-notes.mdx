---
title: "PentaNotes"
sidebarTitle: "PentaNotes"
description: "Registry-driven PentaDocs portal guide for PentaNotes."
...
<Info>
  ...
  **This page:** PentaNotes — Registry-driven PentaDocs portal guide for PentaNotes.
...
## Overview
**Mission / role:** Capture agentic/human feedback, observations, voting inputs, ramifications, lessons, breakdowns, luck factors and structured retrospectives.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.notes` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D1` |
...
| Operator route | `/io/pentas/notes` |
| Public status route | `/penta/notes` |
...
| --- | --- |
| Architectural layers | [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Automation & Agentic](/pentas/layers/automation-agentic) |
| Jobs / functions | [Document](/pentas/jobs/document), [Retrieve](/pentas/jobs/retrieve), [Transform](/pentas/jobs/transform), [Orchestrate](/pentas/jobs/orchestrate) |
...
Route work to PentaNotes when the request matches its recorded role (Capture agentic/human feedback, observations, voting inputs, ramifications, lessons, breakdowns, luck factors and structured retrospectives.) and one of its job classifications: document, retrieve, transform, orchestrate.
...
5. Verify declared dependencies before execution: penta.audit, penta.docs.
...
1. Start from this exact identity and machine key: `penta.notes`.
2. Match the request to the documented jobs: `document`, `retrieve`, `transform`, `orchestrate`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.notes` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.notes` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `50a8403209266cb25a3ad25733cf44e245e2b1165444019002738dc545c0e227`
