---
title: "PentaCosts"
sidebarTitle: "PentaCosts"
description: "Registry-driven PentaDocs portal guide for PentaCosts."
...
<Info>
  ...
  **This page:** PentaCosts — Registry-driven PentaDocs portal guide for PentaCosts.
...
## Overview
**Mission / role:** Cost-pressure detection and controlled recession recommendations without money movement.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.costs` |
| Kind | `system` |
...
| Operator route | `/io/pentas/costs` |
| Public status route | `/penta/costs` |
...
| --- | --- |
| Architectural layers | [Observability & Reliability](/pentas/layers/observability-reliability), [Commerce & Economic](/pentas/layers/commerce-economic) |
| Jobs / functions | [Observe](/pentas/jobs/observe), [Recover](/pentas/jobs/recover), [Support & Operate](/pentas/jobs/support-operate), [Transact & Economic](/pentas/jobs/transact-economic) |
...
Route work to PentaCosts when the request matches its recorded role (Cost-pressure detection and controlled recession recommendations without money movement.) and one of its job classifications: observe, recover, support-operate, transact-economic.
...
1. Start from this exact identity and machine key: `penta.costs`.
2. Match the request to the documented jobs: `observe`, `recover`, `support-operate`, `transact-economic`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.costs` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.costs` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `243d002119dec89c1a857f17e239d6c5ed090afe2934e2913e940f251515dfc6`
