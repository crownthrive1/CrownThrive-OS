---
title: "PentaFetch"
sidebarTitle: "PentaFetch"
description: "Registry-driven PentaDocs portal guide for PentaFetch."
...
<Info>
  ...
  **This page:** PentaFetch — Registry-driven PentaDocs portal guide for PentaFetch.
...
## Overview
**Mission / role:** bounded transport/fetch primitive

| Field | Registry value |
| --- | --- |
| Machine key | `penta.fetch` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/fetch` |
| Public status route | `/penta/fetch` |
...
Route work to PentaFetch when the request matches its recorded role (bounded transport/fetch primitive) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.fetch`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.fetch` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.fetch` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `10c80536c10246815571934204f89505e47279fb59851a5b08143acd5e10ff5d`
