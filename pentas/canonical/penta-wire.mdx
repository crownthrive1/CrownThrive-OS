---
title: "PentaWire"
sidebarTitle: "PentaWire"
description: "Registry-driven PentaDocs portal guide for PentaWire."
...
<Info>
  ...
  **This page:** PentaWire — Registry-driven PentaDocs portal guide for PentaWire.
...
## Overview
**Mission / role:** governed wiring/integration into the operating mesh

| Field | Registry value |
| --- | --- |
| Machine key | `penta.wire` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/wire` |
| Public status route | `/penta/wire` |
...
Route work to PentaWire when the request matches its recorded role (governed wiring/integration into the operating mesh) and one of its job classifications: route, orchestrate, support-operate.
...
1. Start from this exact identity and machine key: `penta.wire`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.wire` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.wire` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `e9de1a57bbe52bb35961fbb7ae5c1c6b090e04905cd8d06000f009da7e058c88`
