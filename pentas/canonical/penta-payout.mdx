---
title: "PentaPayout"
sidebarTitle: "PentaPayout"
description: "Registry-driven PentaDocs portal guide for PentaPayout."
...
<Info>
  ...
  **This page:** PentaPayout — Registry-driven PentaDocs portal guide for PentaPayout.
...
## Overview
**Mission / role:** PentaGreen payout coordination subcomponent subject to financial authority.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.payout` |
| Kind | `subcomponent` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/payout` |
| Public status route | `/penta/payout` |
...
| --- | --- |
| Architectural layers | [Commerce & Economic](/pentas/layers/commerce-economic), [Control & Governance](/pentas/layers/control-governance), [Security & Trust](/pentas/layers/security-trust), [Build, Test & Release](/pentas/layers/build-release) |
...
Route work to PentaPayout when the request matches its recorded role (PentaGreen payout coordination subcomponent subject to financial authority.) and one of its job classifications: transact-economic, govern, observe, secure, build, test-certify.
...
1. Start from this exact identity and machine key: `penta.payout`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.payout` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.payout` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `d194fa26e42b73e0f53c45297778527b0ee66b0c5761280a57ec600551eca8b8`
