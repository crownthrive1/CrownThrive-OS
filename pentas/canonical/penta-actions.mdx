---
title: "PentaActions"
sidebarTitle: "PentaActions"
description: "Registry-driven PentaDocs portal guide for PentaActions."
...
<Info>
  ...
  **This page:** PentaActions — Registry-driven PentaDocs portal guide for PentaActions.
...
## Overview
**Mission / role:** immutable shell-free GitHub action execution contracts

| Field | Registry value |
| --- | --- |
| Machine key | `penta.actions` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/actions` |
| Public status route | `/penta/actions` |
...
Route work to PentaActions when the request matches its recorded role (immutable shell-free GitHub action execution contracts) and one of its job classifications: build, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.actions`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.actions` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.actions` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `3d973e159d12143aca3fd25dc75ba9549018ed65820523bea5100b7e4fb324d9`
