---
title: "PentaLegal"
sidebarTitle: "PentaLegal"
description: "Registry-driven PentaDocs portal guide for PentaLegal."
...
<Info>
  ...
  **This page:** PentaLegal — Registry-driven PentaDocs portal guide for PentaLegal.
...
## Overview
**Mission / role:** Legal-operations workflow for obligations, rights, contracts, licensing, legal holds, jurisdiction, review routing and counsel-ready evidence packets.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.legal` |
| Kind | `system` |
...
| Operator route | `/io/pentas/legal` |
| Public status route | `/penta/legal` |
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Security & Trust](/pentas/layers/security-trust), [Routing, Interop & Transport](/pentas/layers/routing-transport), [Automation & Agentic](/pentas/layers/automation-agentic) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Secure](/pentas/jobs/secure), [Document](/pentas/jobs/document), [Route](/pentas/jobs/route), [Retrieve](/pentas/jobs/retrieve), [Transform](/pentas/jobs/transform) |
...
Route work to PentaLegal when the request matches its recorded role (Legal-operations workflow for obligations, rights, contracts, licensing, legal holds, jurisdiction, review routing and counsel-ready evidence packets.) and one of its job classifications: govern, secure, document, route, retrieve, transform.
...
1. Start from this exact identity and machine key: `penta.legal`.
2. Match the request to the documented jobs: `govern`, `secure`, `document`, `route`, `retrieve`, `transform`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.legal` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.legal` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `5d126e004f6114e4b23ae36cb7af9113bbe1871ec07ac6a59124a5d8358faac1`
