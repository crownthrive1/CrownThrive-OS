---
title: "PentaPolicy"
sidebarTitle: "PentaPolicy"
description: "Registry-driven PentaDocs portal guide for PentaPolicy."
...
<Info>
  ...
  **This page:** PentaPolicy — Registry-driven PentaDocs portal guide for PentaPolicy.
...
## Overview
**Mission / role:** Policy drafting, lifecycle management, versioning, applicability, interpretation routing, exception tracking and obligations-to-controls mapping.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.policy` |
| Kind | `system` |
...
| Operator route | `/io/pentas/policy` |
| Public status route | `/penta/policy` |
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Security & Trust](/pentas/layers/security-trust), [Build, Test & Release](/pentas/layers/build-release) |
...
Route work to PentaPolicy when the request matches its recorded role (Policy drafting, lifecycle management, versioning, applicability, interpretation routing, exception tracking and obligations-to-controls mapping.) and one of its job classifications: govern, secure, document, build, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.policy`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.policy` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.policy` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `19c4d4271615073fea98226515c15591e51c7fa7b770deaa7f973e397cba132b`
