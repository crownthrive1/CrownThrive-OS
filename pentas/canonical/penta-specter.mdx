---
title: "PentaSpecter"
sidebarTitle: "PentaSpecter"
description: "Registry-driven PentaDocs portal guide for PentaSpecter."
...
<Info>
  ...
  **This page:** PentaSpecter — Registry-driven PentaDocs portal guide for PentaSpecter.
...
## Overview
**Mission / role:** Generation-61 PentaFabric observation subcomponent.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.specter` |
| Kind | `subcomponent` |
| Maturity | `specified` |
| Risk ceiling | `D1` |
...
| Operator route | `/io/pentas/specter` |
| Public status route | `/penta/specter` |
...
Route work to PentaSpecter when the request matches its recorded role (Generation-61 PentaFabric observation subcomponent.) and one of its job classifications: architect, govern, support-operate.
...
1. Start from this exact identity and machine key: `penta.specter`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.specter` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.specter` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `84efd55f835487847c27ff13e129465c82ec0bb557a8553d10907a12b15b7596`
