---
title: "PentaFactory"
sidebarTitle: "PentaFactory"
description: "Registry-driven PentaDocs portal guide for PentaFactory."
...
<Info>
  ...
  **This page:** PentaFactory — Registry-driven PentaDocs portal guide for PentaFactory.
...
## Overview
**Mission / role:** Governed specification-to-code/config/package generation, test, packaging, release and provider-native deployment production line.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.factory` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/factory` |
| Public status route | `/penta/factory` |
...
## Dependencies
`penta.assure`, `penta.docs`, `penta.mation`, `penta.route`
...
Route work to PentaFactory when the request matches its recorded role (Governed specification-to-code/config/package generation, test, packaging, release and provider-native deployment production line.) and one of its job classifications: build, test-certify, publish.
...
5. Verify declared dependencies before execution: penta.assure, penta.docs, penta.mation, penta.route.
...
1. Start from this exact identity and machine key: `penta.factory`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.factory` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.factory` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `92b2d407eed062cc7ae8489a059197c2d4c53f84cf0fc558ef84ab732f61a96e`
