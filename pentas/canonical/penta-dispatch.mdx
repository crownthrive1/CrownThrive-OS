---
title: "PentaDispatch"
sidebarTitle: "PentaDispatch"
description: "Registry-driven PentaDocs portal guide for PentaDispatch."
...
<Info>
  ...
  **This page:** PentaDispatch — Registry-driven PentaDocs portal guide for PentaDispatch.
...
| Operator route | `/io/pentas/primitives#dispatch` |
| Public status route | `/penta/dispatch` |
...
Route work to PentaDispatch when the request matches its recorded role (Governed PentaRoute capability primitive.) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.dispatch`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.dispatch` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.dispatch` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `c3bc9cfe41325d840944c5d6be5d19b7051dc6964af9943bb37794ba4efa0c20`
