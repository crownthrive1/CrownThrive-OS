---
title: "PentaCompensate"
sidebarTitle: "PentaCompensate"
description: "Registry-driven PentaDocs portal guide for PentaCompensate."
...
<Info>
  ...
  **This page:** PentaCompensate — Registry-driven PentaDocs portal guide for PentaCompensate.
...
## Overview
**Mission / role:** PentaGreen compensation and rollback-coordination subcomponent.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.compensate` |
| Kind | `subcomponent` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
| Execution eligible by registry | `false` |
| Strict readiness | `HOLD_DEPENDENCY_INVENTORY_UNASSESSED` |
| Family | [Commerce Economy](/pentas/families/commerce-economy) |
| Family assignment | `docs_inferred` |
| Operator route | `/io/pentas/compensate` |
| Public status route | `/penta/compensate` |
...
Primary family context: [Commerce Economy](/pentas/families/commerce-economy). Sibling, upstream, downstream, and cross-family relationships resolve through the family topology and dependency graph rather than prose inference.
...
| --- | --- |
| Architectural layers | [Commerce & Economic](/pentas/layers/commerce-economic), [Control & Governance](/pentas/layers/control-governance), [Build, Test & Release](/pentas/layers/build-release) |
| Jobs / functions | [Transact & Economic](/pentas/jobs/transact-economic), [Govern](/pentas/jobs/govern), [Observe](/pentas/jobs/observe), [Build](/pentas/jobs/build), [Test & Certify](/pentas/jobs/test-certify), [Publish](/pentas/jobs/publish) |
...
Route work to PentaCompensate when the request matches its recorded role (PentaGreen compensation and rollback-coordination subcomponent.) and one of its job classifications: transact-economic, govern, observe, build, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.compensate`.
2. Match the request to the documented jobs: `transact-economic`, `govern`, `observe`, `build`, `test-certify`, `publish`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.compensate` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.compensate` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `7470dea7a0c97031c64d2a780e710e66ecd42dbe54774b3fef99f1f8cf8c3d4a`
