---
title: "PentaBC"
sidebarTitle: "PentaBC"
description: "Registry-driven PentaDocs portal guide for PentaBC."
...
<Info>
  ...
  **This page:** PentaBC — Registry-driven PentaDocs portal guide for PentaBC.
...
## Overview
**Mission / role:** declared backward compatibility with legacy provenance preservation

| Field | Registry value |
| --- | --- |
| Machine key | `penta.bc` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D2` |
...
| Operator route | `/io/pentas/bc` |
| Public status route | `/penta/bc` |
...
| --- | --- |
| Architectural layers | [Foundation & Kernel](/pentas/layers/foundation-kernel), [Routing, Interop & Transport](/pentas/layers/routing-transport), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge) |
| Jobs / functions | [Transform](/pentas/jobs/transform), [Document](/pentas/jobs/document), [Support & Operate](/pentas/jobs/support-operate) |
...
Route work to PentaBC when the request matches its recorded role (declared backward compatibility with legacy provenance preservation) and one of its job classifications: transform, document, support-operate.
...
1. Start from this exact identity and machine key: `penta.bc`.
2. Match the request to the documented jobs: `transform`, `document`, `support-operate`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.bc` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.bc` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `932e4e33fc50ef8225347cbbbf7b76eb07225e11a034ad994ae72b424e27e929`
