---
title: "PentaContinuity"
sidebarTitle: "PentaContinuity"
description: "Registry-driven PentaDocs portal guide for PentaContinuity."
...
<Info>
  ...
  **This page:** PentaContinuity — Registry-driven PentaDocs portal guide for PentaContinuity.
...
## Overview
**Mission / role:** evidence-bound continuity certification

| Field | Registry value |
| --- | --- |
| Machine key | `penta.continuity` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D2` |
...
| Operator route | `/io/pentas/continuity` |
| Public status route | `/penta/continuity` |
...
Route work to PentaContinuity when the request matches its recorded role (evidence-bound continuity certification) and one of its job classifications: recover, observe, support-operate.
...
1. Start from this exact identity and machine key: `penta.continuity`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.continuity` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.continuity` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `b5105d1b4c2684699be7d555c868b8555b44f56c5f596183637d507c9cdeb6f8`
