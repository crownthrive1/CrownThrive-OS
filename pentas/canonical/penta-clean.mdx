---
title: "PentaClean"
sidebarTitle: "PentaClean"
description: "Registry-driven PentaDocs portal guide for PentaClean."
...
<Info>
  ...
  **This page:** PentaClean — Registry-driven PentaDocs portal guide for PentaClean.
...
| Operator route | `/io/pentas/clean` |
| Public status route | `/penta/clean` |
...
Route work to PentaClean when the request matches its recorded role (Unresolved PentaSELF delegation reference pending owner mapping or a complete contract.) and one of its job classifications: route, retrieve, transform.
...
1. Start from this exact identity and machine key: `penta.clean`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.clean` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.clean` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `79dee8c5916081621b49134f6af2f9c0c80c53be85aea3fcd5d0006d721d2657`
