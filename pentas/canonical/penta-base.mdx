---
title: "PentaBase"
sidebarTitle: "PentaBase"
description: "Registry-driven PentaDocs portal guide for PentaBase."
...
<Info>
  ...
  **This page:** PentaBase — Registry-driven PentaDocs portal guide for PentaBase.
...
## Overview
**Mission / role:** canonical Penta interface to ThriveBase/runtime data services

| Field | Registry value |
| --- | --- |
| Machine key | `penta.base` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/base` |
| Public status route | `/penta/base` |
...
| --- | --- |
| Architectural layers | [Foundation & Kernel](/pentas/layers/foundation-kernel), [Control & Governance](/pentas/layers/control-governance), [Experience & Interface](/pentas/layers/experience-interface) |
...
Route work to PentaBase when the request matches its recorded role (canonical Penta interface to ThriveBase/runtime data services) and one of its job classifications: architect, govern, support-operate.
...
1. Start from this exact identity and machine key: `penta.base`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.base` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.base` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `de4f602444448b4c20a0e684d455d9ccd11dbb429a9adec2cba60922003af4f4`
