---
title: "PentaTagger"
sidebarTitle: "PentaTagger"
description: "Registry-driven PentaDocs portal guide for PentaTagger."
...
<Info>
  ...
  **This page:** PentaTagger — Registry-driven PentaDocs portal guide for PentaTagger.
...
## Overview
**Mission / role:** Machine-readable ownership, priority, domain, and routing classification.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.tagger` |
| Kind | `system` |
...
| Operator route | `/io/pentas/tagger` |
| Public status route | `/penta/tagger` |
...
- `tests/test_penta_github_tagger.py`
...
Route work to PentaTagger when the request matches its recorded role (Machine-readable ownership, priority, domain, and routing classification.) and one of its job classifications: observe, recover, support-operate, route, retrieve, transform.
...
1. Start from this exact identity and machine key: `penta.tagger`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.tagger` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.tagger` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `6ae38c1c882740b6267e394541fc9f6316c995ae7dbe68fe2afc1c1427061376`
