---
title: "PentaMarketer"
sidebarTitle: "PentaMarketer"
description: "Registry-driven PentaDocs portal guide for PentaMarketer."
...
<Info>
  ...
  **This page:** PentaMarketer — Registry-driven PentaDocs portal guide for PentaMarketer.
...
## Overview
**Mission / role:** Governed marketing planning, messaging, campaign manifests, channel routing, terminology conformance, CTA packaging, bounded artifact dispatch, and measurement handoff across CrownThrive.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.marketer` |
| Kind | `system` |
| Maturity | `production` |
| Risk ceiling | `D2` |
...
| Operator route | `/io/pentas/marketer` |
| Public status route | `/penta/marketer` |
...
## Dependencies
`penta.docs`, `penta.green`, `penta.mation`, `penta.media`, `penta.route`, `penta.scribe`
...
| --- | --- |
| Architectural layers | [Communications, Growth & Service](/pentas/layers/communications-growth), [Experience & Interface](/pentas/layers/experience-interface) |
| Jobs / functions | [Communicate & Grow](/pentas/jobs/communicate-grow), [Support & Operate](/pentas/jobs/support-operate), [Analyze & Research](/pentas/jobs/analyze-research) |
...
Route work to PentaMarketer when the request matches its recorded role (Governed marketing planning, messaging, campaign manifests, channel routing, terminology conformance, CTA packaging, bounded artifact dispatch, and measurement handoff across CrownThrive.) and one of its job classifications: communicate-grow, support-operate, analyze-research.
...
5. Verify declared dependencies before execution: penta.docs, penta.green, penta.mation, penta.media, penta.route, penta.scribe.
...
1. Start from this exact identity and machine key: `penta.marketer`.
2. Match the request to the documented jobs: `communicate-grow`, `support-operate`, `analyze-research`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.marketer` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.marketer` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `4a9b124a4862dcb1c9c5f25eb83b9d06eb63e8009de4da4d2d91b54eb028cafe`
