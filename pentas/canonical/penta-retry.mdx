---
title: "PentaRetry"
sidebarTitle: "PentaRetry"
description: "Registry-driven PentaDocs portal guide for PentaRetry."
...
<Info>
  ...
  **This page:** PentaRetry — Registry-driven PentaDocs portal guide for PentaRetry.
...
| Operator route | `/io/pentas/primitives#retry` |
| Public status route | `/penta/retry` |
...
Route work to PentaRetry when the request matches its recorded role (Governed PentaRoute capability primitive.) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.retry`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.retry` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.retry` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `f2b9f4ad866b4812d06f411476542addbd1d40e85b53861212137946256f440e`
