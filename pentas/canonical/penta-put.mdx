---
title: "PentaPut"
sidebarTitle: "PentaPut"
description: "Registry-driven PentaDocs portal guide for PentaPut."
...
<Info>
  ...
  **This page:** PentaPut — Registry-driven PentaDocs portal guide for PentaPut.
...
## Overview
**Mission / role:** certified replacement/mutation primitive

| Field | Registry value |
| --- | --- |
| Machine key | `penta.put` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/put` |
| Public status route | `/penta/put` |
...
Route work to PentaPut when the request matches its recorded role (certified replacement/mutation primitive) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.put`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.put` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.put` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `7b3e43da577307755e3c115581472b53d8de3dabfd572a2c5335147307c3e6f9`
