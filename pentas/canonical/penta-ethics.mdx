---
title: "PentaEthics"
sidebarTitle: "PentaEthics"
description: "Registry-driven PentaDocs portal guide for PentaEthics."
...
<Info>
  ...
  **This page:** PentaEthics — Registry-driven PentaDocs portal guide for PentaEthics.
...
## Overview
**Mission / role:** Ethics, integrity, conflict-of-interest, cultural-alignment, fairness and institutional-values review for consequential decisions.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.ethics` |
| Kind | `system` |
...
| Operator route | `/io/pentas/ethics` |
| Public status route | `/penta/ethics` |
...
Route work to PentaEthics when the request matches its recorded role (Ethics, integrity, conflict-of-interest, cultural-alignment, fairness and institutional-values review for consequential decisions.) and one of its job classifications: govern, secure, document, build, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.ethics`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.ethics` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.ethics` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `1d2465c2723e53e7eb6f6449bba5ec13246091a4cddfc5dba3c2d36b220e6c56`
