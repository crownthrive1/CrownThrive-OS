---
title: "PentaEntitle"
sidebarTitle: "PentaEntitle"
description: "Registry-driven PentaDocs portal guide for PentaEntitle."
...
<Info>
  ...
  **This page:** PentaEntitle — Registry-driven PentaDocs portal guide for PentaEntitle.
...
## Overview
**Mission / role:** PentaGreen entitlement issuance and verification subcomponent.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.entitle` |
| Kind | `subcomponent` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/entitle` |
| Public status route | `/penta/entitle` |
...
Route work to PentaEntitle when the request matches its recorded role (PentaGreen entitlement issuance and verification subcomponent.) and one of its job classifications: transact-economic, govern, observe.
...
1. Start from this exact identity and machine key: `penta.entitle`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.entitle` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.entitle` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `c3b08b0e6ba8875fff41dd203df26ba7009e7a197fadd27e4e10b788ec1ac533`
