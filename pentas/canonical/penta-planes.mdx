---
title: "PentaPlanes"
sidebarTitle: "PentaPlanes"
description: "Registry-driven PentaDocs portal guide for PentaPlanes."
...
<Info>
  ...
  **This page:** PentaPlanes — Registry-driven PentaDocs portal guide for PentaPlanes.
...
## Overview
**Mission / role:** control/data/execution/governance plane definitions and boundaries

| Field | Registry value |
| --- | --- |
| Machine key | `penta.planes` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/planes` |
| Public status route | `/penta/planes` |
...
Route work to PentaPlanes when the request matches its recorded role (control/data/execution/governance plane definitions and boundaries) and one of its job classifications: architect, govern, support-operate.
...
1. Start from this exact identity and machine key: `penta.planes`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.planes` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.planes` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `c5eb7e16f68d147d9f320369caf24adca4c6f336845f71d7ff596993ecab472b`
