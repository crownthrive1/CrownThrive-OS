---
title: "PentaTrace"
sidebarTitle: "PentaTrace"
description: "Registry-driven PentaDocs portal guide for PentaTrace."
...
<Info>
  ...
  **This page:** PentaTrace — Registry-driven PentaDocs portal guide for PentaTrace.
...
## Overview
**Mission / role:** Trace, correlation, span, parent-span, and scoped context propagation across bounded PENTA operations.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.trace` |
| Kind | `system` |
| Maturity | `production` |
| Risk ceiling | `D1` |
...
| Operator route | `/io/pentas/trace` |
| Public status route | `/penta/trace` |
...
Route work to PentaTrace when the request matches its recorded role (Trace, correlation, span, parent-span, and scoped context propagation across bounded PENTA operations.) and one of its job classifications: observe, recover, support-operate, document, retrieve.
...
1. Start from this exact identity and machine key: `penta.trace`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.trace` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.trace` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `337bbe083444fa7062b56b0f40dd886b7873da50ca8f6e52259bc270c4b597c7`
