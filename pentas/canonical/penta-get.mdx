---
title: "PentaGet"
sidebarTitle: "PentaGet"
description: "Registry-driven PentaDocs portal guide for PentaGet."
...
<Info>
  ...
  **This page:** PentaGet — Registry-driven PentaDocs portal guide for PentaGet.
...
## Overview
**Mission / role:** certified read/request primitive

| Field | Registry value |
| --- | --- |
| Machine key | `penta.get` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/get` |
| Public status route | `/penta/get` |
...
Route work to PentaGet when the request matches its recorded role (certified read/request primitive) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.get`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.get` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.get` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `e5da9c1b50a9bb2d9e61db90814642f64ca9cd79bdd86d4eb92dde73b762cac8`
