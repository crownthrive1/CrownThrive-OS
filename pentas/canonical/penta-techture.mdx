---
title: "PentaTechture"
sidebarTitle: "PentaTechture"
description: "Registry-driven PentaDocs portal guide for PentaTechture."
...
<Info>
  ...
  **This page:** PentaTechture — Registry-driven PentaDocs portal guide for PentaTechture.
...
## Overview
**Mission / role:** technical/architectural structure and architecture governance

| Field | Registry value |
| --- | --- |
| Machine key | `penta.techture` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/techture` |
| Public status route | `/penta/techture` |
...
Route work to PentaTechture when the request matches its recorded role (technical/architectural structure and architecture governance) and one of its job classifications: architect, govern, support-operate.
...
1. Start from this exact identity and machine key: `penta.techture`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.techture` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.techture` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `d82fe9f513bc43abd80f69493360e3b99be338ba5d5228d11440251d6541a225`
