---
title: "PentaProcure"
sidebarTitle: "PentaProcure"
description: "Registry-driven PentaDocs portal guide for PentaProcure."
...
<Info>
  ...
  **This page:** PentaProcure — Registry-driven PentaDocs portal guide for PentaProcure.
...
## Overview
**Mission / role:** Govern procurement intake, sourcing, comparison, requisitions, approvals, purchasing packets, receiving and procurement evidence across goods and services.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.procure` |
| Kind | `system` |
...
| Operator route | `/io/pentas/procure` |
| Public status route | `/penta/procure` |
...
## Dependencies
`penta.capital`, `penta.contracts`, `penta.cost`, `penta.pay`, `penta.risk`, `penta.vendor`
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Security & Trust](/pentas/layers/security-trust), [Build, Test & Release](/pentas/layers/build-release), [Observability & Reliability](/pentas/layers/observability-reliability) |
...
Route work to PentaProcure when the request matches its recorded role (Govern procurement intake, sourcing, comparison, requisitions, approvals, purchasing packets, receiving and procurement evidence across goods and services.) and one of its job classifications: govern, secure, document, build, test-certify, publish.
...
5. Verify declared dependencies before execution: penta.capital, penta.contracts, penta.cost, penta.pay, penta.risk, penta.vendor.
...
1. Start from this exact identity and machine key: `penta.procure`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.procure` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.procure` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `99866cb9ec222cfbdeaf99c51c20a8a79aa3947adaa26086f38a699786c0dcac`
