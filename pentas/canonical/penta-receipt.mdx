---
title: "PentaReceipt"
sidebarTitle: "PentaReceipt"
description: "Registry-driven PentaDocs portal guide for PentaReceipt."
...
<Info>
  ...
  **This page:** PentaReceipt — Registry-driven PentaDocs portal guide for PentaReceipt.
...
## Overview
**Mission / role:** PentaGreen immutable commerce-receipt subcomponent.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.receipt` |
| Kind | `subcomponent` |
| Maturity | `specified` |
| Risk ceiling | `D2` |
...
| Operator route | `/io/pentas/receipt` |
| Public status route | `/penta/receipt` |
...
Route work to PentaReceipt when the request matches its recorded role (PentaGreen immutable commerce-receipt subcomponent.) and one of its job classifications: transact-economic, govern, observe.
...
1. Start from this exact identity and machine key: `penta.receipt`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.receipt` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.receipt` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `b8b1178809752dee80facb7bbfaa443bd8e1b7d33eb28493604f8d4461adb1e7`
