---
title: "PentaIdentity"
sidebarTitle: "PentaIdentity"
description: "Registry-driven PentaDocs portal guide for PentaIdentity."
...
<Info>
  ...
  **This page:** PentaIdentity — Registry-driven PentaDocs portal guide for PentaIdentity.
...
## Overview
**Mission / role:** Govern human, agent, service and organizational identities, role bindings, lifecycle state, authentication context, entitlement requests and separation-of-duties relationships.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.identity` |
| Kind | `system` |
...
| Operator route | `/io/pentas/identity` |
| Public status route | `/penta/identity` |
...
## Dependencies
`penta.audit`, `penta.credentials`, `penta.hr`, `penta.hybrid`, `penta.security`
...
| --- | --- |
| Architectural layers | [Security & Trust](/pentas/layers/security-trust), [Control & Governance](/pentas/layers/control-governance), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Routing, Interop & Transport](/pentas/layers/routing-transport), [Observability & Reliability](/pentas/layers/observability-reliability) |
...
Route work to PentaIdentity when the request matches its recorded role (Govern human, agent, service and organizational identities, role bindings, lifecycle state, authentication context, entitlement requests and separation-of-duties relationships.) and one of its job classifications: secure, govern, observe, document, retrieve, route.
...
5. Verify declared dependencies before execution: penta.audit, penta.credentials, penta.hr, penta.hybrid, penta.security.
...
1. Start from this exact identity and machine key: `penta.identity`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.identity` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.identity` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `719806427f642d17cc003b85205b3ae7170bb9b0563a10a38146c0360078acac`
