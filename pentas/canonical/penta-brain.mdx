...
## Overview
**Mission / role:** Bounded institutional health assessment, learning trends, and disposition engine.
...
Route work to PentaBrain when the request matches its recorded role (Bounded institutional health assessment, learning trends, and disposition engine.) and one of its job classifications: observe, recover, support-operate.
