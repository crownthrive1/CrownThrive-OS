---
title: "PentaBlue"
sidebarTitle: "PentaBlue"
description: "Registry-driven PentaDocs portal guide for PentaBlue."
...
<Info>
  ...
  **This page:** PentaBlue — Registry-driven PentaDocs portal guide for PentaBlue.
...
## Overview
**Mission / role:** defensive detection, containment, restore validation, and control-effectiveness assurance

| Field | Registry value |
| --- | --- |
| Machine key | `penta.blue` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/blue` |
| Public status route | `/penta/blue` |
...
| --- | --- |
| Architectural layers | [Security & Trust](/pentas/layers/security-trust), [Control & Governance](/pentas/layers/control-governance), [Observability & Reliability](/pentas/layers/observability-reliability) |
| Jobs / functions | [Secure](/pentas/jobs/secure), [Govern](/pentas/jobs/govern), [Observe](/pentas/jobs/observe), [Recover](/pentas/jobs/recover) |
...
Route work to PentaBlue when the request matches its recorded role (defensive detection, containment, restore validation, and control-effectiveness assurance) and one of its job classifications: secure, govern, observe, recover.
...
1. Start from this exact identity and machine key: `penta.blue`.
2. Match the request to the documented jobs: `secure`, `govern`, `observe`, `recover`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.blue` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.blue` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `a2e4fb326012387cdc2cb6e7da403e34be18d6b43c6eae8083dae6d174875451`
