---
title: "PentaPrivacy"
sidebarTitle: "PentaPrivacy"
description: "Registry-driven PentaDocs portal guide for PentaPrivacy."
...
<Info>
  ...
  **This page:** PentaPrivacy — Registry-driven PentaDocs portal guide for PentaPrivacy.
...
## Overview
**Mission / role:** Govern privacy inventories, data-subject rights, consent, minimization, purpose limitation, retention, privacy-impact reviews and privacy incident routing.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.privacy` |
| Kind | `system` |
...
| Operator route | `/io/pentas/privacy` |
| Public status route | `/penta/privacy` |
...
## Dependencies
`penta.audit`, `penta.data`, `penta.identity`, `penta.legal`, `penta.records`, `penta.security`
...
Route work to PentaPrivacy when the request matches its recorded role (Govern privacy inventories, data-subject rights, consent, minimization, purpose limitation, retention, privacy-impact reviews and privacy incident routing.) and one of its job classifications: secure, govern, observe, build, test-certify, publish.
...
5. Verify declared dependencies before execution: penta.audit, penta.data, penta.identity, penta.legal, penta.records, penta.security.
...
1. Start from this exact identity and machine key: `penta.privacy`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.privacy` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.privacy` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `f7784048642f32703239a2dd1e704b552621392676817a1c60d83d1fd3ff43b7`
