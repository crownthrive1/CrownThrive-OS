---
title: "PentaPost"
sidebarTitle: "PentaPost"
description: "Registry-driven PentaDocs portal guide for PentaPost."
...
<Info>
  ...
  **This page:** PentaPost — Registry-driven PentaDocs portal guide for PentaPost.
...
## Overview
**Mission / role:** certified creation/mutation primitive

| Field | Registry value |
| --- | --- |
| Machine key | `penta.post` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/post` |
| Public status route | `/penta/post` |
...
Route work to PentaPost when the request matches its recorded role (certified creation/mutation primitive) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.post`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.post` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.post` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `7a26d9bd31ed772389d22b6acbaf2a54aa4a8fb6319a863ff412c63b4a62172a`
