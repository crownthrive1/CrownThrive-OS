---
title: "PentaOrchestrator"
sidebarTitle: "PentaOrchestrator"
description: "Registry-driven PentaDocs portal guide for PentaOrchestrator."
...
<Info>
  ...
  **This page:** PentaOrchestrator — Registry-driven PentaDocs portal guide for PentaOrchestrator.
...
## Overview
**Mission / role:** cross-system orchestration and dependency-aware execution

| Field | Registry value |
| --- | --- |
| Machine key | `penta.orchestrator` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/orchestrator` |
| Public status route | `/penta/orchestrator` |
...
| --- | --- |
| Architectural layers | [Automation & Agentic](/pentas/layers/automation-agentic) |
| Jobs / functions | [Orchestrate](/pentas/jobs/orchestrate), [Build](/pentas/jobs/build), [Support & Operate](/pentas/jobs/support-operate) |
...
Route work to PentaOrchestrator when the request matches its recorded role (cross-system orchestration and dependency-aware execution) and one of its job classifications: orchestrate, build, support-operate.
...
1. Start from this exact identity and machine key: `penta.orchestrator`.
2. Match the request to the documented jobs: `orchestrate`, `build`, `support-operate`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.orchestrator` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.orchestrator` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `810b5a165b42683fd4853ace7f250784e2f4b7774d2cd7f4b03308ea375e291f`
