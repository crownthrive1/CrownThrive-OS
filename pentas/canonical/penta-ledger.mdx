---
title: "PentaLedger"
sidebarTitle: "PentaLedger"
description: "Registry-driven PentaDocs portal guide for PentaLedger."
...
<Info>
  ...
  **This page:** PentaLedger — Registry-driven PentaDocs portal guide for PentaLedger.
...
## Overview
**Mission / role:** PentaGreen append-only economic ledger subcomponent.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.ledger` |
| Kind | `subcomponent` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/ledger` |
| Public status route | `/penta/ledger` |
...
Route work to PentaLedger when the request matches its recorded role (PentaGreen append-only economic ledger subcomponent.) and one of its job classifications: transact-economic, govern, observe.
...
1. Start from this exact identity and machine key: `penta.ledger`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.ledger` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.ledger` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `908b584cca8bf74159da82541c72ce6b28565f92105abf96faa6ba24af5ae115`
