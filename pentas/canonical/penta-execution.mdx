---
title: "PentaExecution"
sidebarTitle: "PentaExecution"
description: "Registry-driven PentaDocs portal guide for PentaExecution."
...
<Info>
  ...
  **This page:** PentaExecution — Registry-driven PentaDocs portal guide for PentaExecution.
...
## Overview
**Mission / role:** Execution-axis bounded handler, result, and rollback-reference contract.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.execution` |
| Kind | `layer` |
...
| Operator route | `/io/pentas/execution` |
| Public status route | `/penta/execution` |
...
| --- | --- |
| Architectural layers | [Foundation & Kernel](/pentas/layers/foundation-kernel), [Control & Governance](/pentas/layers/control-governance), [Build, Test & Release](/pentas/layers/build-release) |
| Jobs / functions | [Architect](/pentas/jobs/architect), [Govern](/pentas/jobs/govern), [Support & Operate](/pentas/jobs/support-operate), [Build](/pentas/jobs/build), [Test & Certify](/pentas/jobs/test-certify), [Publish](/pentas/jobs/publish) |
...
Route work to PentaExecution when the request matches its recorded role (Execution-axis bounded handler, result, and rollback-reference contract.) and one of its job classifications: architect, govern, support-operate, build, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.execution`.
2. Match the request to the documented jobs: `architect`, `govern`, `support-operate`, `build`, `test-certify`, `publish`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.execution` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.execution` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `7e9c23a446445c9af6a3dee48901b35426cddf69ba74a0587d3b0cee04fec55a`
