---
title: "PentaCompile"
sidebarTitle: "PentaCompile"
description: "Registry-driven PentaDocs portal guide for PentaCompile."
...
<Info>
  ...
  **This page:** PentaCompile — Registry-driven PentaDocs portal guide for PentaCompile.
...
| Operator route | `/io/pentas/primitives#compile` |
| Public status route | `/penta/compile` |
...
Route work to PentaCompile when the request matches its recorded role (Governed PentaRoute capability primitive.) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.compile`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.compile` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.compile` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `0b1d46f6aa1242550e2b9bea020d00324008fc6cbff0d0abdd7cf8edaddc3316`
