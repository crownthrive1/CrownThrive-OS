---
title: "PentaRithms"
sidebarTitle: "PentaRithms"
description: "Registry-driven PentaDocs portal guide for PentaRithms."
...
<Info>
  ...
  **This page:** PentaRithms — Registry-driven PentaDocs portal guide for PentaRithms.
...
## Overview
**Mission / role:** algorithms and governed decision/execution logic

| Field | Registry value |
| --- | --- |
| Machine key | `penta.rithms` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/rithms` |
| Public status route | `/penta/rithms` |
...
Route work to PentaRithms when the request matches its recorded role (algorithms and governed decision/execution logic) and one of its job classifications: orchestrate, build, support-operate, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.rithms`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.rithms` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.rithms` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `094ad03913ad697c135aabdd7553ddb8ae482fb2ceaf44cbdfc2923e14a156d3`
