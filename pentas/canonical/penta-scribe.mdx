---
title: "PentaScribe"
sidebarTitle: "PentaScribe"
description: "Registry-driven PentaDocs portal guide for PentaScribe."
...
<Info>
  ...
  **This page:** PentaScribe — Registry-driven PentaDocs portal guide for PentaScribe.
...
## Overview
**Mission / role:** Canonical terminology, definitions, aliases, glossaries, dictionaries, indexes, FAQs, naming governance, trademark-use ledger, semantic reconciliation, language continuity, and governed candidate discovery.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.scribe` |
| Kind | `system` |
| Maturity | `production` |
| Risk ceiling | `D2` |
| Execution eligible by registry | `true` |
| Strict readiness | `HOLD_EXTERNAL_DEPENDENCY_UNBOUND` |
| Family | [Penta Knowledge, Semantics & Data Family](/pentas/families/knowledge-semantics-data) |
| Family assignment | `registry_backed` |
| Operator route | `/io/pentas/scribe` |
| Public status route | `/penta/scribe` |
...
## Dependencies
`penta.docs`, `penta.federation`, `penta.license`
...
| --- | --- |
| Architectural layers | [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Build, Test & Release](/pentas/layers/build-release), [Commerce & Economic](/pentas/layers/commerce-economic) |
...
Route work to PentaScribe when the request matches its recorded role (Canonical terminology, definitions, aliases, glossaries, dictionaries, indexes, FAQs, naming governance, trademark-use ledger, semantic reconciliation, language continuity, and governed candidate discovery.) and one of its job classifications: document, retrieve, transform, build, test-certify, publish.
...
5. Verify declared dependencies before execution: penta.docs, penta.federation, penta.license.
...
1. Start from this exact identity and machine key: `penta.scribe`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.scribe` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.scribe` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `0aba13ac2a295f8023ec5d8eb395834a96b41722366880f2580f1203b127b04f`
