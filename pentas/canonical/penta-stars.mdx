---
title: "PentaStars"
sidebarTitle: "PentaStars"
description: "Registry-driven PentaDocs portal guide for PentaStars."
...
<Info>
  ...
  **This page:** PentaStars — Registry-driven PentaDocs portal guide for PentaStars.
...
## Overview
**Mission / role:** contracts and governed capability/authority agreements

| Field | Registry value |
| --- | --- |
| Machine key | `penta.stars` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/stars` |
| Public status route | `/penta/stars` |
...
Route work to PentaStars when the request matches its recorded role (contracts and governed capability/authority agreements) and one of its job classifications: document, retrieve, transform, secure, govern.
...
1. Start from this exact identity and machine key: `penta.stars`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.stars` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.stars` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `1ef01b49b300694f44d09f6922a28911f83fbdc2d139e139542a3bfe87858baa`
