---
title: "PentaCache"
sidebarTitle: "PentaCache"
description: "Registry-driven PentaDocs portal guide for PentaCache."
...
<Info>
  ...
  **This page:** PentaCache — Registry-driven PentaDocs portal guide for PentaCache.
...
| Operator route | `/io/pentas/primitives#cache` |
| Public status route | `/penta/cache` |
...
Route work to PentaCache when the request matches its recorded role (Governed capability primitive under PentaRoute and the universal Penta OS contract.) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.cache`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.cache` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.cache` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `c640cff20f8b96db6c0fe37ced5a3cea18e0206316309831a0bc8290607f5189`
