---
title: "PentaSELF"
sidebarTitle: "PentaSELF"
description: "Registry-driven PentaDocs portal guide for PentaSELF."
...
<Info>
  ...
  **This page:** PentaSELF — Registry-driven PentaDocs portal guide for PentaSELF.
...
## Overview
**Mission / role:** self-observation/self-model/readback component for governed system awareness

| Field | Registry value |
| --- | --- |
| Machine key | `penta.self` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/self` |
| Public status route | `/penta/self` |
...
Route work to PentaSELF when the request matches its recorded role (self-observation/self-model/readback component for governed system awareness) and one of its job classifications: architect, govern, support-operate, route, retrieve, transform.
...
1. Start from this exact identity and machine key: `penta.self`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.self` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.self` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `3bfc8787fb0ce64ea8416aa886a9cb60c7e9fe34d727214a2eb199a15815e24f`
