---
title: "PentaImpact"
sidebarTitle: "PentaImpact"
description: "Registry-driven PentaDocs portal guide for PentaImpact."
...
<Info>
  ...
  **This page:** PentaImpact — Registry-driven PentaDocs portal guide for PentaImpact.
...
## Overview
**Mission / role:** Impact measurement, logic models, outcomes, attribution, community benefit, cultural benefit, SROI-style analysis and program evaluation.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.impact` |
| Kind | `system` |
...
| Operator route | `/io/pentas/impact` |
| Public status route | `/penta/impact` |
...
| --- | --- |
| Architectural layers | [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Observability & Reliability](/pentas/layers/observability-reliability), [Communications, Growth & Service](/pentas/layers/communications-growth) |
| Jobs / functions | [Analyze & Research](/pentas/jobs/analyze-research), [Retrieve](/pentas/jobs/retrieve), [Observe](/pentas/jobs/observe), [Communicate & Grow](/pentas/jobs/communicate-grow) |
...
Route work to PentaImpact when the request matches its recorded role (Impact measurement, logic models, outcomes, attribution, community benefit, cultural benefit, SROI-style analysis and program evaluation.) and one of its job classifications: analyze-research, retrieve, observe, communicate-grow.
...
1. Start from this exact identity and machine key: `penta.impact`.
2. Match the request to the documented jobs: `analyze-research`, `retrieve`, `observe`, `communicate-grow`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.impact` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.impact` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `0e5cac49a9858c411c3954a874ff5cdf7e41176fc911d4b1825c07c0487937b6`
