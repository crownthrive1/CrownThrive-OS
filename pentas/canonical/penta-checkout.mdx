---
title: "PentaCheckout"
sidebarTitle: "PentaCheckout"
description: "Registry-driven PentaDocs portal guide for PentaCheckout."
...
<Info>
  ...
  **This page:** PentaCheckout — Registry-driven PentaDocs portal guide for PentaCheckout.
...
## Overview
**Mission / role:** PentaGreen governed checkout activation subcomponent.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.checkout` |
| Kind | `subcomponent` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/checkout` |
| Public status route | `/penta/checkout` |
...
Route work to PentaCheckout when the request matches its recorded role (PentaGreen governed checkout activation subcomponent.) and one of its job classifications: transact-economic, govern, observe.
...
1. Start from this exact identity and machine key: `penta.checkout`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.checkout` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.checkout` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `8d5dee3ddfa4235d8e6843072efb020e1e12b38dff572f38af1b3ef2e24ad166`
