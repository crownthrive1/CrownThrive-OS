---
title: "PentaCrons"
sidebarTitle: "PentaCrons"
description: "Registry-driven PentaDocs portal guide for PentaCrons."
...
<Info>
  ...
  **This page:** PentaCrons — Registry-driven PentaDocs portal guide for PentaCrons.
...
## Overview
**Mission / role:** Generation-61 PentaFabric scheduler subcomponent.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.crons` |
| Kind | `subcomponent` |
| Maturity | `specified` |
| Risk ceiling | `D2` |
...
| Operator route | `/io/pentas/crons` |
| Public status route | `/penta/crons` |
...
Route work to PentaCrons when the request matches its recorded role (Generation-61 PentaFabric scheduler subcomponent.) and one of its job classifications: architect, govern, support-operate.
...
1. Start from this exact identity and machine key: `penta.crons`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.crons` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.crons` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `6f323d4c9a1c8d9845a0fe3beb0bb616b1be8e8adf3f6dd1c08dbac4dbb0fd96`
