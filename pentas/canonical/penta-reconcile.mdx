---
title: "PentaReconcile"
sidebarTitle: "PentaReconcile"
description: "Registry-driven PentaDocs portal guide for PentaReconcile."
...
<Info>
  ...
  **This page:** PentaReconcile — Registry-driven PentaDocs portal guide for PentaReconcile.
...
| Operator route | `/io/pentas/primitives#reconcile` |
| Public status route | `/penta/reconcile` |
...
| --- | --- |
| Architectural layers | [Routing, Interop & Transport](/pentas/layers/routing-transport), [Build, Test & Release](/pentas/layers/build-release), [Observability & Reliability](/pentas/layers/observability-reliability) |
...
Route work to PentaReconcile when the request matches its recorded role (Governed PentaRoute capability primitive.) and one of its job classifications: retrieve, transform, route, build, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.reconcile`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.reconcile` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.reconcile` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `325cd40f691e1cf318b649d645fe5bf69ba9df5df062ece75c66e3bc72a09231`
