---
title: "PentaRoute"
sidebarTitle: "PentaRoute"
description: "Registry-driven PentaDocs portal guide for PentaRoute."
...
<Info>
  ...
  **This page:** PentaRoute — Registry-driven PentaDocs portal guide for PentaRoute.
...
## Overview
**Mission / role:** Exact governed routing between intent, provider adapters, runtimes, queues and registered capabilities.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.route` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/route` |
| Public status route | `/penta/route` |
...
Route work to PentaRoute when the request matches its recorded role (Exact governed routing between intent, provider adapters, runtimes, queues and registered capabilities.) and one of its job classifications: route, orchestrate, support-operate, retrieve, transform.
...
1. Start from this exact identity and machine key: `penta.route`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.route` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.route` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `6a63ec55cbf5c3a2de64e482e8fb763a8a6f4a48229b6b7d866e95d03d82e43e`
