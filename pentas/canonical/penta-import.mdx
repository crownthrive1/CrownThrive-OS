---
title: "PentaImport"
sidebarTitle: "PentaImport"
description: "Registry-driven PentaDocs portal guide for PentaImport."
...
<Info>
  ...
  **This page:** PentaImport — Registry-driven PentaDocs portal guide for PentaImport.
...
| Operator route | `/io/pentas/primitives#import` |
| Public status route | `/penta/import` |
...
Route work to PentaImport when the request matches its recorded role (Governed PentaRoute capability primitive.) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.import`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.import` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.import` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `43b54b520e5fb1d7b432a795d3e8c0c62c25f3f034a6f93e817373a81b1d82f8`
