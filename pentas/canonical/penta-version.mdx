---
title: "PentaVersion"
sidebarTitle: "PentaVersion"
description: "Registry-driven PentaDocs portal guide for PentaVersion."
...
<Info>
  ...
  **This page:** PentaVersion — Registry-driven PentaDocs portal guide for PentaVersion.
...
## Overview
**Mission / role:** canonical component/content/policy/schema/version lineage, compatibility, effective-state, and supersession authority

| Field | Registry value |
| --- | --- |
| Machine key | `penta.version` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/version` |
| Public status route | `/penta/version` |
...
| --- | --- |
| Architectural layers | [Observability & Reliability](/pentas/layers/observability-reliability), [Build, Test & Release](/pentas/layers/build-release), [Security & Trust](/pentas/layers/security-trust) |
...
Route work to PentaVersion when the request matches its recorded role (canonical component/content/policy/schema/version lineage, compatibility, effective-state, and supersession authority) and one of its job classifications: recover, observe, support-operate, secure, govern, build.
...
1. Start from this exact identity and machine key: `penta.version`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.version` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.version` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `588238ca7544b51fb62372713ca66b9058f72adf722fbb2a2bd82fa1ee0d444c`
