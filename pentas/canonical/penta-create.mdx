---
title: "PentaCreate"
sidebarTitle: "PentaCreate"
description: "Registry-driven PentaDocs portal guide for PentaCreate."
...
<Info>
  ...
  **This page:** PentaCreate — Registry-driven PentaDocs portal guide for PentaCreate.
...
| Operator route | `/io/pentas/primitives#create` |
| Public status route | `/penta/create` |
...
Route work to PentaCreate when the request matches its recorded role (Governed PentaRoute capability primitive.) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.create`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.create` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.create` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `b4e7fc09ec162ca4663f220d11bb532f97a02182b513dc218c084c4687e15aab`
