---
title: "PentaEvent"
sidebarTitle: "PentaEvent"
description: "Registry-driven PentaDocs portal guide for PentaEvent."
...
<Info>
  ...
  **This page:** PentaEvent — Registry-driven PentaDocs portal guide for PentaEvent.
...
| Operator route | `/io/pentas/primitives#event` |
| Public status route | `/penta/event` |
...
Route work to PentaEvent when the request matches its recorded role (Governed PentaRoute capability primitive.) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.event`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.event` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.event` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `f5b06166d2cdea75bcd157c1903e3968e5694878928b591e57a7120a699e76c2`
