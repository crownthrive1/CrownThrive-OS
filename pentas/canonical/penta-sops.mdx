---
title: "PentaSOPs"
sidebarTitle: "PentaSOPs"
description: "Registry-driven PentaDocs portal guide for PentaSOPs."
...
<Info>
  ...
  **This page:** PentaSOPs — Registry-driven PentaDocs portal guide for PentaSOPs.
...
## Overview
**Mission / role:** governed SOP registry, procedure versioning, ownership, review, supersession, and operational continuity

| Field | Registry value |
| --- | --- |
| Machine key | `penta.sops` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/sops` |
| Public status route | `/penta/sops` |
...
Route work to PentaSOPs when the request matches its recorded role (governed SOP registry, procedure versioning, ownership, review, supersession, and operational continuity) and one of its job classifications: recover, observe, support-operate, build, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.sops`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.sops` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.sops` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `b80bf7cb15aad51d4ecf2ba8bba5070ba97fe8a441670cec0e570b167d1609f4`
