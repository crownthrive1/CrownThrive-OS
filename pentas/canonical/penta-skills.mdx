...
<Info>
  ...
  **This page:** PentaSkills — Registry-driven PentaDocs portal guide for PentaSkills.
...
Route work to PentaSkills when the request matches its recorded role (governed skill/capability registry and lifecycle) and one of its job classifications: orchestrate, build, support-operate.
...
1. Start from this exact identity and machine key: `penta.skills`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.skills` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.skills` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `10e80a25b409906ab3ad86d425eb75b08826f7a75753e30b381cdaf70431c44b`
