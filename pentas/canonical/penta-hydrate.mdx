---
title: "PentaHydrate"
sidebarTitle: "PentaHydrate"
description: "Registry-driven PentaDocs portal guide for PentaHydrate."
...
<Info>
  ...
  **This page:** PentaHydrate — Registry-driven PentaDocs portal guide for PentaHydrate.
...
| Operator route | `/io/pentas/hydrate` |
| Public status route | `/penta/hydrate` |
...
Route work to PentaHydrate when the request matches its recorded role (Unresolved PentaSELF delegation reference pending owner mapping or a complete contract.) and one of its job classifications: route, retrieve, transform.
...
1. Start from this exact identity and machine key: `penta.hydrate`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.hydrate` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.hydrate` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `088e4e9eb60aecc942159f635f2462e0d445e2731733047eac4dcc50ddf361c4`
