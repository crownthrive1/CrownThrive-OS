---
title: "PentaRollback"
sidebarTitle: "PentaRollback"
description: "Registry-driven PentaDocs portal guide for PentaRollback."
...
<Info>
  ...
  **This page:** PentaRollback — Registry-driven PentaDocs portal guide for PentaRollback.
...
## Overview
**Mission / role:** approved staged restore, recovery health-gate, and rollback authority

| Field | Registry value |
| --- | --- |
| Machine key | `penta.rollback` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/rollback` |
| Public status route | `/penta/rollback` |
...
Route work to PentaRollback when the request matches its recorded role (approved staged restore, recovery health-gate, and rollback authority) and one of its job classifications: recover, observe, support-operate, secure, govern, build.
...
1. Start from this exact identity and machine key: `penta.rollback`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.rollback` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.rollback` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `9ef0f1be8ea86da4a7981e75cf281ebfb94ffda51446b8f56a2951e680164906`
