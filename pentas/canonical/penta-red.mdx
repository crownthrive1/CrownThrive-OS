---
title: "PentaRed"
sidebarTitle: "PentaRed"
description: "Registry-driven PentaDocs portal guide for PentaRed."
...
<Info>
  ...
  **This page:** PentaRed — Registry-driven PentaDocs portal guide for PentaRed.
...
## Overview
**Mission / role:** sandbox-only adversarial simulation inside authorized PentaHoneyPot clone ranges

| Field | Registry value |
| --- | --- |
| Machine key | `penta.red` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/red` |
| Public status route | `/penta/red` |
...
Route work to PentaRed when the request matches its recorded role (sandbox-only adversarial simulation inside authorized PentaHoneyPot clone ranges) and one of its job classifications: secure, govern, observe.
...
1. Start from this exact identity and machine key: `penta.red`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.red` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.red` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `0b9284f76a62de6d1c04ada9cbe1ccee310b252bf26dd36742e0e1292f4d7509`
