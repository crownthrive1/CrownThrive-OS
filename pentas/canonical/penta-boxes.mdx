---
title: "PentaBoxes"
sidebarTitle: "PentaBoxes"
description: "Registry-driven PentaDocs portal guide for PentaBoxes."
...
<Info>
  ...
  **This page:** PentaBoxes — Registry-driven PentaDocs portal guide for PentaBoxes.
...
## Overview
**Mission / role:** plugin/component packaging and runtime extension system

| Field | Registry value |
| --- | --- |
| Machine key | `penta.boxes` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/boxes` |
| Public status route | `/penta/boxes` |
...
Route work to PentaBoxes when the request matches its recorded role (plugin/component packaging and runtime extension system) and one of its job classifications: orchestrate, build, support-operate.
...
1. Start from this exact identity and machine key: `penta.boxes`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.boxes` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.boxes` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `940429741b46bc79d59a99341050d66dbe65c6b7739f8e8e087815cea877bef0`
