---
title: "PentaGeneration"
sidebarTitle: "PentaGeneration"
description: "Registry-driven PentaDocs portal guide for PentaGeneration."
...
<Info>
  ...
  **This page:** PentaGeneration — Registry-driven PentaDocs portal guide for PentaGeneration.
...
## Overview
**Mission / role:** Seven-generation continuity, succession, stewardship handoff, institutional memory, archive/version inheritance and long-horizon preservation.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.generation` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/generation` |
| Public status route | `/penta/generation` |
...
| Jobs / functions | [Recover](/pentas/jobs/recover), [Observe](/pentas/jobs/observe), [Support & Operate](/pentas/jobs/support-operate), [Document](/pentas/jobs/document), [Retrieve](/pentas/jobs/retrieve), [Build](/pentas/jobs/build) |
...
Route work to PentaGeneration when the request matches its recorded role (Seven-generation continuity, succession, stewardship handoff, institutional memory, archive/version inheritance and long-horizon preservation.) and one of its job classifications: recover, observe, support-operate, document, retrieve, build.
...
5. Verify declared dependencies before execution: penta.assure, penta.docs.
...
1. Start from this exact identity and machine key: `penta.generation`.
2. Match the request to the documented jobs: `recover`, `observe`, `support-operate`, `document`, `retrieve`, `build`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.generation` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.generation` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `442123bb53ad16e82743dcd1ef8d33552ff53f9503b3953d9ced342a1c0bae2d`
