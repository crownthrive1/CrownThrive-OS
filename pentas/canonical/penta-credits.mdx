...
description: "Registry-driven PentaDocs portal guide for PentaCredits."
...
<Info>
  ...
  **This page:** PentaCredits — Registry-driven PentaDocs portal guide for PentaCredits.
...
## Overview
**Mission / role:** Govern credits and internal economic-value representations, balances, issuance constraints, attribution and lifecycle state.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.credits` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/credits` |
| Public status route | `/penta/credits` |
...
## Dependencies
`penta.audit`, `penta.cost`, `penta.green`
...
| --- | --- |
| Architectural layers | [Commerce & Economic](/pentas/layers/commerce-economic), [Control & Governance](/pentas/layers/control-governance) |
| Jobs / functions | [Transact & Economic](/pentas/jobs/transact-economic), [Govern](/pentas/jobs/govern), [Observe](/pentas/jobs/observe) |
...
Route work to PentaCredits when the request matches its recorded role (Govern credits and internal economic-value representations, balances, issuance constraints, attribution and lifecycle state.) and one of its job classifications: transact-economic, govern, observe.
...
5. Verify declared dependencies before execution: penta.audit, penta.cost, penta.green.
...
1. Start from this exact identity and machine key: `penta.credits`.
2. Match the request to the documented jobs: `transact-economic`, `govern`, `observe`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.credits` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.credits` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `6969d8f183402a897ac23dbc6817343fd7a75f407e8029d41c09e5ac9107bc7f`
