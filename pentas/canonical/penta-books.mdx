---
title: "PentaBooks"
sidebarTitle: "PentaBooks"
description: "Registry-driven PentaDocs portal guide for PentaBooks."
...
<Info>
  ...
  **This page:** PentaBooks — Registry-driven PentaDocs portal guide for PentaBooks.
...
## Overview
**Mission / role:** Governed manuscript, canon, edition, illustration, QA, packaging, monetization, adaptation and publishing lifecycle.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.books` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D2` |
...
| Operator route | `/io/pentas/books` |
| Public status route | `/penta/books` |
...
## Dependencies
`penta.assure`, `penta.docs`, `penta.mation`
...
| --- | --- |
| Architectural layers | [Media, Creative & Publishing](/pentas/layers/media-creative), [Experience & Interface](/pentas/layers/experience-interface), [Build, Test & Release](/pentas/layers/build-release) |
| Jobs / functions | [Publish](/pentas/jobs/publish), [Build](/pentas/jobs/build), [Communicate & Grow](/pentas/jobs/communicate-grow), [Test & Certify](/pentas/jobs/test-certify) |
...
Route work to PentaBooks when the request matches its recorded role (Governed manuscript, canon, edition, illustration, QA, packaging, monetization, adaptation and publishing lifecycle.) and one of its job classifications: publish, build, communicate-grow, test-certify.
...
5. Verify declared dependencies before execution: penta.assure, penta.docs, penta.mation.
...
1. Start from this exact identity and machine key: `penta.books`.
2. Match the request to the documented jobs: `publish`, `build`, `communicate-grow`, `test-certify`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.books` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.books` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `e5730f3bc74b576fce543460c4a3e79bbc01a6024232a51eab2266031f542654`
