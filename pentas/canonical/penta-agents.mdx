---
title: "PentaAgents"
sidebarTitle: "PentaAgents"
description: "Registry-driven PentaDocs portal guide for PentaAgents."
...
<Info>
  ...
  **This page:** PentaAgents — Registry-driven PentaDocs portal guide for PentaAgents.
...
## Overview
**Mission / role:** governed agent registry, execution, and agent lifecycle

| Field | Registry value |
| --- | --- |
| Machine key | `penta.agents` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/agents` |
| Public status route | `/penta/agents` |
...
Route work to PentaAgents when the request matches its recorded role (governed agent registry, execution, and agent lifecycle) and one of its job classifications: orchestrate, build, support-operate.
...
1. Start from this exact identity and machine key: `penta.agents`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.agents` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.agents` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `b874357005e64b001b143086010efd42ee7eb035fae301284b9b32c7966481b7`
