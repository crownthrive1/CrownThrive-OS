---
title: "PentaMCL"
sidebarTitle: "PentaMCL"
description: "Registry-driven PentaDocs portal guide for PentaMCL."
...
<Info>
  ...
  **This page:** PentaMCL — Registry-driven PentaDocs portal guide for PentaMCL.
...
## Overview
**Mission / role:** machine-learning capability/lifecycle layer

| Field | Registry value |
| --- | --- |
| Machine key | `penta.mcl` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/mcl` |
| Public status route | `/penta/mcl` |
...
Route work to PentaMCL when the request matches its recorded role (machine-learning capability/lifecycle layer) and one of its job classifications: orchestrate, build, support-operate.
...
1. Start from this exact identity and machine key: `penta.mcl`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.mcl` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.mcl` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `5dce032285bd81834e0239fbce2deba156cdeb67a4d54f988743984b43ae1046`
