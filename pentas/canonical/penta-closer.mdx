---
title: "PentaCloser"
sidebarTitle: "PentaCloser"
description: "Registry-driven PentaDocs portal guide for PentaCloser."
...
<Info>
  ...
  **This page:** PentaCloser — Registry-driven PentaDocs portal guide for PentaCloser.
...
## Overview
**Mission / role:** Follow delivery work, identify unresolved gaps and stale work, and drive bounded closure, restacking, preservation or retirement dispositions.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.closer` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D2` |
...
| Operator route | `/io/pentas/closer` |
| Public status route | `/penta/closer` |
...
## Dependencies
`penta.docs`, `penta.merge`, `penta.notes`
...
| --- | --- |
| Architectural layers | [Build, Test & Release](/pentas/layers/build-release), [Routing, Interop & Transport](/pentas/layers/routing-transport) |
...
Route work to PentaCloser when the request matches its recorded role (Follow delivery work, identify unresolved gaps and stale work, and drive bounded closure, restacking, preservation or retirement dispositions.) and one of its job classifications: build, test-certify, publish, route, retrieve, transform.
...
5. Verify declared dependencies before execution: penta.docs, penta.merge, penta.notes.
...
1. Start from this exact identity and machine key: `penta.closer`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.closer` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.closer` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `2849b40955224661a65920713f0781b4b01c044200c0280445b8982aafd516ce`
