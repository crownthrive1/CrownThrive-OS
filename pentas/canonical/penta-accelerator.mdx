---
title: "PentaAccelerator"
sidebarTitle: "PentaAccelerator"
description: "Registry-driven PentaDocs portal guide for PentaAccelerator."
...
<Info>
  ...
  **This page:** PentaAccelerator — Registry-driven PentaDocs portal guide for PentaAccelerator.
...
## Overview
**Mission / role:** Accelerate governed agents, cohorts and capabilities through staged learning, testing, mentorship, readiness and bounded promotion pathways.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.accelerator` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D1` |
| Execution eligible by registry | `false` |
| Strict readiness | `HOLD_UNCLASSIFIED_DEPENDENCY_CYCLE` |
| Family | [Penta Workforce & People Family](/pentas/families/workforce-people) |
| Family assignment | `registry_backed` |
| Operator route | `/io/pentas/accelerator` |
| Public status route | `/penta/accelerator` |
...
Primary family context: [Penta Workforce & People Family](/pentas/families/workforce-people). Sibling, upstream, downstream, and cross-family relationships resolve through the family topology and dependency graph rather than prose inference.

## Dependencies
`penta.alumni`, `penta.certify`, `penta.cohorts`
...
| --- | --- |
| Architectural layers | [Workforce, People & Community](/pentas/layers/workforce-community), [Experience & Interface](/pentas/layers/experience-interface), [Routing, Interop & Transport](/pentas/layers/routing-transport), [Build, Test & Release](/pentas/layers/build-release), [Automation & Agentic](/pentas/layers/automation-agentic) |
| Jobs / functions | [Manage People & Community](/pentas/jobs/manage-people-community), [Support & Operate](/pentas/jobs/support-operate), [Communicate & Grow](/pentas/jobs/communicate-grow), [Route](/pentas/jobs/route), [Retrieve](/pentas/jobs/retrieve), [Transform](/pentas/jobs/transform) |
...
Route work to PentaAccelerator when the request matches its recorded role (Accelerate governed agents, cohorts and capabilities through staged learning, testing, mentorship, readiness and bounded promotion pathways.) and one of its job classifications: manage-people-community, support-operate, communicate-grow, route, retrieve, transform.
...
5. Verify declared dependencies before execution: penta.alumni, penta.certify, penta.cohorts.
...
1. Start from this exact identity and machine key: `penta.accelerator`.
2. Match the request to the documented jobs: `manage-people-community`, `support-operate`, `communicate-grow`, `route`, `retrieve`, `transform`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.accelerator` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.accelerator` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `842b8aae34f2cd258c1eab9ad7898a722b5e7992c6313e8c06242b86dd718709`
