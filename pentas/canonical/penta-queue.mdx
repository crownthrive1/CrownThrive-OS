---
title: "PentaQueue"
sidebarTitle: "PentaQueue"
description: "Registry-driven PentaDocs portal guide for PentaQueue."
...
<Info>
  ...
  **This page:** PentaQueue — Registry-driven PentaDocs portal guide for PentaQueue.
...
| Operator route | `/io/pentas/primitives#queue` |
| Public status route | `/penta/queue` |
...
Route work to PentaQueue when the request matches its recorded role (Governed PentaRoute capability primitive.) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.queue`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.queue` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.queue` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `885236d895842e892b4ea37f061067ed7a34cba3bc762a044bd59744ca91629f`
