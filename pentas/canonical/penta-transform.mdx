---
title: "PentaTransform"
sidebarTitle: "PentaTransform"
description: "Registry-driven PentaDocs portal guide for PentaTransform."
...
<Info>
  ...
  **This page:** PentaTransform — Registry-driven PentaDocs portal guide for PentaTransform.
...
## Overview
**Mission / role:** Governed capability primitive under PentaRoute and the universal Penta OS contract.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.transform` |
| Kind | `primitive` |
| Maturity | `specified` |
| Risk ceiling | `D2` |
...
| Operator route | `/io/pentas/primitives#transform` |
| Public status route | `/penta/transform` |
...
| --- | --- |
| Architectural layers | [Routing, Interop & Transport](/pentas/layers/routing-transport), [Experience & Interface](/pentas/layers/experience-interface) |
| Jobs / functions | [Retrieve](/pentas/jobs/retrieve), [Transform](/pentas/jobs/transform), [Route](/pentas/jobs/route), [Support & Operate](/pentas/jobs/support-operate) |
...
Route work to PentaTransform when the request matches its recorded role (Governed capability primitive under PentaRoute and the universal Penta OS contract.) and one of its job classifications: retrieve, transform, route, support-operate.
...
1. Start from this exact identity and machine key: `penta.transform`.
2. Match the request to the documented jobs: `retrieve`, `transform`, `route`, `support-operate`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.transform` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.transform` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `23be85b40641f69c87ab723fa7f591a37f4984a2ac36900b51aa2babc1aaa016`
