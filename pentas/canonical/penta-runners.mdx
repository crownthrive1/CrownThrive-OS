---
title: "PentaRunners"
sidebarTitle: "PentaRunners"
description: "Registry-driven PentaDocs portal guide for PentaRunners."
...
<Info>
  ...
  **This page:** PentaRunners — Registry-driven PentaDocs portal guide for PentaRunners.
...
## Overview
**Mission / role:** GitHub execution-pool inventory, eligibility and runtime validation

| Field | Registry value |
| --- | --- |
| Machine key | `penta.runners` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/runners` |
| Public status route | `/penta/runners` |
...
Route work to PentaRunners when the request matches its recorded role (GitHub execution-pool inventory, eligibility and runtime validation) and one of its job classifications: build, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.runners`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.runners` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.runners` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `5a1d68b0eb232b86e209b2ab8cc1792dd158443a26daa570ccf98ee041463731`
