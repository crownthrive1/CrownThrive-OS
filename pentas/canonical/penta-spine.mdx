---
title: "PentaSpine"
sidebarTitle: "PentaSpine"
description: "Registry-driven PentaDocs portal guide for PentaSpine."
...
<Info>
  ...
  **This page:** PentaSpine — Registry-driven PentaDocs portal guide for PentaSpine.
...
## Overview
**Mission / role:** Ordered append-only hash-chained institutional event backbone.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.spine` |
| Kind | `system` |
...
| Operator route | `/io/pentas/spine` |
| Public status route | `/penta/spine` |
...
Route work to PentaSpine when the request matches its recorded role (Ordered append-only hash-chained institutional event backbone.) and one of its job classifications: observe, recover, support-operate, route, retrieve, transform.
...
1. Start from this exact identity and machine key: `penta.spine`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.spine` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.spine` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `2303574e21d3f8bfc3a99a6d60acfdeb9d71b06ea62a0b3b1625eaff268356fb`
