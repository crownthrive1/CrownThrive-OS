---
title: "PentaEdge"
sidebarTitle: "PentaEdge"
description: "Registry-driven PentaDocs portal guide for PentaEdge."
...
<Info>
  ...
  **This page:** PentaEdge — Registry-driven PentaDocs portal guide for PentaEdge.
...
## Overview
**Mission / role:** Generation-61 PentaFabric edge subcomponent.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.edge` |
| Kind | `subcomponent` |
| Maturity | `specified` |
| Risk ceiling | `D2` |
...
| Operator route | `/io/pentas/edge` |
| Public status route | `/penta/edge` |
...
Route work to PentaEdge when the request matches its recorded role (Generation-61 PentaFabric edge subcomponent.) and one of its job classifications: architect, govern, support-operate.
...
1. Start from this exact identity and machine key: `penta.edge`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.edge` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.edge` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `d20acd3c5558bed7093be1e0a9653db7245ed33fdc4c7b401cd00037f2c66e85`
