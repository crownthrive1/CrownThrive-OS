---
title: "PentaBenefits"
sidebarTitle: "PentaBenefits"
description: "Registry-driven PentaDocs portal guide for PentaBenefits."
...
<Info>
  ...
  **This page:** PentaBenefits — Registry-driven PentaDocs portal guide for PentaBenefits.
...
## Overview
**Mission / role:** Administer governed benefit eligibility, plans, entitlements, support programs and related workforce obligations.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.benefits` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/benefits` |
| Public status route | `/penta/benefits` |
...
## Dependencies
`penta.cost`, `penta.hr`, `penta.legal`
...
| --- | --- |
| Architectural layers | [Workforce, People & Community](/pentas/layers/workforce-community), [Experience & Interface](/pentas/layers/experience-interface), [Commerce & Economic](/pentas/layers/commerce-economic) |
| Jobs / functions | [Manage People & Community](/pentas/jobs/manage-people-community), [Support & Operate](/pentas/jobs/support-operate), [Communicate & Grow](/pentas/jobs/communicate-grow), [Transact & Economic](/pentas/jobs/transact-economic) |
...
Route work to PentaBenefits when the request matches its recorded role (Administer governed benefit eligibility, plans, entitlements, support programs and related workforce obligations.) and one of its job classifications: manage-people-community, support-operate, communicate-grow, transact-economic.
...
5. Verify declared dependencies before execution: penta.cost, penta.hr, penta.legal.
...
1. Start from this exact identity and machine key: `penta.benefits`.
2. Match the request to the documented jobs: `manage-people-community`, `support-operate`, `communicate-grow`, `transact-economic`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.benefits` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.benefits` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `96e46583ac82d79ac44d69ec69fccabf6c6c34d2ccce16902badc0bbc3ccb231`
