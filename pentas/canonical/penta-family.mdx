---
title: "PentaFamily"
sidebarTitle: "PentaFamily"
description: "Registry-driven PentaDocs portal guide for PentaFamily."
...
<Info>
  ...
  **This page:** PentaFamily — Registry-driven PentaDocs portal guide for PentaFamily.
...
## Overview
**Mission / role:** fail-closed five-layer orchestration

| Field | Registry value |
| --- | --- |
| Machine key | `penta.family` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D2` |
...
| Operator route | `/io/pentas/family` |
| Public status route | `/penta/family` |
...
| --- | --- |
| Architectural layers | [Foundation & Kernel](/pentas/layers/foundation-kernel), [Control & Governance](/pentas/layers/control-governance), [Automation & Agentic](/pentas/layers/automation-agentic) |
| Jobs / functions | [Architect](/pentas/jobs/architect), [Govern](/pentas/jobs/govern), [Support & Operate](/pentas/jobs/support-operate), [Orchestrate](/pentas/jobs/orchestrate) |
...
Route work to PentaFamily when the request matches its recorded role (fail-closed five-layer orchestration) and one of its job classifications: architect, govern, support-operate, orchestrate.
...
1. Start from this exact identity and machine key: `penta.family`.
2. Match the request to the documented jobs: `architect`, `govern`, `support-operate`, `orchestrate`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.family` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.family` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `82d8cd4a8610940d2dd04c66c4cacdaae23eabba9490029f628ae8870b0e7470`
