---
title: "PentaScripts"
sidebarTitle: "PentaScripts"
description: "Registry-driven PentaDocs portal guide for PentaScripts."
...
<Info>
  ...
  **This page:** PentaScripts — Registry-driven PentaDocs portal guide for PentaScripts.
...
## Overview
**Mission / role:** governed script registry, execution, provenance, and versioning

| Field | Registry value |
| --- | --- |
| Machine key | `penta.scripts` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/scripts` |
| Public status route | `/penta/scripts` |
...
Route work to PentaScripts when the request matches its recorded role (governed script registry, execution, provenance, and versioning) and one of its job classifications: orchestrate, build, support-operate, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.scripts`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.scripts` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.scripts` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `910771082e56d29e87224668025cc725a72ae5832160ee08cadd2d8d2524a1a3`
