---
title: "PentaAlumni"
sidebarTitle: "PentaAlumni"
description: "Registry-driven PentaDocs portal guide for PentaAlumni."
...
<Info>
  ...
  **This page:** PentaAlumni — Registry-driven PentaDocs portal guide for PentaAlumni.
...
## Overview
**Mission / role:** Machine-addressable ThriveAlumni stewardship, councils, committees, appointments, mentoring, succession participation, institutional memory and bounded human governance.
...
| Operator route | `/io/pentas/alumni` |
| Public status route | `/penta/alumni` |
...
| --- | --- |
| Architectural layers | [Workforce, People & Community](/pentas/layers/workforce-community), [Experience & Interface](/pentas/layers/experience-interface), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Build, Test & Release](/pentas/layers/build-release) |
| Jobs / functions | [Manage People & Community](/pentas/jobs/manage-people-community), [Support & Operate](/pentas/jobs/support-operate), [Communicate & Grow](/pentas/jobs/communicate-grow), [Document](/pentas/jobs/document), [Retrieve](/pentas/jobs/retrieve), [Build](/pentas/jobs/build) |
...
Route work to PentaAlumni when the request matches its recorded role (Machine-addressable ThriveAlumni stewardship, councils, committees, appointments, mentoring, succession participation, institutional memory and bounded human governance.) and one of its job classifications: manage-people-community, support-operate, communicate-grow, document, retrieve, build.
...
5. Verify declared dependencies before execution: penta.docs, penta.generation.
...
1. Start from this exact identity and machine key: `penta.alumni`.
2. Match the request to the documented jobs: `manage-people-community`, `support-operate`, `communicate-grow`, `document`, `retrieve`, `build`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.alumni` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.alumni` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `8e33300d9855890a906e46c4fdf2923623762aa9695392d891ad95c3b9745d62`
