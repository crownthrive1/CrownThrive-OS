---
title: "PentaLiency"
sidebarTitle: "PentaLiency"
description: "Registry-driven PentaDocs portal guide for PentaLiency."
...
<Info>
  ...
  **This page:** PentaLiency — Registry-driven PentaDocs portal guide for PentaLiency.
...
## Overview
**Mission / role:** resilience engineering, hardening-plan authority, health-gated remediation, and recovery assurance

| Field | Registry value |
| --- | --- |
| Machine key | `penta.liency` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/liency` |
| Public status route | `/penta/liency` |
...
| --- | --- |
| Architectural layers | [Observability & Reliability](/pentas/layers/observability-reliability), [Build, Test & Release](/pentas/layers/build-release), [Security & Trust](/pentas/layers/security-trust), [Media, Creative & Publishing](/pentas/layers/media-creative) |
| Jobs / functions | [Recover](/pentas/jobs/recover), [Observe](/pentas/jobs/observe), [Support & Operate](/pentas/jobs/support-operate), [Secure](/pentas/jobs/secure), [Govern](/pentas/jobs/govern), [Publish](/pentas/jobs/publish) |
...
Route work to PentaLiency when the request matches its recorded role (resilience engineering, hardening-plan authority, health-gated remediation, and recovery assurance) and one of its job classifications: recover, observe, support-operate, secure, govern, publish.
...
1. Start from this exact identity and machine key: `penta.liency`.
2. Match the request to the documented jobs: `recover`, `observe`, `support-operate`, `secure`, `govern`, `publish`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.liency` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.liency` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `dd5504f74ff109b3a8b9f98ec0619f9cb513046e4e8d73c690fe4fe57eb09d19`
