---
title: "PentaBuild"
sidebarTitle: "PentaBuild"
description: "Registry-driven PentaDocs portal guide for PentaBuild."
...
<Info>
  ...
  **This page:** PentaBuild — Registry-driven PentaDocs portal guide for PentaBuild.
...
## Overview
**Mission / role:** Build, package, version and maintain software assets, adapters, plugins, provider bindings and integration components.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.build` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/build` |
| Public status route | `/penta/build` |
...
## Dependencies
`penta.assure`, `penta.certify`, `penta.credentials`, `penta.factory`
...
Route work to PentaBuild when the request matches its recorded role (Build, package, version and maintain software assets, adapters, plugins, provider bindings and integration components.) and one of its job classifications: build, test-certify, publish, route, retrieve, transform.
...
5. Verify declared dependencies before execution: penta.assure, penta.certify, penta.credentials, penta.factory.
...
1. Start from this exact identity and machine key: `penta.build`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.build` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.build` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `09fcbf1443908edc9522759ab8b13c51e7123c3729b57631c2c133a9f620fca9`
