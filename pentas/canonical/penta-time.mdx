---
title: "PentaTime"
sidebarTitle: "PentaTime"
description: "Registry-driven PentaDocs portal guide for PentaTime."
...
<Info>
  ...
  **This page:** PentaTime — Registry-driven PentaDocs portal guide for PentaTime.
...
## Overview
**Mission / role:** Canonical schedules, temporal semantics, clock ownership, recurrence, windows, expirations and scheduler topology.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.time` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D2` |
...
| Operator route | `/io/pentas/time` |
| Public status route | `/penta/time` |
...
Route work to PentaTime when the request matches its recorded role (Canonical schedules, temporal semantics, clock ownership, recurrence, windows, expirations and scheduler topology.) and one of its job classifications: recover, observe, support-operate.
...
1. Start from this exact identity and machine key: `penta.time`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.time` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.time` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `4d342ff86a812fc242b6644fe7ebe0a343d4ab4ad06b7bc3bca642d7181b2859`
