---
title: "PentaCapital"
sidebarTitle: "PentaCapital"
description: "Registry-driven PentaDocs portal guide for PentaCapital."
...
<Info>
  ...
  **This page:** PentaCapital — Registry-driven PentaDocs portal guide for PentaCapital.
...
## Overview
**Mission / role:** Capital-allocation, treasury, liquidity, portfolio, funding-envelope and capital-stack decision intelligence for CrownThrive.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.capital` |
| Kind | `system` |
...
| Operator route | `/io/pentas/capital` |
| Public status route | `/penta/capital` |
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Security & Trust](/pentas/layers/security-trust), [Build, Test & Release](/pentas/layers/build-release), [Commerce & Economic](/pentas/layers/commerce-economic), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge) |
...
Route work to PentaCapital when the request matches its recorded role (Capital-allocation, treasury, liquidity, portfolio, funding-envelope and capital-stack decision intelligence for CrownThrive.) and one of its job classifications: govern, secure, document, build, test-certify, publish.
...
1. Start from this exact identity and machine key: `penta.capital`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.capital` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.capital` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `e4110efa61d8c50a4be775c6003b23aa57dc1ce4723bf39480cffd66d04e1984`
