---
title: "PentaOverseer"
sidebarTitle: "PentaOverseer"
description: "Registry-driven PentaDocs portal guide for PentaOverseer."
...
<Info>
  ...
  **This page:** PentaOverseer — Registry-driven PentaDocs portal guide for PentaOverseer.
...
| Operator route | `/io/pentas/overseer` |
| Public status route | `/penta/overseer` |
...
Route work to PentaOverseer when the request matches its recorded role (Unresolved PentaSELF delegation reference pending owner mapping or a complete contract.) and one of its job classifications: route, retrieve, transform.
...
1. Start from this exact identity and machine key: `penta.overseer`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.overseer` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.overseer` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `cbb04cde46e27feeee58356104e87a86adf2066a6c2014ae774a393990dcac64`
