---
title: "PentaMesh"
sidebarTitle: "PentaMesh"
description: "Registry-driven PentaDocs portal guide for PentaMesh."
...
<Info>
  ...
  **This page:** PentaMesh — Registry-driven PentaDocs portal guide for PentaMesh.
...
## Overview
**Mission / role:** Production routing, federation, redundancy and bounded provider-edge mesh for registered PENTA and CrownThrive services.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.mesh` |
| Kind | `system` |
| Maturity | `production` |
| Risk ceiling | `D2` |
...
| Operator route | `/io/pentas/mesh` |
| Public status route | `/penta/mesh` |
...
## Dependencies
`penta.fabric`, `penta.federation`, `penta.route`, `penta.status`
...
| --- | --- |
| Architectural layers | [Foundation & Kernel](/pentas/layers/foundation-kernel), [Control & Governance](/pentas/layers/control-governance) |
| Jobs / functions | [Architect](/pentas/jobs/architect), [Govern](/pentas/jobs/govern), [Support & Operate](/pentas/jobs/support-operate) |
...
Route work to PentaMesh when the request matches its recorded role (Production routing, federation, redundancy and bounded provider-edge mesh for registered PENTA and CrownThrive services.) and one of its job classifications: architect, govern, support-operate.
...
5. Verify declared dependencies before execution: penta.fabric, penta.federation, penta.route, penta.status.
...
1. Start from this exact identity and machine key: `penta.mesh`.
2. Match the request to the documented jobs: `architect`, `govern`, `support-operate`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.mesh` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.mesh` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `64be14c700332851c7400a4c21f016e5add611695178825d31e4014817b946c6`
