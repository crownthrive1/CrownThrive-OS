---
title: "PentaBody"
sidebarTitle: "PentaBody"
description: "Registry-driven PentaDocs portal guide for PentaBody."
...
<Info>
  ...
  **This page:** PentaBody — Registry-driven PentaDocs portal guide for PentaBody.
...
## Overview
**Mission / role:** Whole-system health and Command Center projection.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.body` |
| Kind | `system` |
...
| Operator route | `/io/pentas/body` |
| Public status route | `/penta/body` |
...
Route work to PentaBody when the request matches its recorded role (Whole-system health and Command Center projection.) and one of its job classifications: observe, recover, support-operate.
...
1. Start from this exact identity and machine key: `penta.body`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.body` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.body` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `2d2fe4a57903b894bb3d030016b4ca0feea476a70a90896693d451a4200e92aa`
