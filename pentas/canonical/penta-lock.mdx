---
title: "PentaLock"
sidebarTitle: "PentaLock"
description: "Registry-driven PentaDocs portal guide for PentaLock."
...
<Info>
  ...
  **This page:** PentaLock — Registry-driven PentaDocs portal guide for PentaLock.
...
| Operator route | `/io/pentas/primitives#lock` |
| Public status route | `/penta/lock` |
...
Route work to PentaLock when the request matches its recorded role (Governed PentaRoute capability primitive.) and one of its job classifications: retrieve, transform, route.
...
1. Start from this exact identity and machine key: `penta.lock`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.lock` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.lock` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `19e49d7355340be96534b0787b6b0c19486801ca593866b1b1b8f30cc6f6f3d6`
