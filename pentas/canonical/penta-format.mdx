---
title: "PentaFormat"
sidebarTitle: "PentaFormat"
description: "Registry-driven PentaDocs portal guide for PentaFormat."
...
<Info>
  ...
  **This page:** PentaFormat — Registry-driven PentaDocs portal guide for PentaFormat.
...
## Overview
**Mission / role:** canonical format, media type, schema identity, extension, migration, and format-compatibility authority

| Field | Registry value |
| --- | --- |
| Machine key | `penta.format` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/format` |
| Public status route | `/penta/format` |
...
| --- | --- |
| Architectural layers | [Observability & Reliability](/pentas/layers/observability-reliability), [Build, Test & Release](/pentas/layers/build-release), [Security & Trust](/pentas/layers/security-trust), [Media, Creative & Publishing](/pentas/layers/media-creative), [Experience & Interface](/pentas/layers/experience-interface) |
| Jobs / functions | [Recover](/pentas/jobs/recover), [Observe](/pentas/jobs/observe), [Support & Operate](/pentas/jobs/support-operate), [Secure](/pentas/jobs/secure), [Govern](/pentas/jobs/govern), [Build](/pentas/jobs/build) |
...
Route work to PentaFormat when the request matches its recorded role (canonical format, media type, schema identity, extension, migration, and format-compatibility authority) and one of its job classifications: recover, observe, support-operate, secure, govern, build.
...
1. Start from this exact identity and machine key: `penta.format`.
2. Match the request to the documented jobs: `recover`, `observe`, `support-operate`, `secure`, `govern`, `build`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.format` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.format` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `db6794b2255db63657c1abb00a779c697bb9041d2c0654cbdf93ef5b9892152c`
