---
title: "PentaContracts"
sidebarTitle: "PentaContracts"
description: "Registry-driven PentaDocs portal guide for PentaContracts."
...
<Info>
  ...
  **This page:** PentaContracts — Registry-driven PentaDocs portal guide for PentaContracts.
...
## Overview
**Mission / role:** Manage contract intake, templates, clause matrices, negotiation packets, approval routing, signatures, obligations, milestones, renewals, amendments and termination tracking.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.contracts` |
| Kind | `system` |
...
| Operator route | `/io/pentas/contracts` |
| Public status route | `/penta/contracts` |
...
## Dependencies
`penta.hybrid`, `penta.legal`, `penta.policy`, `penta.records`, `penta.vendor`
...
| --- | --- |
| Architectural layers | [Control & Governance](/pentas/layers/control-governance), [Security & Trust](/pentas/layers/security-trust), [Observability & Reliability](/pentas/layers/observability-reliability) |
| Jobs / functions | [Govern](/pentas/jobs/govern), [Secure](/pentas/jobs/secure), [Document](/pentas/jobs/document), [Observe](/pentas/jobs/observe), [Recover](/pentas/jobs/recover) |
...
Route work to PentaContracts when the request matches its recorded role (Manage contract intake, templates, clause matrices, negotiation packets, approval routing, signatures, obligations, milestones, renewals, amendments and termination tracking.) and one of its job classifications: govern, secure, document, observe, recover.
...
5. Verify declared dependencies before execution: penta.hybrid, penta.legal, penta.policy, penta.records, penta.vendor.
...
1. Start from this exact identity and machine key: `penta.contracts`.
2. Match the request to the documented jobs: `govern`, `secure`, `document`, `observe`, `recover`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.contracts` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.contracts` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `f5cc74d9957e64ebb3468e58dfe3ce0e180bc4d31c746ed060bef4e78bb554a3`
