---
title: "PentaBind"
sidebarTitle: "PentaBind"
description: "Registry-driven PentaDocs portal guide for PentaBind."
...
<Info>
  ...
  **This page:** PentaBind — Registry-driven PentaDocs portal guide for PentaBind.
...
## Overview
**Mission / role:** governed binding of identities, providers, assets, and capabilities

| Field | Registry value |
| --- | --- |
| Machine key | `penta.bind` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/bind` |
| Public status route | `/penta/bind` |
...
| --- | --- |
| Architectural layers | [Routing, Interop & Transport](/pentas/layers/routing-transport), [Foundation & Kernel](/pentas/layers/foundation-kernel) |
| Jobs / functions | [Route](/pentas/jobs/route), [Orchestrate](/pentas/jobs/orchestrate), [Support & Operate](/pentas/jobs/support-operate), [Retrieve](/pentas/jobs/retrieve), [Transform](/pentas/jobs/transform) |
...
Route work to PentaBind when the request matches its recorded role (governed binding of identities, providers, assets, and capabilities) and one of its job classifications: route, orchestrate, support-operate, retrieve, transform.
...
1. Start from this exact identity and machine key: `penta.bind`.
2. Match the request to the documented jobs: `route`, `orchestrate`, `support-operate`, `retrieve`, `transform`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.bind` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.bind` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `ddafc3426198bf4f14f740ffdb57773c72a991ba9653bf917ae1c4cd1f2b5441`
