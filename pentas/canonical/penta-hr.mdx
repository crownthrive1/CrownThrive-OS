---
title: "PentaHR"
sidebarTitle: "PentaHR"
description: "Registry-driven PentaDocs portal guide for PentaHR."
...
<Info>
  ...
  **This page:** PentaHR — Registry-driven PentaDocs portal guide for PentaHR.
...
## Overview
**Mission / role:** Govern worker/agent role records, onboarding/offboarding, contracts, classifications, performance process, access lifecycle and institutional workforce records.

| Field | Registry value |
| --- | --- |
| Machine key | `penta.hr` |
| Kind | `system` |
| Maturity | `specified` |
| Risk ceiling | `D3` |
...
| Operator route | `/io/pentas/hr` |
| Public status route | `/penta/hr` |
...
## Dependencies
`penta.benefits`, `penta.legal`, `penta.managers`, `penta.pay`
...
| --- | --- |
| Architectural layers | [Workforce, People & Community](/pentas/layers/workforce-community), [Experience & Interface](/pentas/layers/experience-interface), [Data, Knowledge & Semantics](/pentas/layers/data-knowledge), [Automation & Agentic](/pentas/layers/automation-agentic) |
| Jobs / functions | [Manage People & Community](/pentas/jobs/manage-people-community), [Support & Operate](/pentas/jobs/support-operate), [Communicate & Grow](/pentas/jobs/communicate-grow), [Document](/pentas/jobs/document), [Retrieve](/pentas/jobs/retrieve), [Orchestrate](/pentas/jobs/orchestrate) |
...
Route work to PentaHR when the request matches its recorded role (Govern worker/agent role records, onboarding/offboarding, contracts, classifications, performance process, access lifecycle and institutional workforce records.) and one of its job classifications: manage-people-community, support-operate, communicate-grow, document, retrieve, orchestrate.
...
5. Verify declared dependencies before execution: penta.benefits, penta.legal, penta.managers, penta.pay.
...
1. Start from this exact identity and machine key: `penta.hr`.
2. Match the request to the documented jobs: `manage-people-community`, `support-operate`, `communicate-grow`, `document`, `retrieve`, `orchestrate`.
...
2. Resolve the canonical implementation and contracts from machine key `penta.hr` and the evidence paths below.
...
Agents and Pentas should not scrape prose as their primary contract. Consume the machine-readable record keyed by `penta.hr` from `data/penta/agent-knowledge.v1.json`, then use this page for explanation and examples.
...
- This record hash: `46348aced8a91d84d68deaf6034709c5f207f0a3c46d7d3b8208acdbbb7a3b73`
